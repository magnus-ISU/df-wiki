<!-- Mirrored from https://dwarffortresswiki.org/index.php/Wound (revision 319853).
     Generated by crawl.py - edit the wiki, not this file. -->

# Wound

*[Source](https://dwarffortresswiki.org/index.php/Wound) &middot; revision 319853 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Wound.wiki)*

---
<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Wound.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
<div><a href="../Dwarf_Fortress_Wiki/V.md">More Info</a> · <a href="../Template/Av.md">V</a></div></td></tr>
</tbody></table>

> *"Damage" redirects here; for how weapons do damage, see [Weapon](Weapon.md)*

[![](https://dwarffortresswiki.org/images/thumb/c/c9/Injured_dwarf.png/300px-Injured_dwarf.png)](https://dwarffortresswiki.org/index.php/File:Injured_dwarf.png)

[https://dwarffortresswiki.org/index.php/File:Injured_dwarf.png](https://dwarffortresswiki.org/index.php/File:Injured_dwarf.png)

Seen better days. Fought weaker goblins.<br>*Art by Nikolay Persikov*
...
For ways to diagnose and treat injuries, see [health care](Health_care~2.md).
...
As the name implies, this signals that a limb has been completely severed. Dwarves with severed limbs frequently either die of blood loss, or linger in the [hospital](Hospital.md) permanently. Those who recover may find themselves unable to perform the same tasks that they had done in the past.

Dwarves without arms are unable to [haul](Haul.md) items, but are still able to gather crops or work in a workshop. Once created/gathered, the items simply remain where they are until another dwarf comes along to move them. They are also unable to equip armor/clothing, but this won't stop them from biting/kicking in combat. Armless dwarves are unable to operate [screw pumps](Screw_pump.md), and trying to dress or clean themselves often causes constant cancellation spam.
...
Losing both arms is a different story. Dwarves who have lost the use of both arms will be unable to do almost any task. Even managers, bookkeepers, and brokers must be able to use at least one arm. They cannot pick up weapons or shields and cannot haul items. Most irritatingly, they cannot clean themselves, or pick up clothing in order to put it on, and will probably spam cancellation messages at you (seriously, consider turning off job cancellation messages in the 'o'rders menu if this is the case). These dwarves are at risk of [insanity](Insanity.md) from the lack of clothing once their current set wears out, though they may have been lucky enough to be wearing armor, which will not wear out. Military dwarves can still lead demonstrations in non-weapons skills, and could quite possibly become a good wrestler, biter, and/or kicker (if they still have functioning legs). Dwarves without arms can also be used as sentries; burrow them in watchtowers to spot ambushes.

#### Blindness

[![](https://dwarffortresswiki.org/images/thumb/a/a9/Blind_in_adventure_mode.png/300px-Blind_in_adventure_mode.png)](https://dwarffortresswiki.org/index.php/File:Blind_in_adventure_mode.png)

[https://dwarffortresswiki.org/index.php/File:Blind_in_adventure_mode.png](https://dwarffortresswiki.org/index.php/File:Blind_in_adventure_mode.png)

Blindness in [adventure mode](Adventure_mode~2.md)

A dwarf with both eyes damaged cannot see - and what they can't see, they won't be afraid of. Therefore, a blind dwarf can do civilian labors *without* dropping everything and running when there's a wild animal nearby. They will suffer a severe drop in the [quality](Quality.md) of their work, but this won't affect jobs whose products don't have a quality level, such as [wood burning](Wood_burning.md).

Military dwarves are, unfortunately, less useful while blind. They will manage to home in on any nearby enemies just as well as any other dwarf, but will suffer a significant penalty to their dodging ability, to the point where even a dwarf with [legendary](Legendary.md) in [dodging](Dodging.md) may get hit more often than even an untrained civilian. As such, they will die too quickly to be useful as anything more than cannon fodder. Blind military dwarves may still be of use however, as their training will have netted them high [combat skills](Combat_skills.md) alongside a good amount of [organizer](Organizer.md), meaning they make for great [champions](Champions.md), or even just permanent teachers in a training squad.

#### Chronic syndrome

The most common chronic syndrome is probably the bite of a [cave spider](Cave_spider.md), which causes long-term mild dizziness. The dwarf seems fine and works normally, except that the work tends to be low-quality because the dwarf is feeling under the weather. Even legendary dwarves will, if they're feeling dizzy enough, be unable to produce masterwork crafts—assign these dwarves to producing goods that don't have quality levels. Dwarves with dizziness will also perform significantly worse in combat; with them dodging, parrying, and successfully hitting less than normal. This is mild enough that they can still be useful in combat, and it may be worth setting them to train for longer to offset the penalty.

### Adventure Mode

[![](https://dwarffortresswiki.org/images/thumb/2/2d/Healing_liquid_message.png/300px-Healing_liquid_message.png)](https://dwarffortresswiki.org/index.php/File:Healing_liquid_message.png)

[https://dwarffortresswiki.org/index.php/File:Healing_liquid_message.png](https://dwarffortresswiki.org/index.php/File:Healing_liquid_message.png)

The messages that appear after drinking a magic healing substance.

A wounded character in adventurer mode may be unable to use wounded limbs, or perform actions with them - someone with a mangled arm, for example, cannot wield a sword. Wounds heal over time, but moving even one cell in fast-Travel mode will vastly speed up recovery, instantly healing all injuries that could heal over time. An adventurer with higher [recuperation](Attribute.md#recuperation) will heal faster than others. Some wounds, however, will never heal.

As with dwarves in fortress mode, missing limbs and nonfunctional nerves, blindness, and similar permanent injuries do not heal, no matter how much time passes. Lower-body paralysis can be especially dangerous, as the affected character can only crawl on the ground. However, [splints](Splint.md) may provide some limited assistance.

#### Advanced healing

There are some events that heal normally permanent injuries:

- Getting a lucky roll on a [divination die](Die.md) will heal all wounds.
- Undergoing a transformation (such as from a [werebeast](Werebeast.md) curse, or from the divination effect that turns you into a beast) heals all wounds.
- Consuming a healing substance, found in [mysterious dungeons and palaces](Mysterious_dungeon.md), and held by [dungeon guardians](Dungeon_guardian.md), will heal all wounds.

All of these options regrow missing body parts and heal nerve damage.

<table>
<tbody><tr>
<td>"Wound" in other <b><a href="Language.md">Languages</a></b> <a href="https://dwarffortresswiki.org/index.php/File:Story_tell_indicator.png"><img alt="Story tell indicator.png" height="18" src="https://dwarffortresswiki.org/images/9/90/Story_tell_indicator.png" width="20"/></a>
<table>
<tbody><tr>
...
**Categories:** [Exceptional Quality Articles](../Category/Exceptional_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [Military](../Category/Military.md) &middot; [Healthcare](../Category/Healthcare.md) &middot; [Interface](../Category/Interface.md)
