<!-- Mirrored from https://dwarffortresswiki.org/index.php/Rumor (revision 311083).
     Generated by crawl.py - edit the wiki, not this file. -->

# Rumor

*[Source](https://dwarffortresswiki.org/index.php/Rumor) &middot; revision 311083 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Rumor.wiki)*

---
<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Rumor.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
<div><a href="../Dwarf_Fortress_Wiki/V.md">More Info</a> · <a href="../Template/Av.md">V</a></div></td></tr>
</tbody></table>

A **rumor** is a certain piece of [knowledge](Knowledge.md) regarding a specific historical event. Rumors originally come from witnesses of the original event, but can then be spread to others who can, after having heard the rumor, spread it themselves.

In the current version, no false rumors will ever spread, barring those regarding events including individuals with [secret identities](Name.md#false-identities), in which case the only misinformation will be regarding the true identity of those individuals.

### Artifact rumors

[Sites](Site.md) have invisible messages about artifacts to mimic the game's conversation system for your adventurer. There are various sorts -- families seeking heirlooms, scholars seeking books from ruined libraries, and so on.
...
Rumors can become known to your fort either by word of the [outpost liaison](Outpost_liaison~2.md), who will arrive with the caravan once each year, by [diplomats](Diplomat.md), or by [visitors](Visitor.md) in the [tavern](Tavern.md) *when served a drink* by an assigned [tavern keeper](Tavern_keeper.md).
...
[![Announce rumor icon.png](https://dwarffortresswiki.org/images/6/6d/Announce_rumor_icon.png)](https://dwarffortresswiki.org/index.php/File:Announce_rumor_icon.png) The notices when a visitor tells you one or more rumors:
...
Rumors can be looked at in the [![Ui Y.png](https://dwarffortresswiki.org/images/1/19/Ui_Y.png)](https://dwarffortresswiki.org/index.php/File:Ui_Y.png)Y [Civilization and World Info](Civilization_and_World_Info.md) screen, by selecting "News and Rumors" after entering the initial screen. Rumors are then marked on the map, with red A:s indicating rumors about [armies](Army.md), yellow A:s indicating rumors about [artifacts](Artifact.md), and green P:s indicating rumors about [position](Noble.md) changes. If there are multiple rumors regarding the same site, the icon will be one corresponding to the latest rumor.
...
It should be noted that anyone you encounter, that wasn't a [historical figure](Historical_figure.md) already, is going to be a complete blank slate with almost no knowledge of anything, e.g. they won't know about any of the enemies or beast you've slain if you don't tell them about it, or even the most basic animals such as [cats](Cat.md) and [dogs](Dog.md). This leaves the impression that no one cares about your achievements you brag about - they would if they had any idea who you were talking about.
...
There are many different kinds of rumors you can spread, rumors about the presence of people in places, rumors about [site](Site.md) takeovers and succession, rumors about beasts, basically; any rumor an NPC can spread, you can spread as well, which leads to a rather messy screen when you choose to spread a rumor. Luckily, this screen is limited by what your character actually knows, and you can Filter the list with f and there are ways around using it, listed below.

You can also spread rumors via [talking](Talking.md), press [![Adv ui P.png](https://dwarffortresswiki.org/images/0/01/Adv_ui_P.png)](https://dwarffortresswiki.org/index.php/File:Adv_ui_P.png)P-\>Tell a story and find the death of the creature you killed, usually under sites (this would be the [lair](Lair.md) of the creature, or the place you killed it.) or the individual's name. It can also be found in the "region" section if it was in no specific place. A third method is to show someone part of the corpse, eg; its head, and simply [![Adv ui d.png](https://dwarffortresswiki.org/images/a/ab/Adv_ui_d.png)](https://dwarffortresswiki.org/index.php/File:Adv_ui_d.png)d drop it in front of the person you wish to tell.
...
**Categories:** [Fine Quality Articles](../Category/Fine_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [Adventurer mode](../Category/Adventurer_mode.md) &middot; [Fortress mode](../Category/Fortress_mode.md)
