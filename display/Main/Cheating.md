<!-- Mirrored from https://dwarffortresswiki.org/index.php/Cheating (revision 309633).
     Generated by crawl.py - edit the wiki, not this file. -->

# Cheating

*[Source](https://dwarffortresswiki.org/index.php/Cheating) &middot; revision 309633 &middot; retrieved 2026-09-11 &middot; [wikitext](../../mirror/wikitext/Main/Cheating.wiki)*

---
<table>
<tbody><tr><td><div><a href="https://dwarffortresswiki.org/index.php/File:Announce_migrant_icon.png"><img alt="Announce migrant icon.png" height="32" src="https://dwarffortresswiki.org/images/5/5f/Announce_migrant_icon.png" width="32"/></a></div></td><td>This article was migrated from <a href="../DF2014/Cheating.md">DF2014:Cheating</a> and may be inaccurate for the current version of DF (v53.16). See <a href="../Dwarf_Fortress_Wiki/Version_migration.md">this page</a> for more information.  </td></tr></tbody></table>

<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Cheating.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
...
[![Cheat controller icon.png](https://dwarffortresswiki.org/images/thumb/7/7d/Cheat_controller_icon.png/130px-Cheat_controller_icon.png)](https://dwarffortresswiki.org/index.php/File:Cheat_controller_icon.png)

**Cheating** is altering the game to make *Dwarf Fortress* conceptually easier — this is distinct from [exploits](Exploit.md), which take advantage of existing bugs or design oversights. There are two main ways to alter the game: changing the game's raw source files (which are really just text files), and directly altering the game's memory (which requires [special tools](../Utility/DFHack.md)). As with using exploits, whether or not to cheat is down to personal taste — after all, the game is *designed* to be readily moddable. Too much cheating can spoil your experience of *Dwarf Fortress*, but there are no other players to cheat — only yourself.

### Raw Editing

For making [modifications](Modding.md) to a newly-generated world, edit the raw files located in the `<Dwarf Fortress>\data\vanilla\` *before* generating the game.

The most common use of editing raw files is to get free items, such as [gems](Gem.md), [adamantine](Adamantine.md), or [flux](Flux~2.md).
...
[Shaostoul's Guide](Shaostoul's_Guide.md) contains several cut & paste examples for editing raw files specifically for the purpose of cheating.
...
- [Notepad++](http://notepad-plus-plus.org/) is recommended for altering raw files on Windows.

#### Speedy Dwarves

Getting bored with slow dwarves? Open raw/objects/creature_standard.txt, look for `APPLY_CREATURE_VARIATION:STANDARD_BIPED_GAITS`, and change the six numbers after it (0 is fastest). This can impact framerate in some cases - using 3 instead of 0 has been known to help.
...
(Warning, editing this may cause the game to crash.<sup>\[[Verify](https://dwarffortresswiki.org/index.php/Talk:Cheating)\]</sup>)

Other potential problems include, but are not limited to; unhappiness due to never drinking any booze, and insane dwarves with no viable avenues for suicide; not that they can't be [assisted in such endeavors](Unfortunate_accident.md).
...
- Removing the \[CAVE_ADAPT\] tag will eliminate [cave adaptation](Cave_adaptation.md) but will also remove bonuses for dwarves in caves.
...
Ever want [cave dragons](Cave_dragon.md), [giant cave spiders](Giant_cave_spider.md), or even [helmet snakes](Helmet_snake.md) for pets?
...
People in this game (animals and even inanimate beings, too) are individuals governed by [personality traits](Personality_facet.md).
...
Are you tired of your dwarves having red stats after a few years? If so, try adding this mod by [LordSnow](http://www.bay12forums.com/smf/index.php?topic=61016.0) to df_folder/data/save/region/raw/objects/creature_standard.txt in the "dwarf" section.
...
This reaction will allow your dwarves to draw water from the rock. Unfortunately, it will not allow them to part the Red Sea - for that, you'll need lots of [screw pumps](Screw_pump.md), but that's another story...
...
<br> NOTE: use stockpile links to restrict this to Iron/Steel/Nickel/Candy carts, or risk spontaneous combustion in the workshop.
...
[![](https://dwarffortresswiki.org/images/thumb/4/48/Dfhack_cmd.png/200px-Dfhack_cmd.png)](https://dwarffortresswiki.org/index.php/File:Dfhack_cmd.png)

[https://dwarffortresswiki.org/index.php/File:Dfhack_cmd.png](https://dwarffortresswiki.org/index.php/File:Dfhack_cmd.png)

DFHack console, one of the easiest ways to cheat and/or run scripts.

Memory hacking is much harder than raw editing, and requires [special tools](Utilities.md). The most prevalent tool today is [DFHack](../Utility/DFHack.md), which provides complete access to most of *Dwarf Fortress* internal memory through C++ plugins as well as Lua scripts. The `gui/gm-editor` command allows direct data editing of the selected [creature](Creature.md), [item](Item.md), or [job](Job.md), while `gui/gm-editor world` does the same for global variables.
...
<br> For When Losing Is Too Fun

---

**Categories:** [Migrated pages needing review](../Category/Migrated_pages_needing_review.md) &middot; [Unknown Quality Articles](../Category/Unknown_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [Mods](../Category/Mods.md) &middot; [Verify](../Category/Verify.md) &middot; [D for Dwarf](../Category/D_for_Dwarf.md)
