<!-- Mirrored from https://dwarffortresswiki.org/index.php/Villain (revision 314272).
     Generated by crawl.py - edit the wiki, not this file. -->

# Villain

*[Source](https://dwarffortresswiki.org/index.php/Villain) &middot; revision 314272 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Villain.wiki)*

---
<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Villain.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
<div><a href="../Dwarf_Fortress_Wiki/V.md">More Info</a> · <a href="../Template/Av.md">V</a></div></td></tr>
</tbody></table>

[![Always hating.](https://dwarffortresswiki.org/images/f/f9/Villain_preview2.png)](https://dwarffortresswiki.org/index.php/File:Villain_preview2.png)
...
Starting wars involves corrupting leaders, advisors and generals associated to civilizations with which the target civilization is currently at peace. Skilled intrigue can disturb diplomatic relations, though this is rather abstract. Similarly, sabotage is a bit thin on the ground, but if successful, harms the abstract '[account](Account.md)' of either a grudge-target or the [company](Company.md)/[guild](Guild.md) they are a part of, which does have an effect on them (buildings are not actually destroyed on the site map, however).
...
**Categories:** [Superior Quality Articles](../Category/Superior_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [Non-player characters](../Category/Non-player_characters.md)
