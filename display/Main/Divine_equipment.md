<!-- Mirrored from https://dwarffortresswiki.org/index.php/Divine_equipment (revision 318875).
     Generated by crawl.py - edit the wiki, not this file. -->

# Divine equipment

*[Source](https://dwarffortresswiki.org/index.php/Divine_equipment) &middot; revision 318875 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Divine_equipment.wiki)*

---
<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Divine_equipment.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
...
[![Divine equipment preview2.png](https://dwarffortresswiki.org/images/d/db/Divine_equipment_preview2.png)](https://dwarffortresswiki.org/index.php/File:Divine_equipment_preview2.png)

**Divine equipment** is a catch-all term for special, procedurally-generated [weapons](Weapon.md), [armor](Armor.md), and [clothing](Clothing.md) that can be found in [vaults](Vault.md) as well as deep underground. Divine equipment is used by [angels](Angel.md), who ruthlessly protect the vault's priceless treasures. Divine equipment is usually made from [divine metals](Divine_metal.md) and [divine fabrics](Divine_fabric.md).

In fortress mode, divine equipment can be found on the lowest z levels, a few levels above the magma sea. A message "You have discovered an [unusual volcanic wall](Unusual_volcanic_wall.md) studded with gems" will appear, pinpointing its location once the magma sea has been discovered. These gem clusters contain two kinds of divine equipment, "Treasure of the gods", which are [artifacts](Artifact.md) created with divine materials, and the divine equipment of angels that reside in these gem clusters. Their main difference is that angel equipment can be melted and repurposed for specific items, such as a [monarch](Monarch.md)'s throne.

Graphically, sprites of weapons made with divine materials will appear as having a silver and cyan design.

### Traits

Each [vault](Vault.md) entity generates a set of equipment: weapons, shields, clothing and armor. Each item is based on a default item; adding an adjective ("bulging", "bulky", "segmented", etc.) and potentially a new name ("[blade](Short_sword.md)", "[nail](Large_dagger.md)"). Dwarves in [strange moods](Strange_mood.md) may produce one of these procedurally-generated items as they would any other foreign item of that [type](Item_token.md). Divine equipment subtypes are generally equivalent in stats to standard items, with their advantages coming from either [artifact](Artifact.md) [quality](Item_quality.md) or [exceptional](Divine_fabric.md) [materials](Divine_metal.md).
...
<table>
<tbody><tr><th scope="col"><div><a href="Divine_equipment/script.md">Script</a></div></th></tr>
<tr><td><div><div><pre>angel_item_info={
    armor={
        pants={
            gen={},
            adj={
...
**Categories:** [Fine Quality Articles](../Category/Fine_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [Spoilers](../Category/Spoilers.md) &middot; [Weapons](../Category/Weapons.md) &middot; [Armor](../Category/Armor.md) &middot; [Clothing](../Category/Clothing.md)
