<!-- Mirrored from https://dwarffortresswiki.org/index.php/Fluid_logic (revision 301646).
     Generated by crawl.py - edit the wiki, not this file. -->

# Fluid logic

*[Source](https://dwarffortresswiki.org/index.php/Fluid_logic) &middot; revision 301646 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Fluid_logic.wiki)*

---
<table>
<tbody><tr><td><div><a href="https://dwarffortresswiki.org/index.php/File:Announce_migrant_icon.png"><img alt="Announce migrant icon.png" height="32" src="https://dwarffortresswiki.org/images/5/5f/Announce_migrant_icon.png" width="32"/></a></div></td><td>This article was migrated from <a href="../DF2014/Fluid_logic.md">DF2014:Fluid logic</a> and may be inaccurate for the current version of DF (v53.16). See <a href="../Dwarf_Fortress_Wiki/Version_migration.md">this page</a> for more information.  </td></tr></tbody></table>

<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Fluid_logic.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
...
<td>
<b><a href="../Category/Logic.md">Logic</a></b>: <a href="Animal_logic.md">Animal</a> • <a href="Creature_logic.md">Creature</a> • <a>Fluid</a> • <a href="Mechanical_logic~2.md">Mechanical</a> • <a href="Minecart_logic.md">Minecart</a></td>
</tr><tr>
<td>
...
**Fluid logic** is a form of [computing](Computing.md) which uses a fluid (generally [water](Water.md)), controlled by various means, to trigger [pressure plates](Pressure_plate~2.md) and hopefully accomplish some desirable result.

### Infinite Flow Gates

These logic gates are relatively simple and cheap to make, but require an infinite amount of [flow](Flow.md) and infinite drainage to operate. You can build a circuit system to prevent the loss of water, but closing constructions like [floodgates](Floodgate.md) will always destroy water, so you'll always have to replace it somehow. The following examples use raising [bridges](Bridge.md) and floodgates, as they have the same delay of 100 steps when reacting to on/off signals. The bridges work as inverted input as they block passage when receiving an on signal while floodgates open in that case. The channel in the gates stands for the drainage.

There are two versions of these gates here.<br>
...
An AND gate is simply created by putting two floodgates *in a row*, each one connected to one of the input triggers: XX. When both floodgates receive an on signal, they will open and let the water from the left side pass. The [pressure plate](Pressure_plate~2.md) behind the floodgates has to be constructed to react on 4-7 water.
...
Fluid logic offers options for comparatively small [memory](Memory_(computing).md) cells requiring very few mechanisms. They are usually quite primitive, so that more complicated memory manipulation requires additional machinery, but for simply "holding" a bit of information, they are hard to beat in compactness.
...
Design by [Hussell](https://dwarffortresswiki.org/index.php/User:Hussell/SetResetLatch).
...
**Categories:** [Migrated pages needing review](../Category/Migrated_pages_needing_review.md) &middot; [Unknown Quality Articles](../Category/Unknown_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [Constructions](../Category/Constructions.md) &middot; [Computing](../Category/Computing.md) &middot; [Logic](../Category/Logic.md)
