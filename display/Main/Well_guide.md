<!-- Mirrored from https://dwarffortresswiki.org/index.php/Well_guide (revision 313200).
     Generated by crawl.py - edit the wiki, not this file. -->

# Well guide

*[Source](https://dwarffortresswiki.org/index.php/Well_guide) &middot; revision 313200 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Well_guide.wiki)*

---
<table>
<tbody><tr><td><div><a href="https://dwarffortresswiki.org/index.php/File:Announce_migrant_icon.png"><img alt="Announce migrant icon.png" height="32" src="https://dwarffortresswiki.org/images/5/5f/Announce_migrant_icon.png" width="32"/></a></div></td><td>This article was migrated from <a href="../DF2014/Well_guide.md">DF2014:Well guide</a> and may be inaccurate for the current version of DF (v53.16). See <a href="../Dwarf_Fortress_Wiki/Version_migration.md">this page</a> for more information.  </td></tr></tbody></table>

<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Well_guide.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
<div><a href="../Dwarf_Fortress_Wiki/V.md">More Info</a> · <a href="../Template/Av.md">V</a></div></td></tr>
</tbody></table>

*This guide assumes you've read the main article on **[wells](Well.md)** and are familiar with the basic information found in that article, of what a well is used for and what is required to build one.*
...
Not every fortress needs a well. But they all need some form of safe *water source* to bring water to patients and prisoners. If they do not have this and you find yourself in a siege with six injured dwarves, you're in for a little bit of [Fun](Fun.md)... But a hole full of water can be just as good for that as a well.
...
You want a well central to your dwarves, so they'll all get good thoughts from seeing it, and near any [hospital](Hospital.md) beds you have, but you want it off the main traffic routes. You can have more than one well, which solves that problem, but raises the one of engineering water to feed them all. If it's indoors (or behind walls), then there's little threat from [carp](Carp.md), [goblins](Goblin.md), or [animals](Animal.md), and it can provide a safe source of drinking water during a [siege](Siege.md).
...
A well needs a water source of at least 3/7 depth, at least 1 [z-level](Z-level.md) somewhere directly below its opening, with no obstructions between itself and said water. Preexisting water is safe because it's the most predictable - what you see is what you've got, no surprises. You can instead use dwarven engineering to bring water from a distant source to beneath your well, with a safety factor based on your experience and the complexity of the project. (See [flood](Flood.md).)

The important part about the well is to make sure that you don't create a situation where the water will [flood](Flood.md) your fortress, due to [pressure](Pressure.md) from a source at a higher level. If the water is stable before you build the well above it, it will be safe (unless your dwarves change things), but if you are introducing a flow, make sure you understand how *dwarven* pressure works and will not fall victim to its surprises. (See [pressure](Pressure.md).)

#### Preexisting sources

A [brook](Brook.md), [river](River.md), [murky pool](Murky_pool.md), or [cavern](Cavern.md) lakes can provide water under a well. If the water source is only one z-level deep and contains a pile of mud, the water produced will be [muddy](Water.md#water-laced-with-mud). 'A dusting of mud', however, is not an issue - your well and its water is ~~fine~~ wonderful.

The surface of a brook tile will have to be channeled out, but it otherwise works just fine.

Murky pools are not optimal: they can dry up in warm seasons, and water directly from murky pools is [stagnant](Water.md#stagnant-water), which is just as bad as being muddy. Murky pools can refill from [rain](Rain.md), but on hot maps, this may never happen.
...
Oceans and aquifers near oceans carry [salty](Water.md#salt-water) water. This is normally unusable for treating wounds or drinking. However, salty water obtained from a well is used just like normal. This is a bug. <sup>[Bug](#bugs):[1260](https://dwarffortressbugtracker.com/view.php?id=1260)</sup>

#### [Reservoirs](Reservoir.md)
...
- Cut the Pressure. Filling a reservoir from above is a good way to cause a flood. You can neutralize the excess [pressure](Pressure.md) by including a diagonal passage in the aqueduct at or below the level of the well.
...
If you are draining water through an aqueduct, and you know there may be dangerous animals living in it, there are ways to prevent their entry. The simplest way to do this is to build a raising [bridge](Bridge.md#uses) at the intake. Unlike [floodgates](Floodgate.md), bridges are immune to [building destroyers](Building_destroyer.md) so absolutely nothing can get through when raised. Naturally when the bridge is not raised, anything is free to walk on in. If you wish to prevent entry when the bridge is not raised you can place [wall grates](Grate.md) or [upright bars](Bars.md) to act as filters. These allow water to pass through, but animals cannot. (Note that submerged [fortifications](Fortification.md) do **not** block creature movement.) Quickly [flowing](Flow.md) water, however, may push animals through wall grates and vertical bars, and both are vulnerable to level 2 [building destroyers](Building_destroyer.md). For the ultimate in aqueduct filtering, install a floor grate (or floor bars) such that the water flows *upwards* through the grate into your reservoir using [pressure](Pressure.md), and ensure that building destroyers coming from that direction cannot otherwise path into your fortress.
...
Enclosing the water, so that it is "indoors" will decrease the rate of evaporation, but there isn't much you can do to prevent water from freezing above ground. (There is a way, but if you're new, you may not enjoy [the prospects of actually constructing it](#fighting-the-ice).)
...
First, have magma on your map. If you don't, dig deeper and be prepared for [Fun](Fun.md).

Next, you need some [magma-safe](Magma-safe.md) materials. You'll need this to build floodgates and pumps.
...
This can be VERY useful when you have a larger reservoir that fills your well. This way every pull of the lever delivers a set amount of water into your well. Thus eliminating<sup>1</sup> the risk of flooding due to the well becoming pressurized.<br> <sup>1</sup>Beware dwarves that throw tantrums, they randomly pull levers.

---

**Categories:** [Migrated pages needing review](../Category/Migrated_pages_needing_review.md) &middot; [Unknown Quality Articles](../Category/Unknown_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [Bugs](../Category/Bugs.md) &middot; [Guides](../Category/Guides.md) &middot; [Design](../Category/Design.md)
