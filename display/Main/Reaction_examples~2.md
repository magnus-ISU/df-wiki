<!-- Mirrored from https://dwarffortresswiki.org/index.php/Reaction_examples (revision 309187).
     Generated by crawl.py - edit the wiki, not this file. -->

# Reaction examples

*[Source](https://dwarffortresswiki.org/index.php/Reaction_examples) &middot; revision 309187 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Reaction_examples~2.wiki)*

---
<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Reaction_examples.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
...
- Because it's a liquid, not a discrete item, you need to multiply the desired amount by its unit dimension (in this case, 150 liquid units per usable unit of honey). You can see the different dimension multipliers under [PRODUCT_DIMENSION](Reaction.md#product-dimension), below.

<br> Additionally, if one of your ingredients is typically **in** a container (such as with honey), you need to add a reagent for the container as well.
...
<br> Worn containers are always omitted from the selection pool, as are items in them. Held containers are valid receptacles, and items **in** containers (held or on the floor) are usually omitted unless specifically called for in the reaction (like with honey, above).
...
**Categories:** [Current](../Category/Current.md) &middot; [Modding](../Category/Modding.md) &middot; [Modding Examples](../Category/Modding_Examples.md)
