<!-- Mirrored from https://dwarffortresswiki.org/index.php/Talking (revision 318109).
     Generated by crawl.py - edit the wiki, not this file. -->

# Talking

*[Source](https://dwarffortresswiki.org/index.php/Talking) &middot; revision 318109 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Talking.wiki)*

---
<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Talking.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
<div><a href="../Dwarf_Fortress_Wiki/V.md">More Info</a> · <a href="../Template/Av.md">V</a></div></td></tr>
</tbody></table>

[![](https://dwarffortresswiki.org/images/thumb/c/cf/Advmode_conversation_ui_grafics.png/400px-Advmode_conversation_ui_grafics.png)](https://dwarffortresswiki.org/index.php/File:Advmode_conversation_ui_grafics.png)

[https://dwarffortresswiki.org/index.php/File:Advmode_conversation_ui_grafics.png](https://dwarffortresswiki.org/index.php/File:Advmode_conversation_ui_grafics.png)

Talking to someone in Adventurer mode.

|  |  |
| --- | --- |
| [![Adv ui k.png](https://dwarffortresswiki.org/images/7/70/Adv_ui_k.png)](https://dwarffortresswiki.org/index.php/File:Adv_ui_k.png)k | Talk to somebody |
...
To begin a conversation, press [![Adv ui k.png](https://dwarffortresswiki.org/images/7/70/Adv_ui_k.png)](https://dwarffortresswiki.org/index.php/File:Adv_ui_k.png)k. Select the creature you would like to have a conversation with using the cursor. Aside from individuals, you can also Shout out to everybody, which will have you talking with everyone in earshot, or talk to your [deity](Deity.md), or even [![Adv ui P.png](https://dwarffortresswiki.org/images/0/01/Adv_ui_P.png)](https://dwarffortresswiki.org/index.php/File:Adv_ui_P.png)P Begin Performance which includes such things as reciting poetry, telling stories or dancing, and is very important if you want to be a bard. Additionally, you can Assume an identity from the [![Adv ui k.png](https://dwarffortresswiki.org/images/7/70/Adv_ui_k.png)](https://dwarffortresswiki.org/index.php/File:Adv_ui_k.png)k menu, potentially changing your [reputation](Reputation.md).
...
- Refuse conversation — Causes you to explicitly refuse to talk to someone who started a conversation with you. Unknown if this has a different effect from simply not doing anything.<sup>\[[Verify](https://dwarffortresswiki.org/index.php?title=Talk:Talking&action=edit&redlink=1)\]</sup>
...
| Ask about somebody (new menu) | Allows you to ask about a specific creature's [reputation](Reputation.md). Useful to find out if they know somebody, what their relation might be, and what they think of them. |
...
| Investigate or interrogate (new menu) | Opens a menu with options to ask about the creature's master or boss and schemes or plots, using [social skills](Social_skill.md) like Persuader or Intimidator. |
...
| State your values (new menu) | Lets you state one of your [values](Personality_value.md). Doing so will start an argument with the listener if they have differing values, and can train your Persuader, Judge of Intent, Flatterer, Intimidator, and Pacifier [social skills](Social_skill.md) depending on how you argue. If you win the argument, your opposition's [values](Personality_value.md) will change to match yours. If you give in, yours will change. This can result in your needs changing. |
...
| Brag about your past violent acts | Causes you to brag about whatever was the last violent act you did. Doesn't seem to have an effect, or at least of severely less impact than summarizing the conflict.<sup>\[[Verify](https://dwarffortresswiki.org/index.php?title=Talk:Talking&action=edit&redlink=1)\]</sup> |
...
**Categories:** [Unknown Quality Articles](../Category/Unknown_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [Verify](../Category/Verify.md) &middot; [Adventurer mode](../Category/Adventurer_mode.md)
