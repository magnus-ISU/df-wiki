<!-- Mirrored from https://dwarffortresswiki.org/index.php/Megaproject (revision 315834).
     Generated by crawl.py - edit the wiki, not this file. -->

# Megaproject

*[Source](https://dwarffortresswiki.org/index.php/Megaproject) &middot; revision 315834 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Megaproject.wiki)*

---
<table>
<tbody><tr><td><div><a href="https://dwarffortresswiki.org/index.php/File:Announce_migrant_icon.png"><img alt="Announce migrant icon.png" height="32" src="https://dwarffortresswiki.org/images/5/5f/Announce_migrant_icon.png" width="32"/></a></div></td><td>This article was migrated from <a href="../DF2014/Megaproject.md">DF2014:Megaproject</a> and may be inaccurate for the current version of DF (v53.16). See <a href="../Dwarf_Fortress_Wiki/Version_migration.md">this page</a> for more information.  </td></tr></tbody></table>

<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Megaproject.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
...
The term **megaproject** refers to basically any project that takes a long time to build. See also other [challenges](Challenge.md).

Completed megaprojects should be uploaded to the [Dwarf Fortress Map Archive](../Utility/Dwarf_Fortress_Map_Archive.md) and posted on the [Bay12 Forums](http://www.bay12forums.com/smf/index.php?board=11.0). Incredible feats of construction are usually very [fun](Fun.md), so you'll see many different (and probably similar) constructions across the wiki.

Use whatever ideas you think are ingenious. More project ideas can be found where [stupid dwarves try crazy tricks](Stupid_dwarf_trick.md) - for some smaller-scale project ideas that still embody the dwarven spirit, see the [style projects](Style_project.md) page.
...
Variation: On a map containing a river, completely enclose it with glass walls, and floors. Use overhead pipe sections to move the water to places more ~~convenient~~ [Fun](Fun.md).
...
Build a castle, greater than anything built by human, elf or dwarf. This is highly time consuming if you want it to be a good castle. There must be floors indoors, and no underground constructions except for mining operations and cellars. For an even greater challenge, build a gigantic tower in the middle, where the nobles stay.
...
Can your dwarves build the [Antikythera mechanism](http://en.wikipedia.org/wiki/Antikythera_mechanism)? Can you program the fortress to play tic-tac-toe? More details at [computing](Computing.md).
...
- Requires a [magma pipe](Magma.md) and [bauxite](Bauxite.md).

Build a temple structure above a [magma pipe](Magma.md) and [engrave](Engraving.md) every available surface. The temple should be as opulent as possible. In the temple, build a retracting [bridge](Bridge.md) over a hole in the floor, and designate a [coffin](Coffin.md) [stockpile](Stockpile.md) on it. Whenever a dwarf dies, build a [bauxite](Bauxite.md) or other [magma-proof](Magma_safe.md) [coffin](Coffin.md) for him, place it on the [bridge](Bridge.md), and retract it, committing his body to the [fiery blood of the mountain](Magma.md).
...
- BONUS: Make a Sphinx out of solid gold. Solid! Nobody lives or goes inside of it. Entomb the builders in an [unfortunate accident](Unfortunate_accident.md) - preferably inside the sphinx - so that they can never build one for anybody else. Alternately, build a hollow Sphinx and house your nobles inside.
...
- Bonus: There must be only one male dwarf with burial labor enabled. Only his close male relatives can inherit the burial labor.
  - Bonus: Ensure he is a [vampire](Vampire.md), and that he is the last dwarf in your Fortress.
...
- Detail Bonus: Make the statues be of the deceased Dwarf and his or her accomplishments.
  - Dwarf Bonus: Carve every tomb out of [obsidian](Obsidian.md).
  - Extra Bonus: Make every coffin and every statue out of obsidian.
    - Magma Bonus: Edit the raws and make them out of [slade](Slade.md).
- Knife Bonus: Make a mass tomb specially designed for [hippies](Elf.md) that is suspended above the entrance to your fortress.
...
- Mega Bonus: Use [magma](Magma.md) instead of water.
- MEGA Bonus: Still use wood to make the ark.

#### Labyrinth

Build or dig out an elaborate labyrinth. It should be filled with traps, periodically flooded with water and magma, and decorated to your liking. Remember, no self-respecting labyrinth is complete without a [minotaur](Minotaur.md) or two roaming inside.
...
(A labyrinth is a [unicursal maze](http://www.astrolog.org/labyrnth/algrithm.htm): labyrinths offer no choices of path as they curve in and back on themselves to the endpoint. Mazes usually have choices of paths and therefore usually dead ends. Given how pathing will usually let sapient beings in DF avoid dead ends, a labyrinth is preferable to a traditional maze with dead ends.)

[Daedalus](http://sourceforge.net/projects/daedalus/) has many maze algorithms and tools, including for unicursal mazes (GPL, free). A [traditional maze generator](http://www.billsgames.com/mazegenerator/) may be helpful if you somehow open the dead ends (such as with drawbridges) to attract traffic.
...
MegaBonus: Trap [goblins](Goblin.md) and a [megabeast](Megabeast.md) in the various lower levels

UltraMultiverseDwarfyBonus: Build the real [Moria](https://web.archive.org/web/20180930023823if_/http://www.rpg-ash.me.uk/LotRO/moria_special_edition/moria_map.jpg)
...
Mr.CleanBonus: Rebuild the mountain out of [soap](Soap.md).

CandyFlossBonus: Rebuild the mountain out of [candy floss](Adamantine.md).

HeavyMetalBonus: Rebuild the mountain out of [steel](Steel.md).

ArmokBonus: Use adventure mode to raid multiple [candy storages](Vault.md) and rebuild it out of [Armok's favorite stuff](Divine_metal.md).
...
- BONUS: Use exploding [booze](Booze.md) as ignitable fuel. (It doesn't actually explode. It just boils into a gas...)
- BONUS: Make a removable [ramp](Ramp.md) for boarding.
- BONUS: Make the [water](Water.md) for the 2 years be on the ship using removable pumps.
- BONUS: Bring an aquifer with you to get an infinite supply of water!
- BONUS+: Make it totally self-sufficient. (Make an internal system which pumps the [water](Water.md) supply through a room every few years to muddy the floor. Plant [seeds](Seed.md) in the [mud](Mud.md) that's now on the floor. Manage your consumption to maintain self-sufficiency.)
- Modding BONUS: Mod the game so that merchants can fly their new wagonships into your docking bays. *(If possible)*
- BONUS+: Make it all out of [steel](Steel.md) and [aluminum](Aluminum.md).
- [FUN](Fun.md): Let it be held by a single [support](Support.md), ignite the [booze](Booze.md), remove the support an let it "fly".
- EVEN BETTER: ~~Drop~~ Fly it down a chasm.
- More [FUN](Fun.md): Set up a mining operation on the surface and dig into the HFS. Watch the alien creatures take over your ship and hunt down your dwarves. Form a squad of heroes to overload the booze reactor to prevent the aliens from reaching earth. (See [Dead Space](http://en.wikipedia.org/wiki/Dead_Space_%28video_game%29) and/or [the Alien series](http://en.wikipedia.org/wiki/Alien_%28film%29))
...
[![](https://dwarffortresswiki.org/images/thumb/a/ad/Surveillance_track.png/300px-Surveillance_track.png)](https://dwarffortresswiki.org/index.php/File:Surveillance_track.png)

[https://dwarffortresswiki.org/index.php/File:Surveillance_track.png](https://dwarffortresswiki.org/index.php/File:Surveillance_track.png)

A site-wide surveillance track

Build an elevated [minecart](Minecart.md) track around the edges of the map, and send out civilians riding minecarts to spot ambushers and distract enemy archers.
...
Designing a temple to Armok. Aesthetics count - the god will be very angry if there are no stained-glass windows and domed ceilings carved with frescoes. To gain more favor, make regular sacrifices and make fountains and rivers that run red with [blood](Blood.md).

- Bonus: Make the glass windows stained with blood.
- Bonus: Spill blood everywhere.
- AztecBonus: Make it so it's a stepped pyramid. Perform sacrifice with your [priests](Military.md) on top of the statue, preferably with [obsidian](Obsidian.md) short swords.
...
- Bonus: Add [menacing spikes](Menacing_spike~2.md).
...
- TrueBelieverBonus: Same, but make it inside the [magma sea](Magma_sea.md).
- ArmokFanaticBonus: Same, but make it inside [HFS](HFS.md). Sacrifice its denizens for Armok! Alternatively, make it inside an adamantine spire and enjoy your engraved, all-natural raw adamantine walls.
...
Disaster has struck the kingdom. A strangely glowing [‼peasant‼](Fire.md) visited the greatest brewery of the empire, and as a result the whole thing exploded. No time for weeping — create its successor, a fort dedicated to alcohol production, and get the alcohol supplies flowing! Try to make the widest variety possible, and give or trade it to the dwarven [caravan](Caravan.md) each year.
...
Encase your entire fortress in [water](Water.md)! Your fortress should be watersealed: surrounded by water against all [walls](Wall.md) and the top of the fortress.

- Bonus: Build all water-touching walls/roof in clear glass!
- Bonus: Use [magma](Magma.md) instead of water (warning: will almost certainly lead to [fun](Fun.md))!
- Bonus: Build it in the [ocean](Ocean.md) or a non-freezing lake
...
- Remake: Make Rapture city from [Bioshock](http://en.wikipedia.org/wiki/Bioshock)
...
- Remake: Make Columbia from [Bioshock Infinite](http://en.wikipedia.org/wiki/BioShock_Infinite)
...
Embark site biome parameters: Mountain. Fortress shape: Cubicle (assume 7 tiles high), cut from natural rock and separated from the remaining stone so it is held by a single support. Migrant dwarves must report to assimilation chamber where a collapsing dust trap will launch them into large serrated disk [traps](Trap_component.md) to remove unnecessary appendages, or have their offending limbs removed some other way. Dorf drones must be cataloged and arranged in squads of varying number. The naming structure is as follows: First of Ten, Second of Ten, and so on. Clothing is irrelevant.

There is no trade, or unmerited contact with lesser species, they will be assimilated. Nobles are irrelevant. Economy is irrelevant. Solitary creatures that do not pose a notable threat to the Collective are not to be bothered with when there is important work to do. Corpses are to be vaporized or atom-smashed along with all [other useless material](Noble.md). Cage traps should be common.
...
- Give the evil mastermind a pet to obsess over. Give it a name like Mr. Bigglesworth or Snuggles. Even better if it's something really dangerous like a Giant Desert Scorpion.
  - BONUS: With modding, make the evil mastermind's pet a [clown](Demon.md), [megabeast](Megabeast.md), [forgotten beast](Forgotten_beast.md), or [titan](Titan.md).
...
<br> Doomsday device suggestions:
...
- Build [Mechanical Volcano](https://dwarffortresswiki.org/index.php/User:Vattic/Mechanical_Volcano_Explained) to flood entire map with searing magma.
...
4. All criminals must be cast into the fires of Hell. Ideally, this would either be HFS or the bottom of a magma pipe. Or both.
...
BONUS: No dwarves are ever unhappy -- no tantrums and no insanity.<br> BONUS: When migrants arrive at the pearly gates, view their thoughts and preferences and only allow those with a similar/same Deity as your population.<br> BONUS: Make Heaven 10 stories above the ground<br> Mod: Make Angel dwarves and a godly being. (suggestions: Cacame, Morul, Ironblood.)<br> ULTRABONUS: Make Heaven in the air, an earthly society on the ground (a wooden town perhaps?), and carve the HFS place into Hell, complete with a lake of Magma/fire. Look up the character of every dwarf and send him to the appropriate place.<br> MEGABONUS-(Re)Make: The Seven Seals have been broken and the Apocalypse arrives.
...
1. Make your entire fortress supported by one support.
2. on year 5, remove the support so your entire fortress drops one level.
3. Tell us the death rate.
4. double the height of the support every year, see how much is too much of a drop!

#### Pull A Boatmurdered

What's this? Too many goblins? Not enough fun? You may be needing excess amounts of lava!

1. Flood the entire map with water or lava
2. Maybe both and have an obsidian farm in the center
3. Pump all lava resources to the surface and watch it burn!

Most famously employed in [Boatmurdered](Boatmurdered.md).

#### Hippie Exterminator

Much like trees, better water those elves.

1. It's a gigantic drowning chamber for [Elves](Elf.md).
2. Construct a very long wall all the way around a [forest retreat](Forest_retreat.md)
3. Build a floor on top, sealing them in
4. Connect some screw pumps to this and the local water supply
5. Really processor intensive! Not for calculators!

1. At nothing else, at least build the box around your Trade Depot, and flood it when Elves are inside.
2. Drainage can be done with a [floodgate](Floodgate.md) to release the water from the depot.

#### Dwarven Arcology

1. Build your entire fortress above ground in one structure.
2. A subterranean level (the basement) on the bottom floor provides plump helmets, pig tails, and so on.
3. On the ground floor, grow above-ground plants and carve fortifications into all the walls.
4. Every other level is packed with food stores, refuse dumps, wood stockpiles, workshops, archery ranges, and bedrooms.
5. The only subterranean activity permitted is digging, although you may be able to get away with building your depot below ground.

Bonus: Cast the entire thing in Obsidian using magma and water and engrave all the sides with your greatness.

#### D For Dwarvendetta

1. Create the Parliament building or some such construction
2. Rig it to explode or collapse spewing lava everywhere
3. Detonate the fortress while you play the 1812 Overture somewhere

Bonus: make an underground [minecart](Minecart.md) track that detonates it. Bonus: make a metal statue at the top which gets exploded.

UnfortunateBonus: Make your nobles live inside the building to be destroyed.

MegaBonus: send burning [graphite](Graphite.md) or [lignite](Lignite.md) flying into the (strangely always daytime) sky.

CosmicBonus: Have an important Dwarf in a coffin play a role in detonating it.

#### The Two Towers

1. Build a ring of stone \[may be slightly difficult\] and build a tower with four blades protruding from the top
2. Build a (much larger) tower with only two blades protruding from the top
3. Have the two towers combat each other *without* siege weapons

Bonus:

1. Rig the first one to flood and the second to explode! (and you only get the points if you've seen the movies and record the videos. Try to make the towers' destruction as close to the movies as you can!)
...
*"There is one tale that tells about [a place](HFS.md) that only few have seen, and even fewer have returned from... A place beyond the grasp of our hands, beyond the reach of our picks... A place composed of stone that has been there since the beginning, and will remain there after our demise... [A stone](Slade.md) unmoved by the swing of our picks, material that only [fools](Noble.md) would demand... Yet we managed to [scratch its surface](Engraving.md), and now we plan to cast an entire history of our kin onto it, an artwork that no magma will melt, no beasts nor men will ever be able to destroy. A true dwarf would want to go for it. And you surely do."*

- Bonus: Also engrave walls of [the pits](Eerie_glowing_pit.md).
- LegendaryBonus: Use only legendary engravers.
- [☼](Masterwork.md)LEGENDARY BONUS[☼](Masterwork.md): Make sure every engraving has masterwork quality.
...
Minecarts have finally been added! Use them to transport dwarves and goods around the fortress! BONUS: Build several mini-fortresses, each devoted to a different industry or other purpose (e.g., trade, mining, living quarters, etc.). Only minecarts can be used to travel between these mini-forts. Essentially make dwarven Panem!
...
Create a road of gold bars leading from a small village of [mountain gnomes](Mountain_gnome.md), to a large city of [green glass](Green_glass~2.md) (or mod the game to allow using [emeralds](Emerald.md) as building materials.) Have a patrol along the road consisting of a female child (human if you can manage it somehow) wearing [ruby](Ruby.md)-encrusted shoes, a [puppy](Dog.md), an [iron man](Iron_man.md), a [titan](Titan.md) made of grass or wheat, and a [lion](Lion.md).

Capture a female [necromancer](Necromancer.md), install her in a dark-colored fortress, and give her the corpses of [spider monkey men](Spider_monkey_man.md) to resurrect. If you like, mod them to be able to fly.
...
Go to a free family tree generator and add as many characters as you want/can ([this](http://myheritage.com/) website is a good choice). Not even Legends Viewer will be able to compete with the sheer awesomeness of having the list of your dwarves' relatives (and kills) right up to year one.
...
- Masochism bonus: give figurative trees to those tree-huggers and make a tree for nigh-immortal (and who mate like ~~bunnies~~ [unicorns](Unicorn.md)) elves.
...
- Artifact bonus: somehow get a hold of a [legendary ~~dwarf~~](http://www.bay12forums.com/smf/index.php?topic=89305.0) character's savegame, and show us who their ancestors were.
- Mission Impossible Bonus: Do it for as many characters in a "very long history" world.

#### Dwarven Tower Defense

Make a maze (the longer the better) such that any siege that should be laid to your fortress will have to go through it. Add towers that fire upon or unleash your armies as they pass. Towers can include:

- Marksdwarf tower
- [Doberman bomb](Stupid_dwarf_trick.md#doberman-bomb)
  - Point Multiplier: Automate it with pressure plates
- Fire Turret: Trap [magma crabs](Magma_crab.md) and [fire imps](Fire_imp~2.md) in magma safe cage traps from the magma sea and make a tower.
- [Dwarven Traps](Trap.md)
- [VERY Dwarven Traps](Stupid_dwarf_trick.md)
- Your most [Skilled Fighters](Noble.md)

Go to war with everyone (no treaties) and leave the Dwarves open. This means no lock in, no bridge seal, no impossible death. If they get through, you lose. Remember the scoring on this too:

- Average Wave: Elves
- Normal Wave: Goblins
- Harder Wave: Humans
  - (You can kill humans because humans aren't people. Only dwarves are people.)
- Boss Wave: [Cellar Dwellers](Forgotten_beast.md) and [Nomadic Threats](Titan.md)
- Final Wave: [The Clowns](HFS.md)
...
Build one big tower that fulfills multiple defensive purposes. Here are some ideas:
...
Make a large, circular tower, with water running down paths along the inside of the tower. Make the water fall through grates or bars so the dwarf can get out. Allow the dwarf to go into the water at the top using a retracting bridge. Also fairely useful, as it both cleans your dwarves and has all the benefits of a downwards-only [Watervator](https://dwarffortresswiki.org/index.php/v0.34:Stupid_dwarf_trick#Watervator). It is less practical in its functioning than a Watervator, however, but it can be made to generate mist.
...
Use dfhack with advfort to build a worldwide railroad. Use disposable/retired 16x1 embarks to make the game remember what you've done, and to provide raw materials.

Put stations at every friendly settlement. A basic station consists of something that forces incoming carts to stop, and some space between the stop and the next track. Travellers will have to walk to the next track at each stop. A station should have a stockpile of minecarts ready for travelers.

Above-ground rails are nicer (you get to see the sights as you travel). Below-ground rails are easier to build (you can mine instead of using blocks). Either variant can be powered by impulse ramps or rollers. Rollers can be powered by either windmills or water reactors, or, if you're close to a river, ordinary water wheels. To allow bidirectional travel, you can build two rails per link.
...
- Wall off that [special cavern](Hell.md) below the magma sea.
...
- EXPORTING THE REVOLUTION BONUS!!: Conquer and ~~occupy~~ liberate 10 neighboring settlements to spread the great idea of communism!
...
- STUDENT PROTEST BONUS: Have your unhappy university staff and students ~~tantrum~~ protest peacefully over issues such as textbook prices, bad cafeteria food, or terrible dorm conditions. Deal with it accordingly.
...
Have a fortress made purely of YOUR OWN ADVENTURE MODE dwarf adventurers with legendary [skill](Skill.md) in all military stuff.
...
**Categories:** [Migrated pages needing review](../Category/Migrated_pages_needing_review.md) &middot; [Unknown Quality Articles](../Category/Unknown_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [Needs update](../Category/Needs_update.md) &middot; [Design](../Category/Design.md)
