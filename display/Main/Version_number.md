<!-- Mirrored from https://dwarffortresswiki.org/index.php/Version_number (revision 290278).
     Generated by crawl.py - edit the wiki, not this file. -->

# Version number

*[Source](https://dwarffortresswiki.org/index.php/Version_number) &middot; revision 290278 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Version_number.wiki)*

---
<table>
<tbody><tr><td><div><a href="https://dwarffortresswiki.org/index.php/File:Announce_migrant_icon.png"><img alt="Announce migrant icon.png" height="32" src="https://dwarffortresswiki.org/images/5/5f/Announce_migrant_icon.png" width="32"/></a></div></td><td>This article was migrated from <a href="../DF2014/Version_number.md">DF2014:Version number</a> and may be inaccurate for the current version of DF (v53.16). See <a href="../Dwarf_Fortress_Wiki/Version_migration.md">this page</a> for more information.  </td></tr></tbody></table>

<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Version_number.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
...
When software is in the early stages of development, such as alpha or beta, it will likely have version numbers starting with zero, such as 0.3 or 0.23.5. This is currently the case with *[Dwarf Fortress](Dwarf_Fortress.md)*.

[Tarn Adams](Toady.md) assigns a version number for every *Dwarf Fortress* release. Version numbers contain two number sections defining the release information, but don't let this deceive you: the system is more complicated than simple [semantic versioning](https://semver.org/). Releases from 2009 and earlier contained *four* numbers and a letter - see the [older versions of this page](https://dwarffortresswiki.org/index.php/40d:Version_number) for more information.

1. The first number is how many hundreds of core components have been completed.
2. The second number is the total number of [core](http://www.bay12games.com/dwarves/dev.html) components completed.
...
v53.16, the 16th minor release of the version of *Dwarf Fortress* with 53 core components complete.
...
<tr>
<td colspan="2">Fewer than 100 <b>core</b> components complete
</td>
<td><div></div>
</td>
<td colspan="8">53 <b>core</b> components completed
</td>
<td><div></div>
</td>
<td colspan="2">16th <b>minor</b> release
</td></tr></tbody></table>
...
**Categories:** [Migrated pages needing review](../Category/Migrated_pages_needing_review.md) &middot; [Unknown Quality Articles](../Category/Unknown_Quality_Articles.md) &middot; [Game development](../Category/Game_development.md) &middot; [Current](../Category/Current.md)
