<!-- Mirrored from https://dwarffortresswiki.org/index.php/D_init.txt (revision 311453).
     Generated by crawl.py - edit the wiki, not this file. -->

# D init.txt

*[Source](https://dwarffortresswiki.org/index.php/D_init.txt) &middot; revision 311453 &middot; retrieved 2026-09-11 &middot; [wikitext](../../mirror/wikitext/Main/D_init.txt.wiki)*

---
<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/D_init.txt.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
...
> *These settings are covered in more detail in [Settings](Settings.md).*
...
<table>
<tbody><tr><th scope="col"><div><a href="D_init.txt/raw.md">d_init_default.txt</a></div></th></tr>
...
If set to YES, will turn on multithreading features. This is likely to result in a small increase to FPS.

[MULTITHREADING:YES]

Worn clothing on certain creatures can be displayed either using the dye color or to indicate the profession.  The default is to show professions in fortress mode and dyes in adventure mode.

[DISPLAY_CLOTHING_WITH_DYES_IN_FORT_MODE:YES]
[DISPLAY_CLOTHING_WITH_DYES_IN_ADV_MODE:YES]

In Classic ASCII mode, rough ground tiles are chosen from among ,.'`.  If the following option is set to NO, only the period will be used.

[CLASSIC_VARIED_GROUND_TILES:YES]

Show the dimensions of rectangles as you drag them out.

[SHOW_RECTANGLE_DIMENSIONS:YES]

Set the scroll speeds when using the keyboard.
...
[VERTICAL_SCROLL_SPEED_WORLD_FAST:20]</div></td></tr></tbody></table>

### Bugs

- The text in the file says you need a population of 80 for a [monarch](Monarch.md), but you actually need [110](Difficulty.md#fortress-rank), and technically, that is for becoming a [city](Fortress.md#nomenclature), which is what the monarch requires.
...
**Categories:** [Fine Quality Articles](../Category/Fine_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [Bugs](../Category/Bugs.md) &middot; [Files](../Category/Files.md)
