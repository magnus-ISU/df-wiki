<!-- Mirrored from https://dwarffortresswiki.org/index.php/Dwarf (revision 317021).
     Generated by crawl.py - edit the wiki, not this file. -->

# Dwarf

*[Source](https://dwarffortresswiki.org/index.php/Dwarf) &middot; revision 317021 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Dwarf.wiki)*
...
<tbody><tr>
<td colspan="2">
<div><a href="https://dwarffortresswiki.org/index.php/File:Dwarf_sprite.png"><img alt="Dwarf sprite.png" height="128" src="https://dwarffortresswiki.org/images/4/46/Dwarf_sprite.png" width="81"/></a></div>
<div>☺</div>
<p>Toggle
</p>
</td></tr>
...
<tr>
<td colspan="2">
<div><div><a href="https://dwarffortresswiki.org/index.php/File:Dwarf_portrait_anim.gif"><img alt="Dwarf portrait anim.gif" height="82" src="https://dwarffortresswiki.org/images/b/b2/Dwarf_portrait_anim.gif" width="66"/></a></div></div>
</td></tr>
<tr>
<th colspan="2">Biome
</th></tr>
...
<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Dwarf.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
<div><a href="../Dwarf_Fortress_Wiki/V.md">More Info</a> · <a href="../Template/Av.md">V</a></div></td></tr>
</tbody></table>

> *A short, sturdy creature fond of drink and industry.*

[![](https://dwarffortresswiki.org/images/thumb/4/41/Bersek_dwarf.png/300px-Bersek_dwarf.png)](https://dwarffortresswiki.org/index.php/File:Bersek_dwarf.png)

[https://dwarffortresswiki.org/index.php/File:Bersek_dwarf.png](https://dwarffortresswiki.org/index.php/File:Bersek_dwarf.png)

«*Berserk Dwarf*». Art by [Jeff Agudelo](https://dwarffortresswiki.org/index.php/User:Jeff_Agudelo)

[![](https://dwarffortresswiki.org/images/thumb/3/3f/Full_steel_dwarf.png/300px-Full_steel_dwarf.png)](https://dwarffortresswiki.org/index.php/File:Full_steel_dwarf.png)

[https://dwarffortresswiki.org/index.php/File:Full_steel_dwarf.png](https://dwarffortresswiki.org/index.php/File:Full_steel_dwarf.png)

«*Full steel warrior*». Art by [Jeff Agudelo](https://dwarffortresswiki.org/index.php/User:Jeff_Agudelo)
...
**Dwarves** (singular, **Dwarf**) are ["intelligent"](Stupid_dwarf_trick.md), [alcohol](Alcohol.md)-[dependent](Creature_token~2.md#alcohol-dependent), [humanoid](../Category/Humanoids.md) [creatures](Creature.md) that are the featured [race](Civilization.md) of [fortress mode](Fortress_mode~2.md), as well as being playable in [adventurer mode](Adventurer_mode.md). They are well known for their stout physique and prominent [beards](Beard.md) (on the males), which begin to grow from birth; dwarves are stronger, shorter, stockier, and hairier than the average [human](Human.md), have a heightened sense of their surroundings and possess perfect darkvision. Dwarves live both in elaborate underground [fortresses](Fortress.md) carved from the [mountainside](Mountain.md) and above-ground [hillocks](Hillock.md), are naturally gifted [miners](Miner.md), [metalsmiths](Metalsmith.md), and [stone crafters](Stone_crafter.md), and value the acquisition of [wealth](Wealth.md) and [rare](Value.md) [metals](Metal.md) above all else.

Dwarven civilizations typically form (mostly) peaceful, trade-based relationships with [humans](Human.md) and [elves](Elves.md), but are bitter enemies with [goblins](Goblin.md), and consider [kobolds](Kobold.md) a petty annoyance. Dwarven babies become [children](Children.md) one year after birth, grow up to become adults at their eighteenth birthday, and live to be around 150-170 years of age.

Well-trained dwarves are a menace in combat; they are the only race that can enter a [martial trance](Martial_trance.md) when beset by multiple foes, granting them a major combat bonus, and their emphasis on mining and metalworking ensures access to the best [arms](Weapon.md) and [armor](Armor.md). They are incapable, however, of riding [mounts](Mount.md), and will always fight on foot. Note, however, that this is only applicable to player controlled dwarves in fortress mode, as they have access to mounts if they are the invading force of a [siege](Siege.md).

Dwarves speak the [dwarven language](Dwarven_language.md).

Some non-dwarves [like](Preferences.md) dwarves for their *beards*.

### Fortress mode

Dwarves are the current default race in fortress mode, as in, the only one that can be played without [modding](Modding.md). As a [trading](Trading.md) race, dwarves will send a [caravan](Caravan.md) every year in [Autumn](Calendar.md). These merchants will bring back tales of a fortress's wealth and goods, which will attract [immigrants](Immigration.md), and the [outpost liaison](Outpost_liaison~2.md) will bring news about the goings-on of the world centered mainly on the player's civilization, including results of [mayoral](Mayor.md) elections, flight of various refugee groups from their forts and hillocks during [wars](War.md), and replacement of [monarchs](Monarch.md), if the previous incumbent dies with or without an heir.

Dwarves may occasionally be [inspired](Strange_mood.md) to create a [legendary artifact](Legendary_artifact.md), an item of masterful craft and great value. A dwarf who is successful in this quest will, in most cases, become a [legendary](Skill.md) worker in that profession; however, if the appropriate materials are not available, the dwarf will instead go [insane](Insanity.md). Dwarves with the dream of creating a great work of art long for a strange mood to strike them.

Being underground creatures, dwarves are not fond of the sun, and when exposed to it after [spending long enough in the dark](Cave_adaptation.md), they will experience negative thoughts and vomiting, which will be worse and last for longer the longer they have spent underground.

Dwarves react to stress depending on their [personality facets](Personality_facet.md); some react with fear or violence unless they've become sufficiently [disciplined](Discipline.md) (or numbed) to such things, while others will not feel anything unless the stress is particularly personal. When pushed to unhappiness by unfortunate events, dwarves will go into [emotional breakdowns](Mental_breakdown.md) depending on their personalities, ranging from [depression](Depression.md) to aggressive [tantrums](Tantrum.md) – it is not uncommon to find tantruming dwarves overturning furniture, injuring others, and generally being rowdy. Nevertheless, they also have a strong sense of [justice](Justice.md), and those who damage property or other dwarves may find themselves incarcerated, or – in extreme cases – on the receiving end of the [hammerer](Hammerer.md)'s corporal punishment, though unintentionally fatal beatings from the fortress guard are not unusual. While older versions of the game were famed for their "tantrum spirals", where dwarves would enrage each other in a domino effect and destroy the fortress in the process, these are not as common in the current day, though a stressed dwarf is nonetheless a plentiful source of [fun](Fun.md).

### Needs

As living creatures, dwarves need to [drink](Thirst.md), eat [food](Food.md), and [sleep](Sleep.md) to survive. On average, a dwarf needs to drink every 18 days, eat every 35 days, and sleep every 40 days. Dwarves prefer [alcohol](Alcohol.md) and are uniquely alcohol-dependent; if deprived for long enough, a dwarf will suffer from withdrawal and will work slower.

Dwarves also have a variety of emotional [needs](Needs.md) that arise from their [personality facets](Personality_facet.md) and [values](Personality_value.md). A typical dwarf may need to acquire [objects](Finished_goods~2.md), eat [good](Item_value.md) [meals](Prepared_meal.md), maintain their [relationships](Relationship.md), hone their [skills](Skills.md) (often in [crafting](Industry.md), but could also be [martial](Combat_skill.md) or [intellectual](Library.md)), or enjoy a [performance](Performance.md).

### Adventurer mode

Dwarven fortresses can be explored in [Adventurer mode](Adventurer_mode.md), both in their world-generated and player-made forms. They can be a good source of dwarf-sized [armor](Armor.md), as [human](Human.md) armor is too large for dwarves. As the layout of underground [fortresses](Fortress.md) and [mountain halls](Mountain_halls.md) are considered to be [too confusing](http://www.bay12forums.com/smf/index.php?topic=169696.msg8565801#msg8565801) to navigate, it is not possible<sup>v51.01</sup> for adventurers to start from there. Dwarven adventurers must start at other [site](Site.md) types, such as [hillocks](Hillocks.md) or those founded by another [civilization](Civilization.md).

Dwarves have the notable ability to see perfectly well in the dark, either at night or [underground](Underground.md). They can also enter [martial trances](https://dwarffortresswiki.org/index.php?title=Martial_trances&action=edit&redlink=1) under the same conditions as they would in Fortress mode. Most human weapons must be wielded two-handed by dwarves, due to their size, except, of course, the weapons that dwarves can also make.
...
This is a crayon drawing. All craftsdwarfship is of the highest quality. On the item is an image of dwarves in crayon. The dwarves are laughing. The dwarves are dancing. On the item are signatures of [Zach](ThreeToe.md) and [Tarn Adams](Toady_One.md) in crayon.
...
In accounts of exploits or [fun](Fun.md), the generic name *[Urist](Urist.md)* is often used in place of any specific dwarf [name](Name.md), often because the default dwarf names are complex, random, and hard to remember. Several other nicknames for dwarves also exist; some are less polite than others.
...
[Template:Creatures](../Template/Creatures.md)

---

**Categories:** [Pages containing omitted template arguments](../Category/Pages_containing_omitted_template_arguments.md) &middot; [Pages where template include size is exceeded](../Category/Pages_where_template_include_size_is_exceeded.md) &middot; [Masterwork Quality Articles](../Category/Masterwork_Quality_Articles.md) &middot; [Learns](../Category/Learns.md) &middot; [Humanoids](../Category/Humanoids.md) &middot; [Current](../Category/Current.md) &middot; [D for Dwarf](../Category/D_for_Dwarf.md) &middot; [Races](../Category/Races.md) &middot; [Creatures](../Category/Creatures.md)
