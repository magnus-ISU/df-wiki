<!-- Mirrored from https://dwarffortresswiki.org/index.php/Dwarf_Fortress_RPG (revision 245916).
     Generated by crawl.py - edit the wiki, not this file. -->

# Dwarf Fortress RPG

*[Source](https://dwarffortresswiki.org/index.php/Dwarf_Fortress_RPG) &middot; revision 245916 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Dwarf_Fortress_RPG.wiki)*

---
**Multiplayer Adventure Mode**, also known as the **DF Role-Playing Game**, was a fun little gaming get-together of a few players from the forums using the QAGS role-playing system. These are the game logs and summaries of each session. The original forum thread: [http://www.bay12games.com/forum/index.php?topic=2029.0](http://www.bay12games.com/forum/index.php?topic=2029.0)
...
After a small break, we ran [the fifth session](http://docs.google.com/Doc?id=dgc7d3rc_4c593cs). Pathos (aka Urtur) and Xotes (Rakust) joined the game here. The dwarves are waiting to get their immigration papers, in order to move back to the capital and somehow restore the King to power, or at least obtain their prizes. Tok goes back to the kitchens, while the immigration officer munches on her lunch. Edos tries to talk her into cutting her lunch break short, but she's having none of it.
...
The dramatic conclusion: [the sixth session](http://docs.google.com/Doc?id=dgc7d3rc_8cdrmpb). Flamester (Athel) joined us. I'm too lazy to summarize it so go read the log!
