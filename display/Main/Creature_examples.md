<!-- Mirrored from https://dwarffortresswiki.org/index.php/Creature_examples (revision 307769).
     Generated by crawl.py - edit the wiki, not this file. -->

# Creature examples

*[Source](https://dwarffortresswiki.org/index.php/Creature_examples) &middot; revision 307769 &middot; retrieved 2026-09-11 &middot; [wikitext](../../mirror/wikitext/Main/Creature_examples.wiki)*

---
<table>
<tbody><tr><td><div><a href="https://dwarffortresswiki.org/index.php/File:Announce_migrant_icon.png"><img alt="Announce migrant icon.png" height="32" src="https://dwarffortresswiki.org/images/5/5f/Announce_migrant_icon.png" width="32"/></a></div></td><td>This article was migrated from <a href="../DF2014/Creature_examples.md">DF2014:Creature examples</a> and may be inaccurate for the current version of DF (v53.16). See <a href="../Dwarf_Fortress_Wiki/Version_migration.md">this page</a> for more information.  </td></tr></tbody></table>

<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Creature_examples.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
...
You can also give it an [ITEMCORPSE](Creature_token~2.md#itemcorpse) if you want it to leave an item behind.
...
**Categories:** [Migrated pages needing review](../Category/Migrated_pages_needing_review.md) &middot; [Exceptional Quality Articles](../Category/Exceptional_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [Modding](../Category/Modding.md) &middot; [Modding Examples](../Category/Modding_Examples.md)
