<!-- Mirrored from https://dwarffortresswiki.org/index.php/Stockpile_design (revision 318077).
     Generated by crawl.py - edit the wiki, not this file. -->

# Stockpile design

*[Source](https://dwarffortresswiki.org/index.php/Stockpile_design) &middot; revision 318077 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Stockpile_design~2.wiki)*

---
<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Stockpile_design~2.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
...
> Cancellation due to bins were supposed to have been fixed in [50.01](Release_information/50.01.md) and be much less of a problem now, but this section needs in game verification of whether any of these are still issues.
...
Now, place a plant stockpile by each workshop that uses plants ([still](Still.md), [farmer's workshop](Farmer's_workshop~2.md), etc.), set it to take from links only, and link it to take from the "source" stockpile. Ideally, each of these workshop-feeding stockpiles will take only an appropriately chosen subset of the plants (the still takes only brewable plants, while the farmer's workshop for the textile industry only takes plants that can be processed into [thread](Thread.md), and so on). You may choose whether to allow barrels on a case by case basis, depending on how many of each plant you expect to have at once, how time-critical their processing is, etc.
...
One strategy is to place the feeder stockpile immediately around the workshop. This works well for single workshops with just one input (like a [mason's](Mason's_workshop~2.md) or [mechanic's workshop](Mechanic's_workshop~2.md)).
...
[Farms](Farming.md) feed a wide array of workshops. Plants from farms may directly feed the [kitchen](Kitchen.md), [still](Still.md), [millstone](Millstone.md) (or [quern](Quern.md)) and [farmer's workshop](Farmer's_workshop~2.md). The mill and farmer's workshop feed the [loom](Loom.md) and [dyer](Dyer.md) which feed the [clothier](Clothier.md). Farms are in turn supplied seeds from the still, mill, farmer's workshop and dining rooms, completing the cycle of plant life.
...
Because tanners are supplied directly from a butcher it's best to put them right next to each other. Designate a refuse stockpile taking Corpses for the butcher. Let the hides sit in the [butcher's shop](Butcher's_shop~2.md), and the tanner will take them directly to the [tanner's shop](Tanner's_shop~2.md) with no hauling jobs required.
...
A food stockpile accepting meat/fish, raw edible [plants](Crop.md)\*†, [cheese](Cheese.md), [leaves](Quarry_bush~2.md), cookable [milled](Millstone.md) plants (everything but the [dyes](Dye.md)), [fat](Fat.md)†, cookable [extracts](Extract.md) ([Dwarven syrup](Dwarven_syrup.md) and all the [milks](Milk.md)†). If you cook [booze](Alcohol.md), include that. If you want to reserve some edible plants for [brewing](Still.md), leave them out. Allow the maximum barrels. Remember to turn off prepared food.

> *(\* [plump helmet](Plump_helmet.md), [muck root](Muck_root.md), [bloated tuber](Bloated_tuber~2.md), [prickle berry](Prickle_berry.md), [strawberry](Strawberry.md), [rat weed](Rat_weed.md), [fisher berry](Fisher_berry.md) and [sun berry](Sun_berry.md))*
...
**Categories:** [Unknown Quality Articles](../Category/Unknown_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [Design](../Category/Design.md) &middot; [Guides](../Category/Guides.md) &middot; [Stockpiles](../Category/Stockpiles.md)
