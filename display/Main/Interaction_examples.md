<!-- Mirrored from https://dwarffortresswiki.org/index.php/Interaction_examples (revision 304647).
     Generated by crawl.py - edit the wiki, not this file. -->

# Interaction examples

*[Source](https://dwarffortresswiki.org/index.php/Interaction_examples) &middot; revision 304647 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Interaction_examples.wiki)*

---
<table>
<tbody><tr><td><div><a href="https://dwarffortresswiki.org/index.php/File:Announce_migrant_icon.png"><img alt="Announce migrant icon.png" height="32" src="https://dwarffortresswiki.org/images/5/5f/Announce_migrant_icon.png" width="32"/></a></div></td><td>This article was migrated from <a href="../DF2014/Interaction_examples.md">DF2014:Interaction examples</a> and may be inaccurate for the current version of DF (v53.16). See <a href="../Dwarf_Fortress_Wiki/Version_migration.md">this page</a> for more information.  </td></tr></tbody></table>

<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Interaction_examples.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
<div><a href="../Dwarf_Fortress_Wiki/V.md">More Info</a> · <a href="../Template/Av.md">V</a></div></td></tr>
</tbody></table>

This page was created to aid those curious about the [interaction](Interaction_token.md) process by providing example interactions for them to use or study. Those familiar with interaction raws should feel free to add helpful/obscure information to the lists below to help members of the community less experienced with interactions.
...
<table>
<tbody><tr><th scope="col"><div>"Dummy" syndrome tags</div></th></tr>
<tr><td><div>
...
<table>
<tbody><tr><th scope="col"><div>Example [MATERIAL_EMISSION] interaction raws that fire three projectiles of the same material</div></th></tr>
<tr><td><div>
...
<br> By adding additional \[I_EFFECT:MATERIAL_EMISSION\] tags with their associated targets, you may stack additional projectiles.

#### Predefined Material Emissions

<table>
<tbody><tr><th scope="col"><div>Example [MATERIAL_EMISSION] interaction raws that use a predefined material</div></th></tr>
<tr><td><div>
...
<table>
<tbody><tr><th scope="col"><div>Example [MATERIAL_EMISSION] interaction raws that use two predefined material types</div></th></tr>
<tr><td><div>
...
<table>
<tbody><tr><th scope="col"><div>Example interaction raws that may only target unprotected creatures, and the protection interaction</div></th></tr>
<tr><td><div>
...
<table>
<tbody><tr><th scope="col"><div>Turn Undead</div></th></tr>
<tr><td><div>
...
<table>
<tbody><tr><th scope="col"><div>Smite Evil</div></th></tr>
<tr><td><div>
...
<table>
<tbody><tr><th scope="col"><div>Example Timed Self-Destruct with Override Ability</div></th></tr>
<tr><td><div>
...
<table>
<tbody><tr><th scope="col"><div>Demon transformation</div></th></tr>
<tr><td><div>
...
<table>
<tbody><tr><th scope="col"><div>Angel transformation</div></th></tr>
<tr><td><div>
...
An item's [magic](Magic.md)<sup>v51.01-beta26</sup> field can hold an interaction. This sample interaction allows the wielder to shoot an icicle.

<table>
<tbody><tr><th scope="col"><div>Ice bolt</div></th></tr>
<tr><td><div>
...
**Categories:** [Migrated pages needing review](../Category/Migrated_pages_needing_review.md) &middot; [Current](../Category/Current.md) &middot; [Modding](../Category/Modding.md) &middot; [Modding Examples](../Category/Modding_Examples.md)
