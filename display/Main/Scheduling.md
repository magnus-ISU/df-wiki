<!-- Mirrored from https://dwarffortresswiki.org/index.php/Scheduling (revision 315079).
     Generated by crawl.py - edit the wiki, not this file. -->

# Scheduling

*[Source](https://dwarffortresswiki.org/index.php/Scheduling) &middot; revision 315079 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Scheduling.wiki)*

---
<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Scheduling.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
...
Note that civilians can not currently be assigned to orders based on military routines and may need to be directed to safety using a [burrow](Burrow.md) if your fortress is [attacked](Siege.md).

##### Making Routines

[![](https://dwarffortresswiki.org/images/thumb/5/5b/Squad_schedule_menu_v5004.png/300px-Squad_schedule_menu_v5004.png)](https://dwarffortresswiki.org/index.php/File:Squad_schedule_menu_v5004.png)

[https://dwarffortresswiki.org/index.php/File:Squad_schedule_menu_v5004.png](https://dwarffortresswiki.org/index.php/File:Squad_schedule_menu_v5004.png)
...
When you've decided which month to edit, click the "Edit" button to open the order menu. From here, you can use the four buttons at the bottom to quickly assign a new order. From left to right, these buttons create a **Station**, **Patrol Route**, **Defend Burrow**, or **Train** order. To create a **Defend Burrow** order, you will first need to set up the appropriate [burrow](Burrow.md), but **Patrol Route** allows you to create and save routes directly through a sub-menu by clicking on the map, and **Station** simply requires clicking the map to select a station location. Unlike the others, **Train** does not require a location to be set within the monthly orders menu, but rather a valid **[barracks](Barracks.md)** zone must be defined and the squad must be assigned to train in it. Unneeded orders can be deleted by clicking the "cancel" (red circle with a line through it) button next to each assigned order. When you have finished editing the orders, click "Done editing" to save them.
...
Routes are made similarly to stations. Click the 'Patrol' - three red X button to open the route selection submenu, then either choose an existing route or define a new one by choosing "Create new route" then clicking at least two spots on the map and hitting "Confirm". As you define the route, a preview of the path will appear to show which order the soldiers will through the points. This preview does not reflect the exact path they will take and only shows the shortest line between subsequent points. Existing routes can be viewed and edited from the select route menu by clicking the 'Inspect' [![Mag glass icon.png](https://dwarffortresswiki.org/images/4/47/Mag_glass_icon.png)](https://dwarffortresswiki.org/index.php/File:Mag_glass_icon.png) button. Because patrol routes can be saved and used by multiple squads, it is highly recommended to name them as you define them by clicking the text box or [![Quill.png](https://dwarffortresswiki.org/images/7/7f/Quill.png)](https://dwarffortresswiki.org/index.php/File:Quill.png), typing a descriptive name, and pressing enter.

Routes are very useful for Marksdwarves. They don't like to resupply their ammo when faced with an enemy. If you have a route with two waypoints in the firing platform, and two bracketing the ammo supply, the dwarves will be able to find their ammo when empty<sup>\[[Verify](https://dwarffortresswiki.org/index.php?title=Talk:Scheduling&action=edit&redlink=1)\]</sup>.

#### Instructors and demonstrations

Members of a squad with relatively high experience in a [combat skill](Combat_skill.md) will lead the group during a [training](Training.md) session. This can be in the form of a demonstration. Instructors gain [teaching](Teacher.md) experience, while students gain [student](Student.md) and [concentration](Concentration.md) experience. Higher levels of these skills make demonstrations more effective<sup>[source](http://www.bay12forums.com/smf/index.php?topic=85279.0)</sup>.
...
<a href="Soldier.md">Soldiers</a> • <a>Scheduling and alerts</a> • <a href="Squad.md">Squads interface</a> • <a href="Equipment.md">Equipment</a> • <a href="Training.md">Training</a> • <a href="Advanced_Marksdwarf_Training_Guide.md">Marksdwarf training</a></div></td></tr><tr><th scope="row">Design tips</th><td><div>
...
**Categories:** [Fine Quality Articles](../Category/Fine_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [Verify](../Category/Verify.md) &middot; [Military](../Category/Military.md)
