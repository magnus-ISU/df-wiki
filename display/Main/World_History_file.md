<!-- Mirrored from https://dwarffortresswiki.org/index.php/World_History_file (revision 292292).
     Generated by crawl.py - edit the wiki, not this file. -->

# World History file

*[Source](https://dwarffortresswiki.org/index.php/World_History_file) &middot; revision 292292 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/World_History_file.wiki)*

---
<table>
<tbody><tr><td><div><a href="https://dwarffortresswiki.org/index.php/File:Announce_migrant_icon.png"><img alt="Announce migrant icon.png" height="32" src="https://dwarffortresswiki.org/images/5/5f/Announce_migrant_icon.png" width="32"/></a></div></td><td>This article was migrated from <a href="../DF2014/World_History_file.md">DF2014:World History file</a> and may be inaccurate for the current version of DF (v53.16). See <a href="../Dwarf_Fortress_Wiki/Version_migration.md">this page</a> for more information.  </td></tr></tbody></table>

<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/World_History_file.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
...
>   - There aren't always the right number of items in this list, at times some children's ages might not be listed.<sup>\[[Verify](https://dwarffortresswiki.org/index.php?title=Talk:World_History_file&action=edit&redlink=1)\]</sup>
...
**Categories:** [Migrated pages needing review](../Category/Migrated_pages_needing_review.md) &middot; [Current](../Category/Current.md) &middot; [Unknown Quality Articles](../Category/Unknown_Quality_Articles.md) &middot; [Verify](../Category/Verify.md) &middot; [Files](../Category/Files.md)
