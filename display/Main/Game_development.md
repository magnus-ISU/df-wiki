<!-- Mirrored from https://dwarffortresswiki.org/index.php/Game_development (revision 279546).
     Generated by crawl.py - edit the wiki, not this file. -->

# Game development

*[Source](https://dwarffortresswiki.org/index.php/Game_development) &middot; revision 279546 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Game_development.wiki)*

---
Dwarf Fortress is always in development. [Toady One](Toady_One.md) (Tarn Adams), helped by his brother [ThreeToe](ThreeToe.md) (Zach Adams), spends most of his time improving the game, fixing bugs or adding new features.

The main site has a [whole page](http://www.bay12games.com/dwarves/dev.html) on the development cycle of Dwarf Fortress. There's multiple complex lists, with various terms used. This page is made to explain the development cycle of DF.

### Dev pages

There's several pages resuming [the projected features](http://dffd.wimbli.com/file.php?id=2307) of the game :
...
The nearly daily dev log is written on [Dev_Now](http://www.bay12games.com/dwarves/index.html). Here, Toady describes his progress on the current update.
...
Inside Dev_V1 and Dev_Future, you can see that Toady regrouped his ideas into "Arcs". These arcs are a collection of core items, bloats, reqs and power goals (see below) that share the same theme. For instance, there's the [Army Arc](Army_Arc.md), or the [Caravan Arc](Caravan_Arc.md). Toady selected some of these arcs to work on (on the Dev_Next page), in the aim to complete them (or at least do a part of them) in the near-future.
...
- A lot of bugs have been spotted in the game, and they will, of course, be removed at one time or another. You can check the reported bugs in the [Bug Tracker](https://dwarffortress.mantishub.io/login_page.php) page.

- Each month, Toady One writes a report on the financial state of Bay 12 Games, and quickly describes what he'll be working on over the course of the next month. There's a [subforum](http://www.bay12games.com/forum/index.php?board=8.0) for these announcements.
