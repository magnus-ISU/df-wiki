<!-- Mirrored from https://dwarffortresswiki.org/index.php/World_gen.txt (revision 311439).
     Generated by crawl.py - edit the wiki, not this file. -->

# World gen.txt

*[Source](https://dwarffortresswiki.org/index.php/World_gen.txt) &middot; revision 311439 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/World_gen.txt.wiki)*

---
<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/World_gen.txt.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
...
The **world_gen.txt** file stores presets for [advanced world generation](Advanced_world_generation.md). If saved in-game, the file is created in the `prefs/` folder, and can be manually edited to use values that are outside the limits allowed by the in-game interface; the location of the `prefs` [folder](Game_folders_and_files.md) depends on the [portable mode setting](Settings.md#portable-mode).
...
**Categories:** [Superior Quality Articles](../Category/Superior_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [Files](../Category/Files.md)
