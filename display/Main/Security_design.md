<!-- Mirrored from https://dwarffortresswiki.org/index.php/Security_design (revision 315910).
     Generated by crawl.py - edit the wiki, not this file. -->

# Security design

*[Source](https://dwarffortresswiki.org/index.php/Security_design) &middot; revision 315910 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Security_design.wiki)*

---
<table>
<tbody><tr><td><div><a href="https://dwarffortresswiki.org/index.php/File:Announce_migrant_icon.png"><img alt="Announce migrant icon.png" height="32" src="https://dwarffortresswiki.org/images/5/5f/Announce_migrant_icon.png" width="32"/></a></div></td><td>This article was migrated from <a href="../DF2014/Security_design.md">DF2014:Security design</a> and may be inaccurate for the current version of DF (v53.16). See <a href="../Dwarf_Fortress_Wiki/Version_migration.md">this page</a> for more information.  </td></tr></tbody></table>

<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Security_design.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
...
Invaders can now [jump](Jump.md) and [climb](Climb.md), build bridges and stairs, dig through natural walls, and use battering rams to destroy buildings. They will also learn where traps are located eventually and use that knowledge to avoid your traps. Familiarize yourself with these mechanics before implementing these strategies. When in doubt, replacing pits with [fortifications](Fortification.md) is probably a good first step.
...
> - Consider using a [pressure plate](Pressure_plate~2.md) at the extreme entrance to seal off the hall further down and keep your guard animal(s) safe. Thieves won't trigger them, but the animals can deal with those - ambushes *will* trigger them, and you don't want them getting to your guard animals.

Remember that anything short of a [megabeast](Megabeast.md) is not a good match for an armoured opponent.<sup>\[[Verify](https://dwarffortresswiki.org/index.php?title=Talk:Security_design&action=edit&redlink=1)\]</sup> While watching your tame [grizzly bear](Grizzly_bear.md) or [alligator](Alligator.md) tear a thief apart has an amusement value, watching the goblin maceman send them flying across the map, mangled and dying, has less.
...
- You can force a building order using the [DFHack](DFHack.md) command `gui/design`.
...
If it's big enough, build a [siege engine](Siege_engine.md) inside a pillbox. Only a single tile of fortifications is needed to fire through the wall. Position the tower to fire where invaders tend to congregate.
...
The 3 tile wide lane is for traders, so if your [trade depot](Trade_depot~2.md) is located before this set-up, cut it down to a 1 tile lane to slow down invaders more.
...
**Categories:** [Migrated pages needing review](../Category/Migrated_pages_needing_review.md) &middot; [Unknown Quality Articles](../Category/Unknown_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [Verify](../Category/Verify.md) &middot; [Military](../Category/Military.md) &middot; [Fortress defense](../Category/Fortress_defense~2.md) &middot; [Design](../Category/Design.md)
