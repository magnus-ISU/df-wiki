<!-- Mirrored from https://dwarffortresswiki.org/index.php/Fixed_Creature_RAWs (revision 276890).
     Generated by crawl.py - edit the wiki, not this file. -->

# Fixed Creature RAWs

*[Source](https://dwarffortresswiki.org/index.php/Fixed_Creature_RAWs) &middot; revision 276890 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Fixed_Creature_RAWs.wiki)*

---
<table>
<tbody><tr><td><div><a href="https://dwarffortresswiki.org/index.php/File:Announce_migrant_icon.png"><img alt="Announce migrant icon.png" height="32" src="https://dwarffortresswiki.org/images/5/5f/Announce_migrant_icon.png" width="32"/></a></div></td><td>This article was migrated from <a href="../DF2014/Fixed_Creature_RAWs.md">DF2014:Fixed Creature RAWs</a> and may be inaccurate for the current version of DF (v53.16). See <a href="../Dwarf_Fortress_Wiki/Version_migration.md">this page</a> for more information.  </td></tr></tbody></table>

<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Fixed_Creature_RAWs.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
...
- [Raw Explorer](http://www.bay12forums.com/smf/index.php?topic=103360.msg3056848#msg3056848) makes it quick and easy to edit raw files, and individual creatures can be extracted by simply right-clicking (on the creature) and choosing "copy".
- [Creature token](Creature_token~2.md) is a great resource for explaining what each token does and how to use it.
...
Original: [Black mamba/raw](Black_mamba/raw.md)

<table>
<tbody><tr>
<th colspan="2">Modified Black Mamba raw
</th></tr>
<tr>
<td>
<p>[CREATURE:BLACK_MAMBA]
...
- Changed `CLUTCH_SIZE:10:30` to 10:25 to match the real animal. [Source](http://en.wikipedia.org/wiki/Black_mamba)
...
Original: [Adder/raw](Adder/raw.md)

<table>
<tbody><tr>
<th colspan="2">Modified Adder RAW
</th></tr>
<tr>
<td>[CREATURE:ADDER]
<p>	[DESCRIPTION:A small snake with ridged scales and a powerful venomous bite.]
...
- Added `CHILD:1` and `LITTERSIZE:3:20` and removed egg related tags to allow adders to have 3 to 20 live offspring. Adders ([Vipera berus](http://en.wikipedia.org/wiki/Vipera_berus)) don't actually lay eggs, they're [ovoviviparous](http://en.wikipedia.org/wiki/Ovoviviparity), meaning that they keep the eggs internally and then give live birth.

---

**Categories:** [Migrated pages needing review](../Category/Migrated_pages_needing_review.md) &middot; [Current](../Category/Current.md) &middot; [Modding](../Category/Modding.md)
