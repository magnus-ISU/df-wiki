<!-- Mirrored from https://dwarffortresswiki.org/index.php/Elven_language (revision 302502).
     Generated by crawl.py - edit the wiki, not this file. -->

# Elven language

*[Source](https://dwarffortresswiki.org/index.php/Elven_language) &middot; revision 302502 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Elven_language.wiki)*

---
<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Elven_language.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
...
The **Elven language** is one of the five [languages](Language.md) the player will come across. This language is used in-game for the names of the universe, continents, rivers, elven governments and settlements, [elves](Elf.md), [artifacts](Artifact.md) and [engravings](Engraving.md). However, as of yet, it lacks everything necessary for proper conversation, like grammar or personal pronouns.
...
**Categories:** [Current](../Category/Current.md) &middot; [Language](../Category/Language.md)
