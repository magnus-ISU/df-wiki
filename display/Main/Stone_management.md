<!-- Mirrored from https://dwarffortresswiki.org/index.php/Stone_management (revision 293303).
     Generated by crawl.py - edit the wiki, not this file. -->

# Stone management

*[Source](https://dwarffortresswiki.org/index.php/Stone_management) &middot; revision 293303 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Stone_management.wiki)*

---
<table>
<tbody><tr><td><div><a href="https://dwarffortresswiki.org/index.php/File:Announce_migrant_icon.png"><img alt="Announce migrant icon.png" height="32" src="https://dwarffortresswiki.org/images/5/5f/Announce_migrant_icon.png" width="32"/></a></div></td><td>This article was migrated from <a href="../DF2014/Stone_management.md">DF2014:Stone management</a> and may be inaccurate for the current version of DF (v53.16). See <a href="../Dwarf_Fortress_Wiki/Version_migration.md">this page</a> for more information.  </td></tr></tbody></table>

<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Stone_management.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
...
2. Press i→p and select some stones, and the stones will be marked for dumping.
3. A dwarf with refuse-hauling enabled will take the stone to the garbage dump.
4. Every dumped stone will be marked as "[forbidden](Forbid.md)." Use the [stocks](Stocks.md) menu to globally un-forbid types of stone, or use the designation 'Reclaim Items' i→F.
...
[Gem cutters](Gem_cutter.md) can turn stone into [cabochons](Cabochon.md), which can then be [encrusted](Encrust.md) into furniture or crafts by a [gem setter](Gem_setter.md). This synergizes well with the two above options, unless most of your boulders are of the same material.
