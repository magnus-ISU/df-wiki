<!-- Mirrored from https://dwarffortresswiki.org/index.php/Aquifer (revision 319319).
     Generated by crawl.py - edit the wiki, not this file. -->

# Aquifer

*[Source](https://dwarffortresswiki.org/index.php/Aquifer) &middot; revision 319319 &middot; retrieved 2026-09-11 &middot; [wikitext](../../mirror/wikitext/Main/Aquifer.wiki)*

---
<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Aquifer.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
<div><a href="../Dwarf_Fortress_Wiki/V.md">More Info</a> · <a href="../Template/Av.md">V</a></div></td></tr>
</tbody></table>

[![Aquifer preview.png](https://dwarffortresswiki.org/images/c/c8/Aquifer_preview.png)](https://dwarffortresswiki.org/index.php/File:Aquifer_preview.png)

An **aquifer** is a subterranean [layer](Layer.md) of [soil](Soil.md) or [stone](Stone.md) that holds groundwater. Once exposed it will start leaking [water](Water.md), which can lead to a lot of [Fun](Fun.md) [flooding](Flood.md) if left unmanaged. Each [embark](Embark.md) tile within the embark rectangle might contain an aquifer.

### Leaking

Aquifer tiles produce water in any *neighboring* open tiles – **north, south, east, west,** and **below**. The amount of water an aquifer produces depends on what type it is. **Heavy aquifers** are faster to produce water and much harder to manage compared to **light aquifers**. Aquifers cannot be drained; the groundwater is limitless, with even a single isolated tile leaking water forever. However, [smoothed](Smoothing.md), mined, carved staircase, or [channeled](Channel.md) aquifer tiles no longer produce water. Aquifers located in [ocean](Ocean.md) [biomes](Biome.md) will produce salty water; aquifers in other biomes will produce freshwater.

### Identifying

If you are digging an up/down staircase in the downward direction and you hit an aquifer, the aquifer tile will be revealed as [damp soil](Damp_stone.md) or stone and the dig designation cancelled for that tile, though the cancellation can be disabled in [Standing orders](Standing_orders.md#other)<sup>v53.12</sup>. If you are mining horizontally, you will similarly be warned of "damp stone" before breaching the aquifer. If there is no water next to or above these tiles, these are aquifer tiles. If you are digging an up/down staircase in the *upward* direction, or a ramp, and you hit an aquifer from below, the aquifer tile will immediately start producing water in the stairwell.

### Types of aquifers

[![](https://dwarffortresswiki.org/images/1/1c/Aqua_varied.png)](https://dwarffortresswiki.org/index.php/File:Aqua_varied.png)
...
Since water will leak into tiles **below** an aquifer, you must dig out and wall off or smooth the same tiles in every single damp [Z-level](Z-level.md) you wish to utilize, or else find all lower z-levels flooded from a seemingly unknown source; the rough aquifer walls above. It may seem as though the [floor](Floor.md) is leaking water, but it is actually the ceiling. There is no need to smooth or construct floors, as only rough wall tiles will leak water. However, if what you're trying to do is dig out a cistern, the most efficient way is to simply dig a large area out from directly under an aquifer layer, since every single tile will fill with water at a steady rate until it reaches 7/7. You'll know you're digging in the right level to make a cistern when every single tile you're trying to dig out is damp stone, but the layer below is dry.
...
Although digging through light aquifer walls is not very dangerous, your dwarves will continuously cancel designations with the "damp stone" warning with each new tile revealed, unless that is disabled in [Standing orders](Standing_orders.md#other)<sup>v53.12</sup>, otherwise the player must repeatedly re-designate light aquifer squares to get the dwarves to mine it, making it a tedious affair.
...
Rough heavy aquifer walls also act as an infinite *sink* for water, just like an open map edge. A single aquifer tile can absorb any amount of [pressurized](Pressure.md) water each tick, limited only by the supply. One less obvious consequence is that if an opening is made through a multi-layer aquifer, only the lowest opened layer will ever fill with water.
...
Aquifers appear based on the drainage of the terrain. Low elevations - particularly those near [rivers](River.md) and oceans - are more prone to having an aquifer present, while locations closer to mountains are much less likely, but still possible. Depending on the [embark](Embark.md) location's biomes, you may embark to an area containing no aquifers, or up to several aquifers throughout your map.
...
\`[http://www.bay12forums.com/smf/index.php?topic=79224.0#msg2058307](http://www.bay12forums.com/smf/index.php?topic=79224.0#msg2058307) Earlier\] in the same thread, Hans Lemurson laid out a very dwarfy method that can also pierce aquifers of any depth, using several pumps and machinery.
...
The [DFHack](../Utility/DFHack.md) command `light-aquifers-only` changes all heavy aquifers to light aquifers. If you prefer not having to deal with aquifers at all, the DFHack command `aquifer drain --all` removes the aquifer flag from all tiles in your current embark without requiring raw edits.

###### With DFHack's gui/aquifer command

DFHack's ["gui/aquifer"](https://docs.dfhack.org/en/latest/docs/tools/gui/aquifer.html) command lets you interactively remove (or create) aquifers on specific tiles. This is useful if you want to keep a heavy aquifer on your map, but don't want to deal with the hassle of breaching it.

To create an aquiferless shaft, do this:

1. Open gui/launcher by clicking on the DFHack logo and selecting gui/launcher
2. Run gui/aquifer
3. Draw a cube (*e.g. a 4x4x4*) containing the area to drain
...
Aquifers outside [ocean](Ocean.md) biomes also contain fresh water. Since aquifers are almost always located close to the surface, freshwater aquifers can easily be turned into a source of infinite, secure, non-freezing drinking water for your dwarves. While both of these roles can also be filled by [cavern](Caverns.md) features, an aquifer allows you to get the same advantages without exposing yourself to potentially ~~dangerous~~ Fun cavern creatures.
...
[![](https://dwarffortresswiki.org/images/thumb/d/dc/Aquifier_preview.png/360px-Aquifier_preview.png)](https://dwarffortresswiki.org/index.php/File:Aquifier_preview.png)
...
**Categories:** [Superior Quality Articles](../Category/Superior_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [Bugs](../Category/Bugs.md) &middot; [Mods](../Category/Mods.md) &middot; [World](../Category/World.md)
