<!-- Mirrored from https://dwarffortresswiki.org/index.php/Adventurer_mode_F.A.Q. (revision 309391).
     Generated by crawl.py - edit the wiki, not this file. -->

# Adventurer mode F.A.Q.

*[Source](https://dwarffortresswiki.org/index.php/Adventurer_mode_F.A.Q.) &middot; revision 309391 &middot; retrieved 2026-09-11 &middot; [wikitext](../../mirror/wikitext/Main/Adventurer_mode_F.A.Q%252E.wiki)*

---
<table>
<tbody><tr><td><div><a href="https://dwarffortresswiki.org/index.php/File:Announce_migrant_icon.png"><img alt="Announce migrant icon.png" height="32" src="https://dwarffortresswiki.org/images/5/5f/Announce_migrant_icon.png" width="32"/></a></div></td><td>This article was migrated from <a href="../DF2014/Adventurer_mode_F.A.Q%252E.md">DF2014:Adventurer mode F.A.Q.</a> and may be inaccurate for the current version of DF (v53.16). See <a href="../Dwarf_Fortress_Wiki/Version_migration.md">this page</a> for more information.  </td></tr></tbody></table>

<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Adventurer_mode_F.A.Q%252E.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
<div><a href="../Dwarf_Fortress_Wiki/V.md">More Info</a> · <a href="../Template/Av.md">V</a></div></td></tr>
</tbody></table>

This is a list of frequently asked questions related to [Adventurer mode](Adventurer_mode.md).
...
- Follow the advice under [Combat Preferences](Adventurer_mode_gameplay.md#combat-preferences).
...
- If you don't mind taking extra time, you can also start a "temporary" fortress, make as much armor as you could and then abandon/retire to return there as an adventurer later.
  ...
  - If you choose to abandon the "fortress" instead of retiring, remember to put your precious preserved goods in some [heavy](Lead.md) bin or an [inaccessible](Bridge.md) place, as items tend to scatter all over the "fortress" if they have a walkable path from an edge of the map (see [Abandon](Abandon.md)).

#### How do I increase my skills and attributes?

Here are some techniques for raising your skills – very rapidly in some cases. Most of these skill-raising techniques involve repeatedly entering the same keystrokes. To assist with this you can use a [macro](../DF2014/Macro.md) to make entering the same sequence of keystrokes over and over again much easier. Increasing skills increases associated attributes, which may in turn benefit other skills. For example, sharpening rocks using x will increase Knapping, which will increase a number of attributes that help with combat skills. See [Skills and Associated Attributes](Attribute.md#skills-by-associated-attributes) for a mostly complete list.
...
Secondly, you can become a [**vampire**](Vampire.md):
...
- In version 0.42.01, it is now possible to be "cursed" by a god into becoming a vampire by desecrating statues/totems/altars dedicated to them. This can be done by pressing u while adjacent to interact with them, and toppling them. <sup>v0.42.01</sup>

Thirdly, you can become a [**werebeast**](Werebeast.md):
...
- In version 0.42.01, it is now possible to be "cursed" by a god into becoming a werebeast by desecrating statues, totems or altars dedicated to them. This can be done by pressing u while adjacent to interact with them, and toppling them.<sup>v0.42.01</sup>
- You cannot be a werebeast and a vampire at the same time.

And finally, you can become a mist [**zombie**](Zombie.md):
...
#### I don't like the location I am currently at. How can I fast travel away?<sup>v0.42.01</sup>
