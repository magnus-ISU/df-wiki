<!-- Mirrored from https://dwarffortresswiki.org/index.php/Playstyle_challenge (revision 315886).
     Generated by crawl.py - edit the wiki, not this file. -->

# Playstyle challenge

*[Source](https://dwarffortresswiki.org/index.php/Playstyle_challenge) &middot; revision 315886 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Playstyle_challenge.wiki)*

---
<table>
<tbody><tr><td><div><a href="https://dwarffortresswiki.org/index.php/File:Announce_migrant_icon.png"><img alt="Announce migrant icon.png" height="32" src="https://dwarffortresswiki.org/images/5/5f/Announce_migrant_icon.png" width="32"/></a></div></td><td>This article was migrated from <a href="../DF2014/Playstyle_challenge.md">DF2014:Playstyle challenge</a> and may be inaccurate for the current version of DF (v53.16). See <a href="../Dwarf_Fortress_Wiki/Version_migration.md">this page</a> for more information.  </td></tr></tbody></table>

<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Playstyle_challenge.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
<div><a href="../Dwarf_Fortress_Wiki/V.md">More Info</a> · <a href="../Template/Av.md">V</a></div></td></tr>
</tbody></table>

The following is a list of [challenges](Challenge.md) relating to playstyle.

### Pre-Embark Build Ideas

Before you embark, you can optimize or sabotage your fortress from the very start, depending on how you distribute your points. After a few years, a well-developing fortress may or may not stabilize (depending on your idea of [fun](Fun.md)), leaving you to other challenges.

#### Diplomacy

- Six dwarves with only social [skills](Skill.md)
- One skilled dwarf
...
- 1 anvil
- 1 copper ore
- 1 [fire-safe](Fire-safe.md) block
...
<li>Build a wood furnace with the block.</li>
<li>Make 3 charcoal from the wood.</li>
<li>Deconstruct the wood furnace.</li>
<li>Build a smelter.</li>
<li>Smelt the nugget into 4 copper bars using 1 charcoal.</li>
<li>Build a metalsmith's forge with 1 anvil and 1 copper bar, or deconstruct the smelter.</li>
<li>Forge a pick using 1 copper bar and 1 charcoal.</li>
<li>Forge a battle axe using 1 copper bar and 1 charcoal.</li></ul>
<p>... and proceed as normal.
<i>(Building with ash used to be possible, so you would build the furnace with the ore </i>
<i>and then build with an ash bar after, but not since v50)</i>.
</p>
</td></tr>
</tbody></table>

<br> You can set the embark points as 309 (the minimum for a steel anvil and a piece of [Tetrahedrite](Tetrahedrite.md)) in the [advanced world generation](Advanced_world_generation.md) settings to mandate this challenge. (Ironically, bringing a copper axe and pick costs less points than bringing an anvil, but that's perhaps against the spirit of this challenge.)
...
If you want to make things worse for yourself, you can choose not to even make a trade depot. Get your pick or axe from raiding. You can level up your [ambush](Ambush.md) skills from hunting.

For either this or the above challenge, you can choose to instead use your points on [useless crap](Useless_crap.md). Note that most finished goods can be traded, which might go against the spirit of this challenge. It is, however, possible to embark after removing all supplies and skills, thereby having spent no points at all.
...
- Embark in the middle of an [arctic ocean](Arctic_ocean.md)

A challenge for the ultimate survivalist. The map contains only a thick layer of [ice](Ice.md) and a deep body of salty oceanic water underneath it, blocking your way deeper. Your only resources will be ice, wildlife drops, (possibly) fish, the resources you embark with, and the ones you manage to buy from the dwarven caravan, as nobody else will bother to come here.

You'll need to use [DFHack](DFHack.md) to bypass the embark restrictions (you can uninstall it afterwards) and have [cave-ins](Cave-in.md) disabled in [settings](Settings.md#feature-toggles) all the time, to prevent the ice sheet from collapsing into the water underneath.
...
- Don't burn any [coal](Fuel.md). Do you know what that does to the environment, man?
  - Magma-smelting is an option, but steel can't be had.
- Don't cause any creature's death, except in self-defense.
  - No military, induced submerging, or lethal implementation of corkscrews. Or [bridges](Dwarven_atom_smasher~2.md).
- Only use cage traps, and either tame the creatures you catch, or release them back into the wild.
- [Hippies](Elf.md) prefer sunlight and wooded areas, with minimal use of rock (digging and building).
...
- Modding BONUS: Add actual hobbits as a playable civ and embark as them.

#### Humans - Living Large and Standing Tall

Pretend you're a filthy above-ground dwelling [human](Human.md).
...
- MEGABONUS: Build your entire fortress as [one huge arcology](Mega_construction.md).
...
Shun technology and contraptions. Who can really trust them, with all those [gremlins](Gremlin.md) running around? This may be challenging, as it forbids easy isolation/defense from attacks, all traps and wells. Irrigation is reduced to solid elbow grease and maybe a bucket or two. This challenge may be even harder combined with another challenge.

- No mechanics or [mechanisms](Mechanism.md)
- No [machines](Machine.md)
...
Try to kill as many [demons](Demon.md) as possible. Use siege-engines and fortifications. Remember that collapsing caves (use supports) kills everything.
...
- Do not geld any animals. Even [cats](Catsplosion.md).
- If any gelder arrive to your fortress, kill them.
  - Bonus: legendary gelders must be killed with legendary violence!

#### Dwemer City-State

In loving memory of the famous [extincted](Losing.md) race from Tamriel.
...
- Optional: Catch some [iron men](Iron_man.md) or [bronze colossuses](Bronze_colossus.md) and unleash them on everything that is not the dwarven caravan. Or on actually everything - that's easier.
...
Raise a civilization just to hunt [demons](Demon.md).
...
- When everything is ready, find the most military skilled dwarves, give them adamantine equipment and training on your choice. They are The Hunters now.
  - HINT: [Danger room](Danger_room.md) can be useful.
- Dig into Hell, if you haven't done it yet. Let the hunt begin!
  - Bonus: Fortress should have several small corridors, so demons can [troop round](Fun.md) the hunters.
    - DoubleBonus: When the hunt starts, open the main enterance to your fortress. Also make some kind of fortress-destruction mechanism connected to a lever. The last alive Hunter should pull it, so demons wouldn't reach the surface.
      - Or would they?..
- Optional: If the Hunter(s) survive for a period (season, year etc.), close Hell with [bridge](Bridge.md) and give the Hunters some kind of award. Also they're now supposed to be True Men.
...
- Three or more Marksdwarves (perhaps with [ambushing](Ambusher.md))
...
At the start your dwarves split everything equally and move to 7 different locales that are not interconnected. They have to mine their own rooms, plant their own crops, use their own craft piles. This will probably require a bit of cross-fertilization until you get [doors](Door.md) and can lock everyone in, but after that it is every dwarf for him/herself!
...
- Spend points ONLY on ONE [pick](Pick.md).

A well known and popular challenge. Kill off or expel 6 of the starting dwarves and any [immigrants](Immigrant.md) as they arrive, and try to make a living for the last dwarf. Turn away merchants. If they don't leave, kill them.
...
- No military dwarves are permitted, including the [Fortress guard](Fortress_guard.md).
...
- Bonus: If you have "reason" to believe the migrants are [infected](Noble.md), sacrifice them to [Armok](Armok.md). Remember, he loves Magma!
...
Opposite of "Master of One" above.<br><br> Pre-Embark:
...
- Artifacts containing stone and metal are to be destroyed **utterly** (magma or the [DAS](Dwarven_atom_smasher~2.md))
...
- Bonus: Use this Christmas-themed tileset: [User:Sphr/gfx set#Christmas_Special_2007](https://dwarffortresswiki.org/index.php/User:Sphr/gfx_set#Christmas_Special_2007)
...
- Mega Bonus: Use [Olivine](Olivine.md), [Serpentine](Serpentine.md), [Bauxite](Bauxite.md), [Kaolinite](Kaolinite.md), [Cinnabar](Cinnabar.md), [Petrified wood](Petrified_wood.md), [Realgar](Realgar.md), (red and green) to build your fortress.
- Dwarven Spirit Bonus: Edit the raws to embark with [elves](Elves.md). Utilize elf labor to craft your toys.
...
- Should an inmate [start to rebel](Tantrum.md) the ~~[sheriff](Sheriff.md)~~ chief warden should restore discipline with an iron hand.
- It won't take long until a few inmates start to [go insane](Strange_mood.md) from sensory deprivation. Too bad for them.
...
- All full-time military dwarves must have a matching set of iron platemail ([lorica segmentata](http://en.wikipedia.org/wiki/Lorica_segmentata)) and iron short swords.
  - All conscripted dwarves must have a full set of leather armor (material doesn't matter) and wooden crossbow.
    - BONUS: All conscripted dwarves must have bows and arrows instead of crossbows and bolts. Trade with the filthy [Gauls](Elf.md) for them.
...
- Try to ensure that there are no neighbors on the island (except other dwarves, of course).
  - Bonus: try to find an island that only has hostile neighbors (i.e. [goblins](Goblin.md), [kobolds](Kobold.md), [evil](Evil.md#evil)).
- Take only the bare essentials along with you (see [Minimalist/Survivalist](Challenges.md#minimalist2fsurvivalist-build) build above).
  - Bonus: only peasants managed to survive the incident which landed your dwarves on the island (see [Peasantry](Challenges.md#peasantry) above).
- NO TRADING! Ignore the dwarven traders that come (or kill them).
- [Immigrants](Immigrant.md) are now other survivors; limit the number of survivors your island can have (either by changing the population cap or just killing off new immigrants).
...
Simple: your dwarves cannot harvest or use [wood](Wood.md), or any wooden items. Non-artifact [beds](Bed.md) are out, which will significantly reduce the happiness of your dwarves. Without charcoal, your furnaces will need to depend upon coal or magma--don't forget to bring a bar of coke to jumpstart your industry if you're using coal. You'll need to brew your alcohol on site using stone pots (to avoid buying wooden barrels on embark). Without [windmills](Windmill.md) and [waterwheels](Waterwheel.md) (and [axles](Axle.md)), powered machinery is not possible. A fair number of [strange moods](Strange_mood.md) will prove impossible to complete without wood; you'll need to be ready to deal with the consequences. [Nobles](Noble.md) will be particularly problematic since their demands for a bedroom will have to be ignored.

#### Evil Fortress

Create an evil, hidden fortress where everyone will wonder what's going on inside, but won't know.

- Make everything underground, nothing can be built in plain view of the surface lest they figure out what's going on underground.
- You may only export weapons.
- At least half of the population must be in the military.
- Dwarves start off with picks, weapons, food and one type of seed.
- Dwarves must be trained in a weapon skill on embark.
- Create death chambers and have a strict prison policy.
- Make sure to sacrifice dwarves to Armok.
- Bonus: Remember, Armok loves magma.
- FunBonus: Conduct "experiments" on the denizens of the HFS.
...
- In [fortress mode](Fortress_mode~2.md), successfully colonize [Hell](Hell.md). Retire the fortress.
- In [adventurer mode](Adventurer_mode.md), clear a [vault](Vault.md). Bring all [divine metal](Divine_metal.md) items and the artifact slab found in the vault back to your fortress. Retire the adventurer.
...
- [Drop](Cave-in.md) the entire monument into an eerie pit.
- Profit.
...
- [Animals](Animals.md) are forbidden from the fortress
...
- Coins are forbidden.
- Be aware that nobles are to be considered part of the "bourgeoisie" and are to be [dealt with](Unfortunate_accident.md) immediately.
...
Suggested provisions for prisoners: a bed, a personal cell, a commons area, aboveground exercise yard, and the clothes the creature was wearing when captured. For more inspiration, go to: [Geneva Conventions](http://en.wikipedia.org/wiki/Geneva_Conventions)
...
- Only gems can be traded.
  - BONUS: Your leader [denies the existence of infections](http://en.wikipedia.org/wiki/AIDS_denialism#In_South_Africa). Soap is neither manufactured nor traded for. Even if you know a dwarf has an infection, do not quarantine it or treat it any differently.
...
Note that the above suggestions are modeled on the popular movie [300](http://en.wikipedia.org/wiki/300_(film)), an adaption of the graphic novel [300](http://en.wikipedia.org/wiki/300_(comics)), both of which are historically inaccurate. For a more "realistic dwarven Sparta", try reading the Wikipedia article on [Spartan society](http://en.wikipedia.org/wiki/Sparta#Society), and see Bret Devereaux's series [This. Isn't. Sparta](https://acoup.blog/2019/08/16/collections-this-isnt-sparta-part-i-spartan-school/).
...
- BONUS: The filthy steel-wearing [conquistadors](Human.md) have come to plunder your city! sacrifice them to the blood god!
...
- No armor except leather and only let champions use it. All others must fight unarmored.
  - BONUS: Divide your soldiers into "Jaguar[\[1\]](http://en.wikipedia.org/wiki/Jaguar_warrior)" and "Eagle[\[2\]](http://en.wikipedia.org/wiki/Eagle_warrior)" warrior societies and outfit them with leather armor made from their respective animals.
  ...
  - BONUS : all dwarves must be at least at least Proficient in military skills
    - MEGABONUS : all dwarves must be Legendary in MS
      - ULTRABONUS : all dwarves must have slain a whole siege all by themselves
        - SADISTICDWARFBONUS : Assault [HFS](HFS.md) with your bunch of überdwarves. Win. No traps allowed.
...
- Don't build any workshops or farms (with a possible exception for [still](Still.md)).
  - Bonus: Disable all labors and live solely on imported goods.
- Build your whole fortress around a [trade depot](Trade_depot~2.md). Train your [building designer](Building_designer.md) to build a really good trade depot eventually.
...
- Build shrines in the names of [outpost liaison](Outpost_liaison~2.md) and foreign diplomats.
...
- Real elartians hate the gods and dream of killing them. Don't build temples. Intentionally dig into [HFS](Demon.md). Run raids on angels.
...
- Embark with lead bars to create a radiation proof [vault door](Bridge.md).

- [Animals](Animals.md) are also forbidden to embark with. Any brought by migrants are to be immediately slaughtered.
...
- Survive as long as you can!
  - BONUS: Last at least 200 years.
    - MEGABONUS: …then delve into the [Magma sea](Magma_sea.md). Build a massive pumpstack up to the surface. Flood the surface with lava, destroying factionalism and paving the way for your brave vault dwellers to recolonize the surface!

---

**Categories:** [Migrated pages needing review](../Category/Migrated_pages_needing_review.md) &middot; [Current](../Category/Current.md) &middot; [Unknown Quality Articles](../Category/Unknown_Quality_Articles.md)
