<!-- Mirrored from https://dwarffortresswiki.org/index.php/Physics (revision 302538).
     Generated by crawl.py - edit the wiki, not this file. -->

# Physics

*[Source](https://dwarffortresswiki.org/index.php/Physics) &middot; revision 302538 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Physics.wiki)*

---
<table>
<tbody><tr><td><div><a href="https://dwarffortresswiki.org/index.php/File:Announce_migrant_icon.png"><img alt="Announce migrant icon.png" height="32" src="https://dwarffortresswiki.org/images/5/5f/Announce_migrant_icon.png" width="32"/></a></div></td><td>This article was migrated from <a href="../DF2014/Physics.md">DF2014:Physics</a> and may be inaccurate for the current version of DF (v53.16). See <a href="../Dwarf_Fortress_Wiki/Version_migration.md">this page</a> for more information.  </td></tr></tbody></table>

<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Physics.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
<div><a href="../Dwarf_Fortress_Wiki/V.md">More Info</a> · <a href="../Template/Av.md">V</a></div></td></tr>
</tbody></table>

> *For in-game physics, see [gravity](Gravity.md), [temperature](Temperature.md) or [minecart#Physics](Minecart.md#physics).*
...
***E*** ![](https://dwarffortresswiki.org/images/e/ed/Dwarf.png) ***mc<sup>2</sup>***
...
The following items are possible in *Dwarf Fortress*, but ~~impossible otherwise~~ humans have yet to learn from Dwarves how to build them in our own world.

#### Dwarven perpetual motion device

As the name implies, this is a device that continuously generates power. Specifically, it generates power by building a [water wheel](Water_wheel.md) in a [waterfall](Waterfall.md), then using said waterwheel to power a [screw pump](Screw_pump.md). The screw pump is used to pump [water](Water.md) back to its original [Z-level](Z-axis~2.md) and recycle it through the waterfall. Somehow, the device consistently generates a surplus of rotational energy.

#### Quantum garbage dumps

Perhaps the most common Dwarven anomaly, this is simply a 1x1 garbage [dump](Dump.md) zone, with massive amounts of items (usually [stone](Stone.md)) all contained in a single tile. The practicality is obvious—where else are you going to put all that stone?

#### Matter annihilation

Another common method of garbage disposal. Items and [creatures](Creature.md) in DF can be "annihilated" by placing them under a [drawbridge](Drawbridge.md), and lowering the bridge. This is an example where the *Dwarven Equation of Everything* states that energy is *not* equal to mass times the speed of light squared. If the opposite was true, players would witness a massive explosion and a corresponding drop in FPS rate whenever an item was annihilated.
...
Another interesting case of matter annihilation occurs in the seemingly ordinary craftdwarf's workshop, where a chunk of [diorite](Diorite.md) which weighs 186 kilograms is somehow compressed into three diorite figurines, each weighing less than one kilogram.

#### Matter creation

The reverse of matter annihilation is creating something from nothing. Examples include:

- Obtaining enough [sand](Sand.md) from one tile to build a giant fortress out of [glass](Glass.md)
- Obtaining an infinite amount of [water](Water.md) from a single [aquifer](Aquifer.md) wall, isolated from the rest of the aquifer
...
- Making a 314 Γ ballista arrow out of a 104 Γ silver ballista arrowhead and a 32 Γ [birch](Birch.md) [log](Log.md).

#### Special Relativity

It is also important to note that while relativity is indeed a proven phenomenon in Dwarven Physics, the catalyst for time dilation is not the speed an object moves at (as in traditional physics) but instead the population of its region. For decades, Dwarven Scientists have observed that, as local populations increase (dwarf, animal, or [otherwise](Waterfall.md)), the relative passage of time slows. To combat this, mayors have been known to enact ordinances ranging from the [simple and logical](Maximizing_framerate~2.md) to the [ethically dubious](Catsplosion.md#thermonuclear-catsplosion).
...
Dwarven [mechanics](Mechanic.md) have apparently discovered a means of transmitting signals across arbitrary distances without requiring any physical connection between them - for example, a single [lever](Lever.md) can be linked to a door thousands of feet away using only one mechanism on the door and another on the lever, and pulling the lever will *instantly* cause the door to open or close. Some have speculated that the Dwarves have discovered a means of utilizing [quantum teleportation](http://en.wikipedia.org/wiki/Quantum_teleportation) to transmit both information and energy.

##### Dwartum Teleportation

Dwarves have been shown<sup>[Bug](#bugs):[7444](https://dwarffortressbugtracker.com/view.php?id=7444)</sup> to be able to apply Quantum Teleportation on the macro scale. Despite having been known to be on one side of a wall, and being unable to exist within a wall, the dwarf will sometimes find itself on the other side of the wall. It is suspected that this may be related to Entanglement, as it is only observed when the dwarf is grappling with another being, and never observed when a dwarf is alone. New discoveries in dwarven construction physics led to the creation, and soon widespread adoption, of quantum-tuneling-proof walls preventing teleporation. Old fortresses that have not yet caught up to the new state of the art might still have access to this, now ancient, form of transportation.

##### Urist's First Law of Relativity

As featured here.[\[1\]](http://www.bay12forums.com/smf/index.php?topic=61507.msg1412612#msg1412612)
...
**Categories:** [Migrated pages needing review](../Category/Migrated_pages_needing_review.md) &middot; [Unknown Quality Articles](../Category/Unknown_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [D for Dwarf](../Category/D_for_Dwarf.md) &middot; [Bugs](../Category/Bugs.md)
