<!-- Mirrored from https://dwarffortresswiki.org/index.php/Micromanaging_tricks (revision 295541).
     Generated by crawl.py - edit the wiki, not this file. -->

# Micromanaging tricks

*[Source](https://dwarffortresswiki.org/index.php/Micromanaging_tricks) &middot; revision 295541 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Micromanaging_tricks.wiki)*

---
<table>
<tbody><tr><td><div><a href="https://dwarffortresswiki.org/index.php/File:Announce_migrant_icon.png"><img alt="Announce migrant icon.png" height="32" src="https://dwarffortresswiki.org/images/5/5f/Announce_migrant_icon.png" width="32"/></a></div></td><td>This article was migrated from <a href="../DF2014/Micromanaging_tricks.md">DF2014:Micromanaging tricks</a> and may be inaccurate for the current version of DF (v53.16). See <a href="../Dwarf_Fortress_Wiki/Version_migration.md">this page</a> for more information.  </td></tr></tbody></table>

<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Micromanaging_tricks.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
...
- Use a [civilian alert](Civilian_alert.md) [burrow](Burrow.md) to keep your dwarves in - and out of - specific locations.
- Instantly locking [doors](Door.md) can reliably keep a dwarf in a specific location (and doing a specific job), or prevent them from doing something ridiculously stupid.
- Order a dwarf to go to a specific location by building an unconnected [lever](Lever.md), setting the profile on the lever to the specific dwarf, then ordering the lever be pulled. This works for Nobles too, but can be delayed by any other jobs the dwarf is currently tasked with.
- Order a dwarf to go to a specific area by drafting him into the [military](Military.md) and issuing a "move" (station) order. Note that this can make your dwarf charge \*towards\* any nearby enemies.
...
- Cancel a "Store item in stockpile" job by finding the item in question and [forbidding](Forbid.md) it. This can keep your dwarves from running through an active battlefield to collect the enemy's severed limbs. You can also set the default status for some items to forbidden under the [standing orders](Standing_orders.md) menu.
- If you stop an active task in progress via joblist j-r the dwarf may not accept similar jobs for about a week.

### Mining

- The default priority for mining can be counter-intuitive to new users. To avoid miners running from one side of the fort to another for no apparent reason, it is recommended to designate areas to mine in batches with a unique priority. Designation priority explanation here: [Designations_menu#Priority](Designations_menu~2.md#priority).

[![](https://dwarffortresswiki.org/images/thumb/b/b6/Designation_example.png/300px-Designation_example.png)](https://dwarffortresswiki.org/index.php/File:Designation_example.png)

[https://dwarffortresswiki.org/index.php/File:Designation_example.png](https://dwarffortresswiki.org/index.php/File:Designation_example.png)

An example of mining micromanagement via prioritization
...
- Use a locked [door](Door.md) or [burrows](Burrow.md) to limit mining in a specific area to a single dwarf (reliably prevents channeling "[accidents](Cave-in.md)"). Designate one tile for mining, wait until your dwarf is through the door, then lock it and designate all the tiles to be mined. Don't forget to free your miner after the work is complete.
...
- Buildings are prioritized according to a LIFO (last in first out) queue, meaning your most recently ordered [construction](Construction.md) will be built first. To increase priority on a previously-ordered construction, cancel it and re-order the construction.
...
- Combine large stacks of meat with a dwarf's "[preferred](Preference.md)" ingredient to create a large stack of "preferred" meals (for more happy [thoughts](Thought.md)).
...
- Move (Station) orders only cause your dwarves to move to a 7x7 non-contiguous area around the location selected. To force them to move to a specific location (such as adjacent to a fortification), build [statues](Statue.md) (preferred), walls, or designate restricted traffic areas then order your dwarves to move from one side to the other.
...
- If you construct all the [moodable](Moodable.md) workshops in your fortress with a specific type of material (e.g. chalk blocks), you can use the k stocks menu to quickly forbid all your moodable workshops. Note that workshops need to be forbidden *before* the game notifies you of the strange mood.
...
**Categories:** [Migrated pages needing review](../Category/Migrated_pages_needing_review.md) &middot; [Unknown Quality Articles](../Category/Unknown_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [Guides](../Category/Guides.md) &middot; [Fortress mode](../Category/Fortress_mode.md) &middot; [Dwarves](../Category/Dwarves.md)
