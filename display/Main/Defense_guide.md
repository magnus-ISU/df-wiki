<!-- Mirrored from https://dwarffortresswiki.org/index.php/Defense_guide (revision 315519).
     Generated by crawl.py - edit the wiki, not this file. -->

# Defense guide

*[Source](https://dwarffortresswiki.org/index.php/Defense_guide) &middot; revision 315519 &middot; retrieved 2026-09-11 &middot; [wikitext](../../mirror/wikitext/Main/Defense_guide.wiki)*

---
<table>
<tbody><tr><td><div><a href="https://dwarffortresswiki.org/index.php/File:Announce_migrant_icon.png"><img alt="Announce migrant icon.png" height="32" src="https://dwarffortresswiki.org/images/5/5f/Announce_migrant_icon.png" width="32"/></a></div></td><td>This article was migrated from <a href="../DF2014/Defense_guide.md">DF2014:Defense guide</a> and may be inaccurate for the current version of DF (v53.16). See <a href="../Dwarf_Fortress_Wiki/Version_migration.md">this page</a> for more information.  </td></tr></tbody></table>

<table><tbody><tr><td><div><b>v53.16</b> · <a href="../DF2014/Defense_guide.md">v0.47.05</a></div>This article is about the current version of DF.<br/>Note that some content may still need to be updated.<br/>
...
- **Assume the worst:** Build up your defenses *before* the enemy shows up - like right now! Plan on being [sieged](Siege.md) by scores of [goblin](Goblin.md) archers, door-breaking [trolls](Troll.md), invisible [kobold](Kobold.md) master thieves, dive-bombing [giant eagles](Giant_eagle.md), flame-breathing [fire imps](Fire_imp~2.md), angry [elephants](Elephant.md), and a [bronze colossus](Bronze_colossus.md) - *all at once*. Hopefully, you will never have to face that kind of threat, but being ready for anything is the best bet, and, more realistically, when things go wrong (and with dwarves, they will, just believe it) you will have a buffer of defense to fall back on.
...
> - **Building destroyers**
>
> > Some creatures have the [BUILDINGDESTROYER tag](Creature_token~2.md) in their [Raw file](Raw_file.md). This gives them the fearful capacity of tearing apart your doors and workshops. Constructions built with the [![Ui b.png](https://dwarffortresswiki.org/images/b/b1/Ui_b.png)](https://dwarffortresswiki.org/index.php/File:Ui_b.png)b[![Ui bn.png](https://dwarffortresswiki.org/images/c/c7/Ui_bn.png)](https://dwarffortresswiki.org/index.php/File:Ui_bn.png)n keys are safe, and so are [bridges](Bridge.md).
...
> Do note that invaders can climb walls and, in some cases, swim rivers or moats. This limits somewhat the usefulness of natural defences, but with care they can be augmented by [constructions](Construction.md) and still provide important first-line defences.
...
> [Doors](Door.md) are the simplest way to keep an enemy out. (A [floor hatch](Floor_hatch~2.md) in this sense is just a [Z-axis](Z-level.md) door, and in most ways works the same.) Most creatures will be stopped by any door or hatch, though some others can smash them. With a little tinkering, doors can be made 3 tiles wide or more, but this remains mostly for aesthetics without much practical use, as [wagons](Caravan.md) will still not be able to pass them. You can [forbid](Forbid.md) doors to keep (most) hostile humanoids and creatures out, and your dwarves in.
...
- **Forbid dropped equipment and corpses.** Mark every item on the battlefield as [forbidden](Forbidden.md). This includes any items dropped by dead merchants or scuttled wagons. You can have this done automatically for dwarf and enemy corpses and inventories in the **Labor** [![Ui y.png](https://dwarffortresswiki.org/images/c/cb/Ui_y.png)](https://dwarffortresswiki.org/index.php/File:Ui_y.png)y -\> *Standing orders* -\> *Sieges and forbidding*.
...
Factoring in 3-tile wide access to the [trade depot](Trade_depot~2.md) adds a layer of complexity. Letting merchants in while keeping enemies out requires a careful balance. The merchants can reveal ambushes and thieves like any other creature, and their arrival is frequently accompanied by an ambush or a [siege](Siege.md). If the merchants run into an enemy squad, they can be slaughtered before reaching your doors, and that hurts your reputation (as well as possibly causing your civilian dwarves to want to go running out and collect their dropped items). Consider sending heavily armored escorts when expecting a caravan (usually the middle of the third month of each season, except winter). Unless it's an elven caravan, it will have some guards escorting it, and you can take advantage of the distraction to attack an enemy from both sides, but keep in mind that if the merchants themselves are under attack, they will flee.
...
Name each lever, and the attached device if necessary, to indicate what it does. If you come back to a game after a week and can't remember your levers, they are useless (or, worse, ~~dangerous~~ [Fun](Fun.md)!) Color code your levers with different color [mechanisms](Mechanism.md) if that works for you.
...
First, look around. At the terrain, at the animals present. Scan the [![Ui u.png](https://dwarffortresswiki.org/images/4/47/Ui_u.png)](https://dwarffortresswiki.org/index.php/File:Ui_u.png)u menu before un-pausing the game at the start, and regularly. More animals will enter the map, constantly and without warning, so keep an eye on visitors.
...
<a href="Military_quickstart.md">Military quickstart</a> • <a>Defense guide</a></div></td></tr><tr><th scope="row">Managing soldiers</th><td><div>
...
**Categories:** [Migrated pages needing review](../Category/Migrated_pages_needing_review.md) &middot; [Unknown Quality Articles](../Category/Unknown_Quality_Articles.md) &middot; [Current](../Category/Current.md) &middot; [Bugs](../Category/Bugs.md) &middot; [Military](../Category/Military.md) &middot; [Guides](../Category/Guides.md) &middot; [Fortress defense](../Category/Fortress_defense~2.md) &middot; [Design](../Category/Design.md)
