<!-- Mirrored from https://dwarffortresswiki.org/index.php/Army_arc (revision 313973).
     Generated by crawl.py - edit the wiki, not this file. -->

# Army arc

*[Source](https://dwarffortresswiki.org/index.php/Army_arc) &middot; revision 313973 &middot; retrieved 2026-09-11 &middot; [wikitext](../../mirror/wikitext/Main/Army_arc~2.wiki)*

---
*Dwarf Fortress* [development](Game_development.md) is no longer done in large [arcs](Development_arc~2.md), favoring smaller releases with more incremental changes; this page is for historical documentation.
...
[Toady One](Toady_One.md) officially began work on it February 28th 2008, released the first part on July 13, 2008, and various patches through to September 6, 2008.
...
June 20th to July 12th - Bug fixes and tweaks. July 13th - Version [0.28.181.39a](https://dwarffortresswiki.org/index.php/40d:Release_information/0.28.181.39a) Released!

### Further plans

While in development for the first release of the Army arc, the 'Future of the Fortress' notes had a linear schedule of releases. This no longer exists in favor of a list of the most pertinent [development](Dwarf_Fortress_Development.md) goals and ideas in the hope of frequent releases.
...
- [*Latest Developments of Dwarf Fortress*](http://www.bay12games.com/dwarves/dev_now.html)
- [*Army Arc in the Future of the Fortress*](http://www.bay12games.com/dwarves/dev.html)

---

**Categories:** [Arcs](../Category/Arcs.md) &middot; [Military](../Category/Military.md) &middot; [Unversioned](../Category/Unversioned.md)
