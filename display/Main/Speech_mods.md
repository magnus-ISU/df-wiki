<!-- Mirrored from https://dwarffortresswiki.org/index.php/Speech_mods (revision 281305).
     Generated by crawl.py - edit the wiki, not this file. -->

# Speech mods

*[Source](https://dwarffortresswiki.org/index.php/Speech_mods) &middot; revision 281305 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/Main/Speech_mods.wiki)*
...
<br> [Dwarf Fortress](Dwarf_Fortress.md)' [Speech](Speech.md) files determine the exact dialog (mostly in [adventurer mode](Adventurer_mode.md)) between two characters, such as the threats an important enemy will make to you before attacking, or the response when you ask a [child](Child.md) his or her profession. The files may be found in the Dwarf Fortress folder, in the directory "data/speech". These files are easily modified by adding additional lines of text, one entry per line. Take for instance, the file "positive.txt":
...
**Categories:** [Mods](../Category/Mods.md) &middot; [Needs update](../Category/Needs_update.md)
