...
<br> Now that you know how to kill people, you may also want to know how to talk to and otherwise interact with them in a less-violent manner - while this is less entertaining, it can sometimes be useful.

To begin a conversation, press [![Adv ui k.png](https://dwarffortresswiki.org/images/7/70/Adv_ui_k.png)](https://dwarffortresswiki.org/index.php/File:Adv_ui_k.png)k. Select the creature you would like to have a conversation with using the cursor. Aside from individuals, you can also Shout out to everybody, which will have you talking with everyone in earshot, or talk to your deity, or even [![Adv ui P.png](https://dwarffortresswiki.org/images/0/01/Adv_ui_P.png)](https://dwarffortresswiki.org/index.php/File:Adv_ui_P.png)P Begin Performance which includes such things as reciting poetry, telling stories or dancing, and is very important if you want to be a bard. Additionally, you can Assume an identity from the [![Adv ui k.png](https://dwarffortresswiki.org/images/7/70/Adv_ui_k.png)](https://dwarffortresswiki.org/index.php/File:Adv_ui_k.png)k menu, potentially changing your [reputation](../Main/Reputation.md).

Whenever you want to advance the conversation, you have to press [![Adv ui k.png](https://dwarffortresswiki.org/images/7/70/Adv_ui_k.png)](https://dwarffortresswiki.org/index.php/File:Adv_ui_k.png)k again and choose the ongoing conversation you wish to continue. You will also see ongoing conversations from people who have started a conversation with you. If you want to talk to someone else during this time, simply *Start a new conversation*.
...
- *Refuse conversation* — Causes you to explicitly refuse to talk to someone who started a conversation with you. Unknown if this has a different effect from simply not doing anything.<sup>\[[Verify](https://dwarffortresswiki.org/index.php/Dwarf_Fortress_Wiki_talk:Sandbox)\]</sup>
...
| *Ask about somebody (new menu)* | Allows you to ask about a specific creature's [reputation](../Main/Reputation.md). Useful to find out if they know somebody, what their relation might be, and what they think of them. |
...
| *Investigate or interrogate (new menu)* | Opens a menu with options to ask about the creature's master or boss and schemes or plots, using [social skills](../Main/Social_skill.md) like Persuader or Intimidator. |
...
| *State your values (new menu)* | Lets you state one of your [values](../Main/Personality_value.md). Doing so will start an argument with the listener if they have differing values, and can train your Persuader, Judge of Intent, Flatterer, Intimidator, and Pacifier [social skills](../Main/Social_skill.md) depending on how you argue. If you win the argument, your opposition's [values](../Main/Personality_value.md) will change to match yours. If you give in, yours will change. This can result in your needs changing. |
...
| *Brag about your past violent acts* | Causes you to brag about whatever was the last violent act you did. Doesn't seem to have an effect, or at least of severely less impact than summarizing the conflict.<sup>\[[Verify](https://dwarffortresswiki.org/index.php/Dwarf_Fortress_Wiki_talk:Sandbox)\]</sup> |
