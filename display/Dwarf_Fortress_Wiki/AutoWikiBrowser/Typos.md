<!-- Mirrored from https://dwarffortresswiki.org/index.php/Dwarf_Fortress_Wiki:AutoWikiBrowser/Typos (revision 288532).
     Generated by crawl.py - edit the wiki, not this file. -->

# Dwarf Fortress Wiki:AutoWikiBrowser/Typos

*[Source](https://dwarffortresswiki.org/index.php/Dwarf_Fortress_Wiki:AutoWikiBrowser/Typos) &middot; revision 288532 &middot; retrieved 2026-09-13 &middot; [wikitext](../../../mirror/wikitext/Dwarf_Fortress_Wiki/AutoWikiBrowser/Typos.wiki)*

---
<br> Typo-fixing regex list for AutoWikiBrowser. Copied from [\[1\]](https://en.wikipedia.org/wiki/Wikipedia:AutoWikiBrowser/Typos). see that page for more details.
...
> *Per [WP:EUPH](https://dwarffortresswiki.org/index.php?title=WP:EUPH&action=edit&redlink=1) and [MOS:SUICIDE](https://dwarffortresswiki.org/index.php?title=MOS:SUICIDE&action=edit&redlink=1)*
...
> *Per [Wikipedia:Manual_of_Style/Abbreviations#Symbols](http://en.wikipedia.org/wiki/Manual_of_Style/Abbreviations#Symbols), Do not use Unicode characters that put an abbreviation into a single character (unless the character itself is the subject of the text)*

```
<Typo disabled="CURLY DOUBLE QUOTES" find="[“”]" replace=""" />
<Typo disabled="CURLY SINGLE QUOTES" find="[‘’]" replace="'" />
<Typo word="ff" find="(?:&#xFB00;|ﬀ)" replace="ff" />
...
<Typo word="roman500" find="(?:[ⅮＤ]|&#(?:8558;|65316;|x(?:216E;|FF24;)))" replace="D" />
...
> *Per [WP:CONTRACTION](https://dwarffortresswiki.org/index.php?title=WP:CONTRACTION&action=edit&redlink=1), the use of contractions is informal and should be avoided.*
