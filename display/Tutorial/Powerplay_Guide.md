...
[![](https://dwarffortresswiki.org/images/thumb/c/cf/Stq3w89lf.png/400px-Stq3w89lf.png)](https://dwarffortresswiki.org/index.php/File:Stq3w89lf.png)

[https://dwarffortresswiki.org/index.php/File:Stq3w89lf.png](https://dwarffortresswiki.org/index.php/File:Stq3w89lf.png)
...
- A [tower](../DF2014/Tower_(necromancy).md)
- 2 or 3 [dark fortresses](../DF2014/Dark_fortress.md)
- A [vault](../Main/Vault.md)

Optional features:

- A [desert](../Main/Desert.md)
- An [island](../Main/Island.md) no more than 2 blocks away from the mainland
- A [maze](../DF2014/Labyrinth.md)
...
- A **"Short"** history setting will make the world 125 years old. This is done to ensure that goblin settlements (a.k.a [dark pits](../Main/Dark_pit.md)) are not too abundant. It also prevents a lot of takeover wars, so it is less likely to end up with dead civilization(s) or human towns populated by elves (or more likely, goblins).<br>
- A **"High"** number of civilizations provides increased chances of Towers and [dark fortresses](../Main/Dark_fortress.md) appearing. Same applies to the "High" Number of Sites, only that it also influences the amount of creature lairs and encampments in the wild.
...
Human or Dwarf - besides armour and clothing size, the only considerable gameplay difference is that dwarves can see in the dark. Some may argue that dwarves have an advantage due to being able to wear better armour, made in a player fortress. However, as of 0.43.05 it is possible to set the size of armor to be crafted to "Large", giving humans (and many other larger/smaller races) access to any armor a dwarf can wear. Moreover, later on you will realize that masterwork armour is just as useful as standard quality. More on this will be explained in "Armour" section. As for the dwarven "[Battle Trance](../DF2014/Martial_trance.md)" - it will not activate against megabeasts, generally doesn't benefit much to a legendarily skilled adventurer, moreover, this guide emphasizes on NOT finding yourself alone and surrounded most of the time. Hence, battle influence on race choice is negligible.

As of 0.43.05, it is now possible to play as one of the many [animal people](../Main/Animal_people.md), who have their own ups and downs that are numerous, and best discussed elsewhere.
...
[![](https://dwarffortresswiki.org/images/thumb/7/7e/Values4402.png/200px-Values4402.png)](https://dwarffortresswiki.org/index.php/File:Values4402.png)

[https://dwarffortresswiki.org/index.php/File:Values4402.png](https://dwarffortresswiki.org/index.php/File:Values4402.png)
...
<br> Your warlike adventurers naturally value (+++) (in order of appearance): power, truth, cunning, independence, stoicism, self-control, craftsmanship, martial prowess, skill, competition, perseverance and knowledge. At the same time, they despise (---) (also in order of appearance): nature, romance and peace while being mostly indifferent (N/A) to everything else. They dream of ruling the world (or becoming a legendary warrior).

<br> On the emotional plane, they never fall in love or lust, hate easily though not prone to anger, never give in to feelings of sadness or anxiety, impervious to stress, have calm demeanor, modest, strive for perfection, sometimes cruel, relentless, private to the point of paranoia, do not go out of their way to help others and fear nothing.

<br> The values and emotions from the screenshot above will provide your character with the following mindset:

[![Mindset4402.PNG](https://dwarffortresswiki.org/images/thumb/0/0b/Mindset4402.PNG/600px-Mindset4402.PNG)](https://dwarffortresswiki.org/index.php/File:Mindset4402.PNG)

[https://dwarffortresswiki.org/index.php/File:Mindset4402.PNG](https://dwarffortresswiki.org/index.php/File:Mindset4402.PNG)
...
- A large copper [dagger](../DF2014/Dagger.md)
- A copper [spear](../DF2014/Spear.md)
- A [waterskin](../DF2014/Flask.md) with 3 units of water
- A [backpack](../DF2014/Equipment.md#backpacks)
...
[![](https://dwarffortresswiki.org/images/thumb/5/5c/Berrybag.png/200px-Berrybag.png)](https://dwarffortresswiki.org/index.php/File:Berrybag.png)

[https://dwarffortresswiki.org/index.php/File:Berrybag.png](https://dwarffortresswiki.org/index.php/File:Berrybag.png)
...
<br> Your inventory should look similar to what is shown on the image below:

[![](https://dwarffortresswiki.org/images/thumb/d/d0/Startinginv.png/600px-Startinginv.png)](https://dwarffortresswiki.org/index.php/File:Startinginv.png)

[https://dwarffortresswiki.org/index.php/File:Startinginv.png](https://dwarffortresswiki.org/index.php/File:Startinginv.png)

All set, with a lucky find!

<br> Now you are armored and armed, alongside a companion, with plenty of food and drink. While still quite far from being combat-worthy, your character is now ready for training.
...
A punch from a [bronze colossus](../DF2014/Bronze_colossus.md) that can turn any armored human into paste is rendered completely harmless when blocked or dodged. Considering that around the middle stages of the game you will encounter enemies much more fearsome than a colossus, this makes Dodging and Shield User invaluable.
...
[![](https://dwarffortresswiki.org/images/thumb/c/c7/Pastures.png/200px-Pastures.png)](https://dwarffortresswiki.org/index.php/File:Pastures.png)

[https://dwarffortresswiki.org/index.php/File:Pastures.png](https://dwarffortresswiki.org/index.php/File:Pastures.png)
...
[![](https://dwarffortresswiki.org/images/thumb/2/29/Geld.png/200px-Geld.png)](https://dwarffortresswiki.org/index.php/File:Geld.png)

[https://dwarffortresswiki.org/index.php/File:Geld.png](https://dwarffortresswiki.org/index.php/File:Geld.png)
...
- **[Tick](../Main/Time.md#breakdown)** - 1 second of in-game time, equivalent of one press of the \[,\] key. To draw parallels with in-game actions, standing up/lying down takes almost 1 full tick.
...
[![](https://dwarffortresswiki.org/images/thumb/7/72/Attack_types.png/200px-Attack_types.png)](https://dwarffortresswiki.org/index.php/File:Attack_types.png)

[https://dwarffortresswiki.org/index.php/File:Attack_types.png](https://dwarffortresswiki.org/index.php/File:Attack_types.png)
...
[Kisat Dur](../Main/Kisat_Dur.md): [http://www.bay12forums.com/smf/index.php?topic=148015.0](http://www.bay12forums.com/smf/index.php?topic=148015.0) A lot of the techniques described there are applicable to armed combat as well. Just don't try taking down bronze colossus with it.
...
- Q:I am attacked by a [night creature](../DF2014/Night_creature.md), how do I fight? A: As with many other humanoids, target the legs (and wings, if it has any). After hitting the ground, the night creature cannot charge you, making the battle significantly easier. Note that many of the night creatures are almost as fast on the ground as they are on their feet.
...
(The method below utilizes the "rumors" system, which allows you to be a freewheeling adventurer who lets the stories of your renown build your reputation through word-of-mouth. If you prefer the more traditional RPG model of getting a specific quest assignment from a leader whom you can report back to, see the [Agreements](../Main/Quest.md#agreements) section of the [quest](../Main/Quest.md) page for more information.)
...
You will need to install the Rumor System UI improvement script (DFhack is required) by 1337G4mer: [Link](http://www.bay12forums.com/smf/index.php?topic=155262.0). Otherwise, finding the needed kill in the long list of useless rumours will be next to impossible.
...
- **Q:** How do I trade with the merchants? **A:** Don't, it's a fruitless endeavour. None of the merchants will ever have anything useful for sale. However, dwarves at [hillocks](../Main/Hillock.md) sometimes have steel equipment, and are willing to part with it for a worthy offer. To trade with other NPC's, use "Exchange personal items" talk menu.
...
> *Main article: [Adventure mode](../Main/Adventurer_mode.md#faq)*

## See Also

- [Adventure Mode Quick Reference](../Main/Adventure_Mode_quick_reference~2.md)
- [Adventure Mode Quickstart Guide](../Main/Adventure_mode_quick_start.md)
...
**Categories:** [D for Dwarf](../Category/D_for_Dwarf.md) &middot; [Getting started](../Category/Getting_started.md) &middot; [Adventurer mode](../Category/Adventurer_mode.md) &middot; [Interface](../Category/Interface.md)
