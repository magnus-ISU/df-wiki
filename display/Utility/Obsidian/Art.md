<!-- Mirrored from https://dwarffortresswiki.org/index.php/Utility:Obsidian/Art (revision 119425).
     Generated by crawl.py - edit the wiki, not this file. -->

# Utility:Obsidian/Art

*[Source](https://dwarffortresswiki.org/index.php/Utility:Obsidian/Art) &middot; revision 119425 &middot; retrieved 2026-09-13 &middot; [wikitext](../../../mirror/wikitext/Utility/Obsidian/Art.wiki)*

---
- Textures and models for Obsidian must be renderable by OpenSceneGraph. Use [OSGEdit](http://osgedit.sourceforge.net/) to test it.
...
- Animations are allowed, but only if you can get the model to animate correctly in an [OSGEdit](http://osgedit.sourceforge.net/) scene
...
| Owner | Objective | Progress |
| --- | --- | --- |
| nbonaparte | Door | Initial meshes. [open](http://www.mediafire.com/download.php?jnz2nm5nezz) and [closed](http://www.mediafire.com/download.php?5knan2lj2tw). PM me on the forums if the hosting site spits it out, they're only 3 kb 3ds files. |
