<!-- Mirrored from https://dwarffortresswiki.org/index.php/Utility:Stonesense/Adding_Content (revision 294609).
     Generated by crawl.py - edit the wiki, not this file. -->

# Utility:Stonesense/Adding Content

*[Source](https://dwarffortresswiki.org/index.php/Utility:Stonesense/Adding_Content) &middot; revision 294609 &middot; retrieved 2026-09-13 &middot; [wikitext](../../../mirror/wikitext/Utility/Stonesense/Adding_Content.wiki)*
...
The default way of distributing content for [Stonesense](../../Main/Stonesense.md) is to create an archive of the XML configs and the image files. Upload this archive together with a description to the [Utility:Stonesense/Content_repository](Content_repository.md) page, in much the same way tilesets and graphic packs are distributed for Dwarf Fortress, see the [Tileset repository](../../Main/Tileset_repository~2.md) for reference.
...
Here's an example of a typical Stonesense sprite: <br> [![Stonesene sprite sample.png](https://dwarffortresswiki.org/images/5/5f/Stonesene_sprite_sample.png)](https://dwarffortresswiki.org/index.php/File:Stonesene_sprite_sample.png)

Note that, in order not to conflict with neighboring sprites, a sprite must actually be within a smaller area than its 32x32 block. A template for the area used by most sprites is:<br> [![Stonesene sprite template.png](https://dwarffortresswiki.org/images/c/c2/Stonesene_sprite_template.png)](https://dwarffortresswiki.org/index.php/File:Stonesene_sprite_template.png)
...
This image shows how sprites are indexed. Note: Grid added for readability.<br> [![Stonesene indexed sprites.png](https://dwarffortresswiki.org/images/c/cc/Stonesene_indexed_sprites.png)](https://dwarffortresswiki.org/index.php/File:Stonesene_indexed_sprites.png)
...
The \<creature\> tag can be quite a bit more advanced than what we've seen so far. One thing it is often relevant to distinguish is creature professions. A creature's profession is set by the game, and examples might include "WOODCRAFTER", "ADMINISTRATOR" or "MACEMAN". A complete list of creature professions can be found [here](../../Main/Unit_type_token.md). Also note that all races have the same creature strings, meaning a dwarf swordsman will still be a "SWORDS*MAN*".
...
[![Stonesene dwarf prof.png](https://dwarffortresswiki.org/images/a/ad/Stonesene_dwarf_prof.png)](https://dwarffortresswiki.org/index.php/File:Stonesene_dwarf_prof.png)
...
[![Japa gobbos.png](https://dwarffortresswiki.org/images/2/21/Japa_gobbos.png)](https://dwarffortresswiki.org/index.php/File:Japa_gobbos.png)
...
[![Japa gobbo.png](https://dwarffortresswiki.org/images/b/b5/Japa_gobbo.png)](https://dwarffortresswiki.org/index.php/File:Japa_gobbo.png)
...
[![Beefmo giantbat.png](https://dwarffortresswiki.org/images/4/47/Beefmo_giantbat.png)](https://dwarffortresswiki.org/index.php/File:Beefmo_giantbat.png)
...
- gameID: the name of the shrub or tree, as defined by the DF raw files. See here [for a complete list](https://dwarffortresswiki.org/index.php/Talk:Stonesense:Adding_Vegetation).
- [sheetIndex](../../Main/Stonesense%253ASprites.md#sprite-index): the index of the sprite to be drawn for this plant.
...
[![SimpleWorkshopExample.png](https://dwarffortresswiki.org/images/5/5b/SimpleWorkshopExample.png)](https://dwarffortresswiki.org/index.php/File:SimpleWorkshopExample.png)
...
[![SimpleSpritesheetExample.png](https://dwarffortresswiki.org/images/e/e8/SimpleSpritesheetExample.png)](https://dwarffortresswiki.org/index.php/File:SimpleSpritesheetExample.png)

---

**Categories:** [Utility:Superior Quality Articles](../../Category/Utility%253ASuperior_Quality_Articles.md) &middot; [Stonesense](../../Category/Stonesense.md)
