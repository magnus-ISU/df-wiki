<!-- Mirrored from https://dwarffortresswiki.org/index.php/Utility:DFusion (revision 199828).
     Generated by crawl.py - edit the wiki, not this file. -->

# Utility:DFusion

*[Source](https://dwarffortresswiki.org/index.php/Utility:DFusion) &middot; revision 199828 &middot; retrieved 2026-09-13 &middot; [wikitext](../../mirror/wikitext/Utility/DFusion.wiki)*
...
Thread for discussions: [Thread](http://www.bay12forums.com/smf/index.php?topic=93317.0)
...
Runs an interactive lua console. For more on lua commands see [Lua reference manual](http://www.lua.org/manual/5.1/manual.html) or google "lua". Also this command could be ran with filepath as an argument. Then it runs that file as a lua script file. E.g. *lua dfusion/temp.lua* runs a file \<your df path\>/dfusion/temp.lua.
...
<br> Also dfuse/dfusion runs an init script located at 'save directory/dfusion/init.lua'. And 'initcustom.lua' if it exists

### Exported functions and objects

The DF is accessed by object 'df'. This object holds all the types, globals table and some helper functions. Up-to-date api help could be found here: [https://github.com/peterix/dfhack/blob/master/LUA_API.rst](https://github.com/peterix/dfhack/blob/master/LUA_API.rst)
