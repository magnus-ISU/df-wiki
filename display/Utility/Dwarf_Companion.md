<!-- Mirrored from https://dwarffortresswiki.org/index.php/Utility:Dwarf_Companion (revision 231593).
     Generated by crawl.py - edit the wiki, not this file. -->

# Utility:Dwarf Companion

*[Source](https://dwarffortresswiki.org/index.php/Utility:Dwarf_Companion) &middot; revision 231593 &middot; retrieved 2026-09-13 &middot; [wikitext](../../mirror/wikitext/Utility/Dwarf_Companion.wiki)*
...
[![](https://dwarffortresswiki.org/images/thumb/8/8b/Dfcompanion1.png/300px-Dfcompanion1.png)](https://dwarffortresswiki.org/index.php/File:Dfcompanion1.png)

[https://dwarffortresswiki.org/index.php/File:Dfcompanion1.png](https://dwarffortresswiki.org/index.php/File:Dfcompanion1.png)
...
It supports version 40d16, supposedly. The latest screenshot is at [this place](http://bartabox.banquise.net/df/screen1.png).
...
- designator.exe - see [User:Bartavelle/DesignatorTiles](https://dwarffortresswiki.org/index.php/User:Bartavelle/DesignatorTiles)
...
[Download (Version 0.16)](http://www.pindi.us/files/df/dfcompanion-0.16-exe.zip). [Download (Version 0.17c)](http://www.pindi.us/files/df/dfcompanion-0.17c-exe.zip).

## How to install and run it

You need to install several things first. Do it right, or it will not work.

- [Python](http://www.python.org/download/) (should work with any version)
- from [this page](http://sourceforge.net/projects/gladewin32/files/), the latest "Gtk+/Win32 Runtime Environment Installer" (the files that is named like that : gtk-2.12.9-win32-2.exe, scroll down a bit).

- For users of the -any versions, or python 2.4 users, you must:
  - Install the three modules from [this page](http://www.pygtk.org/downloads.html) (PyCairo, PyGObject, PyGTK)
  - Grab the software, v0.17d, at [this place](http://bartabox.banquise.net/df/companion-0.17d-any.zip).
...
Interesting effects are [butcherable dwarves](http://mkv25.net/dfma/movie-236-lazydwarvesmustdie) and [Corbine's crazy dogs](http://img184.imageshack.us/img184/7919/straydognz6.jpg). Oh, and skeletal legendary miners that turn against your fortress.
...
- [butchercats.py](http://bartabox.banquise.net/df/butchercats.py) : marks all "unintersted" cats and kitten as ready for slaughter.
- Soon, the "designator", with a list of cool stuff : [User:Bartavelle/DesignatorTiles](https://dwarffortresswiki.org/index.php/User:Bartavelle/DesignatorTiles)
...
**Categories:** [Utility:Outdated](../Category/Utility%253AOutdated.md) &middot; [Hacking](../Category/Hacking.md) &middot; [Utilities](../Category/Utilities.md)
