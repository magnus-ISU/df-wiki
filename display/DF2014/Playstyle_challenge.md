<!-- Mirrored from https://dwarffortresswiki.org/index.php/DF2014:Playstyle_challenge (revision 302537).
     Generated by crawl.py - edit the wiki, not this file. -->

# DF2014:Playstyle challenge

*[Source](https://dwarffortresswiki.org/index.php/DF2014:Playstyle_challenge) &middot; revision 302537 &middot; retrieved 2026-09-13 &middot; [wikitext](../../mirror/wikitext/DF2014/Playstyle_challenge.wiki)*

---
<table><tbody><tr><td><div><a href="../Main/Playstyle_challenge.md">v53.16</a> · <b>v0.47.05</b> · <a href="https://dwarffortresswiki.org/index.php?title=v0.34:Playstyle_challenge&amp;action=edit&amp;redlink=1">v0.34</a> · <a href="https://dwarffortresswiki.org/index.php?title=v0.31:Playstyle_challenge&amp;action=edit&amp;redlink=1">v0.31</a> · <a href="https://dwarffortresswiki.org/index.php?title=40d:Playstyle_challenge&amp;action=edit&amp;redlink=1">v0.28</a> · <a href="https://dwarffortresswiki.org/index.php?title=23a:Playstyle_challenge&amp;action=edit&amp;redlink=1">v0.23</a></div>This article is about an <b>older version</b> of DF.<br/>
...
<li>Go into the Status-&gt;Stone screen and allow your copper ore as building material</li>
...
<li>Build a smelter with 1 ash <i>(a fire-safe "bar")</i>.</li>
<li>Smelt the nugget into 4 copper bars using 1 charcoal.</li>
<li>Build a metalsmith's forge with 1 anvil and 1 copper bar.</li>
<li>Forge a battle axe using 1 copper bar and 1 charcoal.</li>
<li>Chop some trees.</li>
<li>Construct a wood furnace with a copper bar.</li>
<li>Make more charcoal.</li>
<li>Forge a pick.</li></ul>
...
You'll need to use [DFHack](DFHack.md) to bypass the embark restrictions (you can uninstall it afterwards) and have [cave-ins](Cave-in.md) disabled in [d_init.txt](D_init.txt.md) all the time, to prevent the ice sheet from collapsing into the water underneath.
...
A well known and popular challenge. Kill off 6 starting dwarves and any [immigrants](Immigrant.md) as they arrive, and try to make a living for the last dwarf. Turn away merchants. If they don't leave, kill them.
...
- In [fortress mode](Fortress_mode.md), successfully colonize [Hell](Hell.md). Retire the fortress.
...
- Build your whole fortress around a [trade depot](Trade_depot.md). Train your [building designer](Building_designer.md) to build a really good trade depot eventually.
...
- Build shrines in the names of [outpost liaison](Outpost_liaison.md) and foreign diplomats.
