<!-- Mirrored from https://dwarffortresswiki.org/index.php/DF2014:Megaproject (revision 286005).
     Generated by crawl.py - edit the wiki, not this file. -->

# DF2014:Megaproject

*[Source](https://dwarffortresswiki.org/index.php/DF2014:Megaproject) &middot; revision 286005 &middot; retrieved 2026-09-13 &middot; [wikitext](../../mirror/wikitext/DF2014/Megaproject.wiki)*

---
<table><tbody><tr><td><div><a href="../Main/Megaproject.md">v53.16</a> · <b>v0.47.05</b> · <a href="https://dwarffortresswiki.org/index.php/v0.34:Megaproject">v0.34</a> · <a href="https://dwarffortresswiki.org/index.php/v0.31:Megaproject">v0.31</a> · <a href="https://dwarffortresswiki.org/index.php?title=40d:Megaproject&amp;action=edit&amp;redlink=1">v0.28</a> · <a href="https://dwarffortresswiki.org/index.php?title=23a:Megaproject&amp;action=edit&amp;redlink=1">v0.23</a></div>This article is about an <b>older version</b> of DF.<br/>
...
**\<\<☼Ultimate Super Khazad-Dúm Durin’s Folk Dwarven Ultra-bonus☼\>\>**: Build the real [Moria](https://web.archive.org/web/20180930023823if_/http://www.rpg-ash.me.uk/LotRO/moria_special_edition/moria_map.jpg)
...
- Bonus: Add [menacing spikes](Menacing_spike.md).
...
- ArmokFanaticBonus: Same, but make it inside [HFS](HFS.md). Sacrifice it's denizens for Armok! Alternatively, make it inside an adamantine spire and enjoy your engraved, all-natural raw adamantine walls.
...
- BONUS: Make it block the goblins out of your half of the map.
...
- 
  ...
  - MERCILESS ARMOK BONUS:As above, but make sure it goes through a Haunted Biome.
...
Most famously employed in [Boatmurdered](../Main/Boatmurdered.md).
...
Create a road of gold bars leading from a small village of [mountain gnomes](Mountain_gnome.md), to a large city of [green glass](Green_glass.md) (or mod the game to allow using [emeralds](Emerald.md) as building materials.) Have a patrol along the road consisting of a female child (human if you can manage it somehow) wearing [ruby](Ruby.md)-encrusted shoes, a [puppy](Dog.md), an [iron man](Iron_man.md), a [titan](Titan.md) made of grass or wheat, and a [lion](Lion.md).
...
- Marksdwarf tower
- [Doberman bomb](https://dwarffortresswiki.org/index.php/v0.34:Stupid_dwarf_trick#Doberman_Bomb)
  - Point Multiplier: Automate it with pressure plates
- Fire Turret: Trap [magma crabs](Magma_crab.md) and [fire imps](Fire_imp.md) in magma safe cage traps from the magma sea and make a tower.
- [Dwarven Traps](Trap.md)
- [VERY Dwarven Traps](https://dwarffortresswiki.org/index.php/v0.34:Stupid_dwarf_trick)
...
- Night's Watch Bonus: Have all the dwarves be trained in some military skill with at least novice.
  - Roles Bonus: Have each dwarves assigned to a class - Steward, Builder, Ranger either using the profession nickname or the squad menu.
- Command Bonus: Change the noble positions to the counterparts of The Night's Watch - The expedition leader/mayor would be Lord Commander, Military Commander as First Ranger, and if using the squad naming system for the classes - First Steward and First Builder, and Medical Dwarf - Maester etc etc.
...
**Categories:** [DF2014:Exceptional Quality Articles](../Category/DF2014%253AExceptional_Quality_Articles.md) &middot; [DF2014:Needs update](../Category/DF2014%253ANeeds_update.md) &middot; [DF2014:Design](../Category/DF2014%253ADesign.md)
