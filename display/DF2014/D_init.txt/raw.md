<!-- Mirrored from https://dwarffortresswiki.org/index.php/DF2014:D_init.txt/raw (revision 255136).
     Generated by crawl.py - edit the wiki, not this file. -->

# DF2014:D init.txt/raw

*[Source](https://dwarffortresswiki.org/index.php/DF2014:D_init.txt/raw) &middot; revision 255136 &middot; retrieved 2026-09-12 &middot; [wikitext](../../../mirror/wikitext/DF2014/D_init.txt/raw.wiki)*
...
<br> Use these to control the automatic saving behavior in the dwarf fortress mode of the game. AUTOSAVE can be set to NONE, SEASONAL or YEARLY. This updates your save at these intervals, so that some of your progress will be saved in case of system instability. You can set AUTOBACKUP to YES if you want the updated save to be copied to another folder so that you'll have several copies of your world at different times. Set AUTOSAVE_PAUSE to YES if you want the game to pause every time it autosaves.

\[AUTOSAVE:NONE\] \[AUTOBACKUP:NO\] \[AUTOSAVE_PAUSE:NO\]
...
\[TEMPERATURE:YES\] \[WEATHER:YES\] \[ECONOMY:YES\] \[INVADERS:YES\] \[CAVEINS:YES\] \[ARTIFACTS:YES\] \[ZERO_RENT:NO\] \[TESTING_ARENA:YES\] \[WALKING_SPREADS_SPATTER_DWF:NO\] \[WALKING_SPREADS_SPATTER_ADV:YES\]
...
\[WOUND_COLOR_NONE:7:0:1\] No recorded active wounds on the part. Default = white \[WOUND_COLOR_MINOR:6:0:0\] Any damage that doesn't have functional/structural consequences (might be heavy bleeding though). Default = brown \[WOUND_COLOR_INHIBITED:6:0:1\] Any muscular, structural or functional damage without total loss. Default = yellow \[WOUND_COLOR_FUNCTION_LOSS:3:0:1\] An important function of the part is completely lost, but the part is structurally sound (or at least partially intact). Default = bright cyan \[WOUND_COLOR_BROKEN:4:0:1\] The part has lost all structural integrity or muscular ability. Default = bright red \[WOUND_COLOR_MISSING:0:0:1\] The part is completely gone. Default = dark gray
...
\[PRIESTHOOD_UNIT_COUNTS:10:25\] \[TEMPLE_VALUE_LEVELS:2000:10000\] \[GUILD_UNIT_COUNTS:10:25\] \[GUILDHALL_VALUE_LEVELS:2000:10000\]
