<!-- Mirrored from https://dwarffortresswiki.org/index.php/DF2014:Elven_language (revision 302507).
     Generated by crawl.py - edit the wiki, not this file. -->

# DF2014:Elven language

*[Source](https://dwarffortresswiki.org/index.php/DF2014:Elven_language) &middot; revision 302507 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/DF2014/Elven_language.wiki)*

---
<table><tbody><tr><td><div><a href="../Main/Elven_language.md">v53.16</a> · <b>v0.47.05</b> · <a href="https://dwarffortresswiki.org/index.php?title=v0.34:Elven_language&amp;action=edit&amp;redlink=1">v0.34</a> · <a href="https://dwarffortresswiki.org/index.php?title=v0.31:Elven_language&amp;action=edit&amp;redlink=1">v0.31</a> · <a href="https://dwarffortresswiki.org/index.php?title=40d:Elven_language&amp;action=edit&amp;redlink=1">v0.28</a> · <a href="https://dwarffortresswiki.org/index.php?title=23a:Elven_language&amp;action=edit&amp;redlink=1">v0.23</a></div>This article is about an <b>older version</b> of DF.<br/>
<div><a href="../Dwarf_Fortress_Wiki/V.md">More Info</a> · <a href="../Template/Av.md">V</a></div></td></tr>
</tbody></table>

> *Not to be confused with [Quenya](http://en.wikipedia.org/wiki/Quenya) or [Sindarin](http://en.wikipedia.org/wiki/Sindarin).*

The **Elven language** is one of the [languages](Language.md) the player will come across. This language is used in-game for the names of the universe, continents, rivers, elven governments and settlements, [elves](Elf.md), [artifacts](Artifact.md) and [engravings](Engraving.md). However, as of yet, it lacks everything necessary for proper conversation, like grammar or personal pronouns.
...
The letters J and X of the [ISO basic Latin alphabet](http://en.wikipedia.org/wiki/ISO_basic_Latin_alphabet) do not occur in the Elven alphabet.
...
- [Digraphs](http://en.wikipedia.org/wiki/digraph_(orthography)) *th* and *qu*.
  - *h* only occurs in the digraph *th*.
  - *q* only occurs in the digraph *qu*.
- Only allowed consonant cluster *sl*.
- Elven has no [diphthongs](http://en.wikipedia.org/wiki/diphthongs).
- Possible [syllable structure](http://en.wikipedia.org/wiki/syllable_structure) (C)(C)V

#### Diacritic meaning

The Elven language has two diacritics ([◌̀](http://en.wikipedia.org/wiki/Grave_accent) and [◌́](http://en.wikipedia.org/wiki/Acute_accent)) used on four vowels (*e*, *i*, *o*, and *u*). Its possible that this is just a simpler version of the Dwarven language's system, with just high and low pitch. It's also possible that the two diacritics represent short and overlong vowels, and no diacritic represents a long vowel.
...
<table>
<tbody><tr><th scope="col"><div><a href="Elven_language/raw.md">Raws</a></div></th></tr>
<tr><td><div>[TRANSLATION:ELF]
	[T_WORD:ABBEY:cebela]
	[T_WORD:ACE:adi]
	[T_WORD:ACT:aró]
	[T_WORD:AFTER:ifife]
	...
	[T_WORD:COMPANY:famari]</div></td></tr></tbody></table>
