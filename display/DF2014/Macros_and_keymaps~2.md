<!-- Mirrored from https://dwarffortresswiki.org/index.php/DF2014:Macros_and_keymaps (revision 272137).
     Generated by crawl.py - edit the wiki, not this file. -->

# DF2014:Macros and keymaps

*[Source](https://dwarffortresswiki.org/index.php/DF2014:Macros_and_keymaps) &middot; revision 272137 &middot; retrieved 2026-09-13 &middot; [wikitext](../../mirror/wikitext/DF2014/Macros_and_keymaps~2.wiki)*

---
<table><tbody><tr><td><div><a href="../Main/Macros_and_keymaps~2.md">v53.16</a> · <b>v0.47.05</b> · <a href="https://dwarffortresswiki.org/index.php/v0.34:Macros_and_keymaps">v0.34</a> · <a href="https://dwarffortresswiki.org/index.php/v0.31:Macros_and_keymaps">v0.31</a> · <a href="https://dwarffortresswiki.org/index.php/40d:Macros_and_keymaps">v0.28</a> · <a href="https://dwarffortresswiki.org/index.php?title=23a:Macros_and_keymaps&amp;action=edit&amp;redlink=1">v0.23</a></div>This article is about an <b>older version</b> of DF.<br/>
...
<br> The third way to increase the speed of macros is to change settings in the init-files. In the [base init file (data/init/init.txt)](Init.txt.md) you will find the follow lines:
...
- The `KEY_REPEAT_ACCEL_START` and `KEY_REPEAT_ACCEL_LIMIT` settings are unrelated to macros (except while recording). See [Technical tricks](Technical_tricks.md#keyboard) for more information.
