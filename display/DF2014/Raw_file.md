<!-- Mirrored from https://dwarffortresswiki.org/index.php/DF2014:Raw_file (revision 284172).
     Generated by crawl.py - edit the wiki, not this file. -->

# DF2014:Raw file

*[Source](https://dwarffortresswiki.org/index.php/DF2014:Raw_file) &middot; revision 284172 &middot; retrieved 2026-09-13 &middot; [wikitext](../../mirror/wikitext/DF2014/Raw_file.wiki)*

---
<table><tbody><tr><td><div><a href="../Main/Raw_file.md">v53.16</a> · <b>v0.47.05</b> · <a href="https://dwarffortresswiki.org/index.php/v0.34:Raw_file">v0.34</a> · <a href="https://dwarffortresswiki.org/index.php/v0.31:Raw_file">v0.31</a> · <a href="https://dwarffortresswiki.org/index.php/40d:Raw_file">v0.28</a> · <a href="https://dwarffortresswiki.org/index.php/23a:Raw_file">v0.23</a></div>This article is about an <b>older version</b> of DF.<br/>
...
**Raw files** are text files found in the **raw/objects/** subdirectory of *Dwarf Fortress* (used for [world generation](World_generation.md)), as well as inside the [saved game folder](Saved_game_folder.md) (**data/save/\<region name\>/raw/objects/**) for already generated worlds. These files can be looked through to discover various specifics of game items, materials, and creatures, and can be changed to alter how the game behaves. They are sometimes referred to by players as just "the raws".

The **raw/graphics** subfolder of *Dwarf Fortress* is used to store user-customizable [graphics sets](Graphics_set_repository.md). The **raw/[interaction examples](Interaction_examples.md)** folder contains examples useful for modding but completely ignored by *Dwarf Fortress*.
...
**Categories:** [DF2014:Superior Quality Articles](../Category/DF2014%253ASuperior_Quality_Articles.md) &middot; [DF2014:Files](../Category/DF2014%253AFiles.md) &middot; [DF2014:Modding](../Category/DF2014%253AModding.md)
