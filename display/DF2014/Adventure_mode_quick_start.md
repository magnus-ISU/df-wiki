<!-- Mirrored from https://dwarffortresswiki.org/index.php/DF2014:Adventure_mode_quick_start (revision 310162).
     Generated by crawl.py - edit the wiki, not this file. -->

# DF2014:Adventure mode quick start

*[Source](https://dwarffortresswiki.org/index.php/DF2014:Adventure_mode_quick_start) &middot; revision 310162 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/DF2014/Adventure_mode_quick_start.wiki)*

---
<table><tbody><tr><td><div><a href="../Main/Adventure_mode_quick_start.md">v53.16</a> · <b>v0.47.05</b> · <a href="https://dwarffortresswiki.org/index.php/v0.34:Adventure_mode_quick_start">v0.34</a> · <a href="https://dwarffortresswiki.org/index.php/v0.31:Adventure_mode_quick_start">v0.31</a> · <a href="https://dwarffortresswiki.org/index.php?title=40d:Adventure_mode_quick_start&amp;action=edit&amp;redlink=1">v0.28</a> · <a href="https://dwarffortresswiki.org/index.php?title=23a:Adventure_mode_quick_start&amp;action=edit&amp;redlink=1">v0.23</a></div>This article is about an <b>older version</b> of DF.<br/>
<div><a href="../Dwarf_Fortress_Wiki/V.md">More Info</a> · <a href="../Template/Av.md">V</a></div></td></tr>
</tbody></table>

> *See [Adventure Mode quick reference](Adventure_Mode_quick_reference.md) to quickly look up key commands. If you're a more experienced player (perhaps directed here in error) look up the [Tutorial:Powerplay Guide](../Tutorial/Powerplay_Guide.md) for instruction, instead.*

This guide provides step-by-step instruction for those who have never played *Dwarf Fortress* in **Adventure Mode** before. It assumes that you have already installed the game and can navigate the menus on your own, but no significant knowledge of how to play adventure mode is required - see the full [adventure mode](Adventure_mode.md) documentation for additional details.

### Common UI concepts

**Key Reference**

Most of the key commands you will need are noted on this page, but you can refer to the in-game help with ? or the [quick reference](Adventure_Mode_quick_reference.md) page to look up the key for a particular action.
...
- Exploring human and dwarf [sites](Site.md) - there are [bags](Bag.md) of food stored in the houses. Some Shaping Trees in [forest retreats](Forest_retreat.md) may have fruits and vegetables in or out of season, or you can buy some in city-sized human, dwarven and elven settlements.
...
You may want to read through the full [adventure mode](Adventure_mode.md) documentation to learn about things that weren't covered here.
...
**Categories:** [DF2014:Exceptional Quality Articles](../Category/DF2014%253AExceptional_Quality_Articles.md) &middot; [Version 0.42.01](../Category/Version_0.42.01.md) &middot; [DF2014:Getting started](../Category/DF2014%253AGetting_started.md) &middot; [DF2014:Adventurer mode](../Category/DF2014%253AAdventurer_mode.md)
