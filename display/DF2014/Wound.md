<!-- Mirrored from https://dwarffortresswiki.org/index.php/DF2014:Wound (revision 304723).
     Generated by crawl.py - edit the wiki, not this file. -->

# DF2014:Wound

*[Source](https://dwarffortresswiki.org/index.php/DF2014:Wound) &middot; revision 304723 &middot; retrieved 2026-09-13 &middot; [wikitext](../../mirror/wikitext/DF2014/Wound.wiki)*

---
<table><tbody><tr><td><div><a href="../Main/Wound.md">v53.16</a> · <b>v0.47.05</b> · <a href="https://dwarffortresswiki.org/index.php/v0.34:Wound">v0.34</a> · <a href="https://dwarffortresswiki.org/index.php/v0.31:Wound">v0.31</a> · <a href="https://dwarffortresswiki.org/index.php/40d:Wound">v0.28</a> · <a href="https://dwarffortresswiki.org/index.php/23a:Wound">v0.23</a></div>This article is about an <b>older version</b> of DF.<br/>
...
> *(The [color](Color.md) of wounds can be changed in [d_init.txt](D_init.txt.md).)*

For ways to diagnose and treat injuries, see [health care](Health_care.md).

### Wound effects

[![](https://dwarffortresswiki.org/images/9/98/Dwarf2_injury.gif)](https://dwarffortresswiki.org/index.php/File:Dwarf2_injury.gif)

*Many* injuries of a dwarf.

[![](https://dwarffortresswiki.org/images/a/a4/Recluse_injuries.png)](https://dwarffortresswiki.org/index.php/File:Recluse_injuries.png)

Injuries of a [brown recluse spider man](../Main/Brown_recluse_spider_man.md).

[![](https://dwarffortresswiki.org/images/9/91/Adder_injuries.png)](https://dwarffortresswiki.org/index.php/File:Adder_injuries.png)

Injuries of an [adder](../Main/Adder.md).
...
Injuries cause pain; and excessive pain will knock your dwarves [unconscious](Unconscious.md) from the shock.
...
Blindness in [adventure mode](../Main/Adventure_mode~2.md)
...
A wounded character in adventurer mode may be unable to use wounded limbs, or perform actions with them - a mangled arm, for example, cannot wield a sword. Wounds heal over time, but moving even one cell in fast-Travel mode will vastly speed up recovery, instantly healing all injuries that could heal over time. An adventurer with higher [recuperation](Attribute.md#recuperation) will heal faster than others. Some wounds, however, will never heal.
...
- Getting a lucky roll on a [divination die](Die.md) will heal some wounds.
- Undergoing a [werebeast](Werebeast.md) transformation heals all wounds, including paralysis. This is the only way in the game to restore lost limbs.
...
**Categories:** [DF2014:Exceptional Quality Articles](../Category/DF2014%253AExceptional_Quality_Articles.md) &middot; [DF2014:Military](../Category/DF2014%253AMilitary.md) &middot; [DF2014:Healthcare](../Category/DF2014%253AHealthcare.md) &middot; [DF2014:Interface](../Category/DF2014%253AInterface.md)
