<!-- Mirrored from https://dwarffortresswiki.org/index.php/DF2014:Adder_%28Computing%29 (revision 267572).
     Generated by crawl.py - edit the wiki, not this file. -->

# DF2014:Adder (Computing)

*[Source](https://dwarffortresswiki.org/index.php/DF2014:Adder_%28Computing%29) &middot; revision 267572 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/DF2014/Adder_(Computing).wiki)*

---
<table><tbody><tr><td><div><a href="../Main/Adder_(Computing).md">v53.16</a> · <b>v0.47.05</b> · <a href="https://dwarffortresswiki.org/index.php/v0.34:Adder_%28Computing%29">v0.34</a> · <a href="https://dwarffortresswiki.org/index.php?title=v0.31:Adder_(Computing)&amp;action=edit&amp;redlink=1">v0.31</a> · <a href="https://dwarffortresswiki.org/index.php?title=40d:Adder_(Computing)&amp;action=edit&amp;redlink=1">v0.28</a> · <a href="https://dwarffortresswiki.org/index.php?title=23a:Adder_(Computing)&amp;action=edit&amp;redlink=1">v0.23</a></div>This article is about an <b>older version</b> of DF.<br/>
<div><a href="../Dwarf_Fortress_Wiki/V.md">More Info</a> · <a href="../Template/Av.md">V</a></div></td></tr>
</tbody></table>

> *For the species of snake, see [Adder](Adder.md).*
...
<td>
<b><a href="../Category/DF2014%253AComputing.md">Components</a></b>: <a>Adder</a> • <a href="Memory_(computing).md">Memory</a> • <a href="Repeater.md">Repeater</a></td>
...
Understanding of principles of addition are important to many dwarven [logic](Computing.md) devices. Addition can be used in devices to keep track of various values, such as the number of items in a [stockpile](Stockpile.md), the number of [years](Time.md) that have passed since a particular event, or more abstract computation.

Addition is simplest when dealing with binary values. Addition in other number bases is possible, but this article focuses on binary addition. Addition requires the choice of an arbitrary number of bits, or digits, to add, although numbers larger than the adder is designed for can be added via sequential [additions with carry](Adder.md#add-with-carry). For purposes of this discussion, the least significant digit will be considered the first or right-most digit.

Before beginning an adder, one should become familiar with the logic gates NOT, OR, XOR, and AND. Descriptions of these gates are available for [mechanical](Mechanical_logic.md), [fluid](Fluid_logic.md), [creature](Creature_logic.md), and [animal logic](Animal_logic.md). Addition also requires values to add, which need to be stored in some kind of [memory](Memory_(computing).md).
...
For an example of a creature logic based incrementation system, with incrementation built into the memory, see [here](https://dwarffortresswiki.org/index.php/User:Vasiln/Goblin_Logic_1#Incrementing_memory_and_percolating_functions:_the_two-bit_add).
...
For an example of an incrementation system using animal logic, see [User:Bidok#Counter](https://dwarffortresswiki.org/index.php/User:Bidok#Counter). A fully fluid implementation is available at [User:Hussell/ClockToggle](https://dwarffortresswiki.org/index.php/User:Hussell/ClockToggle).

#### Addition via increment/decrement

A simple but slow adder can be designed by repeatedly incrementing one value while decrementing a second value, until the second value reaches zero. Such a system requires some sort of [repeater](Repeater.md) to drive the process-- every time the repeater fires, and the second value is not equal to zero (NOT the first bit AND NOT the second bit AND NOT the nth bit), the first value is incremented and the second value is decremented. When the second value reaches zero, the first value represents the sum of the initial two values.
...
- [![](https://dwarffortresswiki.org/images/thumb/b/bd/9bit_adder_prototype_10100010notes.PNG/72px-9bit_adder_prototype_10100010notes.PNG)](https://dwarffortresswiki.org/index.php/File:9bit_adder_prototype_10100010notes.PNG)
  ...
  More information is available at [User:LordOOTFD#Adders](https://dwarffortresswiki.org/index.php/User:LordOOTFD#Adders)

A 6-bit mechanical adder is demonstrated at [http://mkv25.net/dfma/movie-1561-addingmachine](http://mkv25.net/dfma/movie-1561-addingmachine). An 8-bit hybrid system is demonstrated at [http://mkv25.net/dfma/movie-1084-numberabbeydemonstration](http://mkv25.net/dfma/movie-1084-numberabbeydemonstration).
...
A system capable of both addition and add-with-carry is considered a full adder. Full adders, even 1-bit full adders, can add values of any bit length. For an example using fluid logic, see [User:Kyace/Adder](https://dwarffortresswiki.org/index.php/User:Kyace/Adder).
...
[Jong's dwarven computer](https://dwarffortresswiki.org/index.php/User:Jong/Dwarven_Computer) uses look-aheads for faster addition, and is capable of add-with-carry. The design can be further compressed to a very compact and versatile full adder: [User:Larix/Adder](https://dwarffortresswiki.org/index.php/User:Larix/Adder). For an example using creature logic, see [Look-ahead Add](https://dwarffortresswiki.org/index.php/User:Vasiln/Goblin_Logic_2#Look-ahead_Adder).
...
- [User:BaronW](https://dwarffortresswiki.org/index.php/User:BaronW)'s page demonstrates the action of just such an awe-inspiring mechanical calculator.

---

**Categories:** [DF2014:Superior Quality Articles](../Category/DF2014%253ASuperior_Quality_Articles.md) &middot; [DF2014:Computing](../Category/DF2014%253AComputing.md)
