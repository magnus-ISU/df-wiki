<!-- Mirrored from https://dwarffortresswiki.org/index.php/DF2014:Dipscript (revision 306879).
     Generated by crawl.py - edit the wiki, not this file. -->

# DF2014:Dipscript

*[Source](https://dwarffortresswiki.org/index.php/DF2014:Dipscript) &middot; revision 306879 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/DF2014/Dipscript.wiki)*

---
<table><tbody><tr><td><div><a href="../Main/Dipscript.md">v53.16</a> · <b>v0.47.05</b> · <a href="https://dwarffortresswiki.org/index.php/v0.34:Dipscript">v0.34</a> · <a href="https://dwarffortresswiki.org/index.php/v0.31:Dipscript">v0.31</a> · <a href="https://dwarffortresswiki.org/index.php/40d:Dipscript">v0.28</a> · <a href="https://dwarffortresswiki.org/index.php/23a:Dipscript">v0.23</a></div>This article is about an <b>older version</b> of DF.<br/>
<div><a href="../Dwarf_Fortress_Wiki/V.md">More Info</a> · <a href="../Template/Av.md">V</a></div></td></tr>
</tbody></table>

A **dipscript**, or "diplomat script", is what controls the behavior of visiting [diplomats](Diplomat.md) when they meet with your [nobles](Noble.md). Dipscripts were originally used to trigger special events at specific points in the lifetime of one's fortress (such as undead invasions), but much of this was stripped out by the time the first version of *Dwarf Fortress* was actually released.

Only 5 different dipscripts are ever executed during gameplay, and they are defined in records 13-17 of the game's "index" file: ELVES_FIRSTCONTACT, HUMAN_STANDARD, DWARF_LIAISON, HUMAN_TRADE, and ELVES_STANDARD. The dipscript files themselves are compressed - with the [proper tools](http://dffd.wimbli.com/file.php?id=4175), editing them is fairly straightforward.
...
| TEXTVIEWER:filename:varname | Opens a [text viewer](Text_viewer.md) using the specified filename (located within data/dipscripts/text). Second parameter is optional - if specified, indicates a LONG script variable which will be set based on the hyperlink selected. |
...
| DISCUSS:length | Inserts a delay into the meeting. Valid lengths are SHORT (500-1000 [steps](FPS.md), about a half a day) and LONG (2-4 days). |
...
| ACTION:type:subtype | Has no effect. In previous versions, DREAM:UNDEAD_ARMY would cause one of your dwarves to have "[a terrifying nightmare about an army of the dead](Thought.md)". |
| DIPEVENT:unit_class:unit_name:dipscript:outcome_class:outcome_name | Has no effect. Most likely, pre-release versions used this to perform special actions. |
| INVASION:type | Has no effect. Most likely, pre-release versions used this to trigger invasions of specific types. |
...
| GLOBAL | TREESREMOVED | Integer | The number of [trees](Tree.md) that have been destroyed at your fortress, whether by cutting them down or by smashing them with [ballista](Ballista.md) bolts. |
...
| Class | Name | Type | Description |
| --- | --- | --- | --- |
| GLOBAL | TREESREMOVED | Integer | The number of [trees](Tree.md) that have been destroyed at your fortress. |
