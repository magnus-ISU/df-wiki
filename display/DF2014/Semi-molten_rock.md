<!-- Mirrored from https://dwarffortresswiki.org/index.php/DF2014:Semi-molten_rock (revision 274057).
     Generated by crawl.py - edit the wiki, not this file. -->

# DF2014:Semi-molten rock

*[Source](https://dwarffortresswiki.org/index.php/DF2014:Semi-molten_rock) &middot; revision 274057 &middot; retrieved 2026-09-13 &middot; [wikitext](../../mirror/wikitext/DF2014/Semi-molten_rock.wiki)*

---
<table><tbody><tr><td><div><a href="../Main/Semi-molten_rock.md">v53.16</a> · <b>v0.47.05</b> · <a href="https://dwarffortresswiki.org/index.php/v0.34:Semi-molten_rock">v0.34</a> · <a href="https://dwarffortresswiki.org/index.php/v0.31:Semi-molten_rock">v0.31</a> · <a href="https://dwarffortresswiki.org/index.php?title=40d:Semi-molten_rock&amp;action=edit&amp;redlink=1">v0.28</a> · <a href="https://dwarffortresswiki.org/index.php?title=23a:Semi-molten_rock&amp;action=edit&amp;redlink=1">v0.23</a></div>This article is about an <b>older version</b> of DF.<br/>
...
[![](https://dwarffortresswiki.org/images/thumb/d/d9/Semimolten.jpg/300px-Semimolten.jpg)](https://dwarffortresswiki.org/index.php/File:Semimolten.jpg)

[https://dwarffortresswiki.org/index.php/File:Semimolten.jpg](https://dwarffortresswiki.org/index.php/File:Semimolten.jpg)

Not as cool as full-blown lava...

**Semi-molten rock** (SMR), represented by the tile `░`, is an unique type of obstacle generally found at the bottommost edges of [great magma seas](Magma_sea.md). Anywhere that [magma](Magma.md) is found rests on layer after layer of semi-molten rock, with no normal material to be found beneath it. There is also a layer near the bottom of the map composed almost entirely of semi-molten rock even where magma does not overlie it. Freestanding formations are possible, though less common. Though its name suggests the rock is hot, it is not dangerous to nearby [dwarves](Dwarf.md). SMR acts as a barrier, and cannot be mined through by conventional means, nor smoothed. Unlike magma, SMR does not react with [water](Water.md), producing no [steam](Steam.md) or [obsidian](Obsidian.md).

The top of semi-molten rock, or its *floor* when observed from the layer above, is described as a [magma flow](Magma_flow.md), appearing in blue text when examined with the Look cursor and resembling a river of magma slowly flowing to the south (just like it did in [older versions](https://dwarffortresswiki.org/index.php/23a:Magma_flow)).

The floor of the stone layer above the SMR at the bottom of the map is *not* a magma flow when stone is dug into, but appears as the same type of rock as the tile dug into. However, if a [channel](Channel.md) is dug down into the SMR from this tile, a magma flow floor is revealed; *under* this intact floor the unusable ramp will appear, if and only if the tile of SMR was previously unrevealed. Otherwise it will be unchanged (as a result, no two of these ramps can adjoin). A magma flow also cannot be dug into, nor smoothed. However, [constructions](Construction.md) can be built on top of it, and these convert the magma flow into some other kind of stone or soil, which is sometimes useful [sand](Sand.md) or [clay](Clay.md), appearing when the construction is removed.
...
These odd exceptions to the normal rules mean that dwarves on a level partially filled with water can (with much effort) completely wall off the region surrounding some [special point of interest](Adamantine.md), eventually removing *all* the magma from a large area despite the failure of the usual magma-water interaction.
...
Semi-molten rock is *not* synonymous with [warm stone](../Main/Digging_designation_canceled.md), although any given tile of SMR may in fact be warm if it adjoins magma. If you're looking for magma and you find SMR rather than warm stone, your best bet is to do some exploratory mining several Z levels up.

You can also dig *up* into semi-molten rock just fine (by designating an up/down staircase accessible from below). This also works *only* if the tile is still unrevealed. But often (but not always) you can't get down there without encountering [spoilers](Hidden_Fun_Stuff.md) first.
...
Channelling down into unrevealed SMR may open it into an [Eerie Glowing Pit](Underworld.md).
...
3. Collapse a constructed floor into the shaft. This collapses the magma flow tile to the bottom and destroys the unusable ramp. Use materials which will burn or [melt in magma](Magma_safe.md) to build the collapsing floor. If only a single layer of SMR remains, the collapse will breach through to the expanse below. Any dwarf miner trapped in the shaft from step 2 will be crushed and killed.
...
5. Use a [pond](Activity_zone.md#pit2fpond) designation and wait for a dwarf to pour a single bucket of water to remove the 7/7 magma at the bottom. Remove the pond zone.
...
<br> There may be many layers of semi-molten rock to dig through before reaching hell. Also, if you get really unlucky, your final floor collapse can break through into hell and land in an Eerie Glowing Pit. If it does, your FPS will be [ruined](http://www.youtube.com/watch?v=aCNt8zFnyvM). Make sure you have a backup save before starting this procedure. What happens is that the magma flow tile gets stuck in the middle of the Eerie Glowing Pit, but it is unsupported by any walls or floors and will perpetually collapse every single frame. Your FPS drop to the low single digits even on a modern gaming PC.
...
**Categories:** [DF2014:Fine Quality Articles](../Category/DF2014%253AFine_Quality_Articles.md) &middot; [DF2014:Spoilers](../Category/DF2014%253ASpoilers.md) &middot; [DF2014:Map tiles](../Category/DF2014%253AMap_tiles.md)
