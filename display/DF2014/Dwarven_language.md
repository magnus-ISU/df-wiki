<!-- Mirrored from https://dwarffortresswiki.org/index.php/DF2014:Dwarven_language (revision 302533).
     Generated by crawl.py - edit the wiki, not this file. -->

# DF2014:Dwarven language

*[Source](https://dwarffortresswiki.org/index.php/DF2014:Dwarven_language) &middot; revision 302533 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/DF2014/Dwarven_language.wiki)*

---
<table><tbody><tr><td><div><a href="../Main/Dwarven_language.md">v53.16</a> · <b>v0.47.05</b> · <a href="https://dwarffortresswiki.org/index.php?title=v0.34:Dwarven_language&amp;action=edit&amp;redlink=1">v0.34</a> · <a href="https://dwarffortresswiki.org/index.php?title=v0.31:Dwarven_language&amp;action=edit&amp;redlink=1">v0.31</a> · <a href="https://dwarffortresswiki.org/index.php?title=40d:Dwarven_language&amp;action=edit&amp;redlink=1">v0.28</a> · <a href="https://dwarffortresswiki.org/index.php?title=23a:Dwarven_language&amp;action=edit&amp;redlink=1">v0.23</a></div>This article is about an <b>older version</b> of DF.<br/>
<div><a href="../Dwarf_Fortress_Wiki/V.md">More Info</a> · <a href="../Template/Av.md">V</a></div></td></tr>
</tbody></table>

> *Not to be confused with [Khuzdul](http://en.wikipedia.org/wiki/Khuzdul).*

The **Dwarven language** is one of the [languages](Language.md) the player will come across. This language is used in-game for the names of the universe, continents, rivers, dwarven governments and settlements, dwarves, [artifacts](Artifact.md) and [engravings](Engraving.md). However, as of yet, it lacks everything necessary for proper conversation, like grammar or personal pronouns.
...
<tr>
<td align="center" colspan="40"><b>Majuscule forms</b> (also called <b>uppercase</b> or <b>capital letters</b>)
</td></tr>
<tr>
...
<tr>
<td align="center" colspan="40"><b>Minuscule forms</b> (also called <b>lowercase</b> or <b>small letters</b>)
</td></tr>
<tr>
<td align="center">a</td>
<td align="center">à</td>
...
The letters J, P, Q, W, X, and Y of the [ISO basic Latin alphabet](http://en.wikipedia.org/wiki/ISO_basic_Latin_alphabet) do not occur in the Dwarven alphabet.
...
- [Digraphs](http://en.wikipedia.org/wiki/digraph_(orthography)) *sh*, *th*, and *ng*.
  - *h* only occurs in the digraphs *sh* and *th*.
- Common consonant cluster *st*.
- Dwarven has no [diphthongs](http://en.wikipedia.org/wiki/diphthongs).
- *c*, *f*, and *v* are always followed by a vowel.
- Possible [syllable structure](http://en.wikipedia.org/wiki/syllable_structure) either (C)<sup>2</sup>V(C)<sup>2</sup> or (C)V(C).

#### Diacritic meaning

The Dwarven language has five diacritics ([◌̀](http://en.wikipedia.org/wiki/Grave_accent), [◌́](http://en.wikipedia.org/wiki/Acute_accent), [◌̂](http://en.wikipedia.org/wiki/Circumflex), [◌̈](http://en.wikipedia.org/wiki/Diaeresis_(diacritic)), and [◌̊](http://en.wikipedia.org/wiki/Ring_(diacritic))) used on five vowels (*a*, *e*, *i*, *o*, and *u*). The ring accent only appears on *a* and the diaeresis accent doesn't appear on *u*.

The use of diacritics in Dwarven could mean that vowels have different pronunciations, like in some European languages such as French, German, or Swedish,<br> or that it's a tonal language that indicates pitch, such as Chinese languages, Thai, Vietnamese, etc. The pronunciation of the diacritics is currently unknown.

| Diacritic | Diacritic name | Use in other languages | Probable Tonal meaning |
| --- | --- | --- | --- |
| ◌ | None | - | Neutral pitch |
| ◌̀ | [Grave accent](http://en.wikipedia.org/wiki/Grave_accent) | Low pitch, stressed vowels, open vowels, short vowels. | Low pitch |
| ◌́ | [Acute accent](http://en.wikipedia.org/wiki/Acute_accent) | High pitch, stressed vowels, close vowels, long vowels. | High pitch |
| ◌̂ | [Circumflex](http://en.wikipedia.org/wiki/Circumflex) | Used to represent falling pitch or long vowels. | Falling pitch |
| ◌̈ | [Diaeresis (diacritic)](http://en.wikipedia.org/wiki/Diaeresis_(diacritic)) | Used to show that a vowel should be read separately (like in *coöperate*). This is certainly not its use in Dwarven, because there are no diphthongs. It could also indicate a sound change. | Mid pitch |
| ◌̊ | [Ring (diacritic)](http://en.wikipedia.org/wiki/Ring_(diacritic)) | *Å* is a completely separate letter from *A* in various Nordic alphabets, and this diacritic is only used on *a* in Dwarven... | Rising pitch |
...
General suggestions for the pronunciation of the various languages were developed [here.](https://www.reddit.com/r/dwarffortress/comments/7ttsz9/suggested_pronunciation_system_for_dwarf_fortress/%7CRing)

### Vocabulary

> *Main articles: [Noun dictionary](../Template/Noun_dictionary.md), [Verb dictionary](../Template/Verb_dictionary.md), [Adjective dictionary](../Template/Adjective_dictionary.md), and [Prefix dictionary](../Template/Prefix_dictionary.md)*

The average word in the Dwarven language is 5.088 letters long. The longest known word is *ngathsesh*, meaning "[vomit](Vomit.md)".

The average word has 1.868 syllables. Generally, words either have one or two syllables.

#### Notes

Interestingly, the language lacks words like dwarf (possibly *bistök-udos*, "hairy man", or *duradudos*, "bearded man"), human (technically they have *udos* ("man")), goblin or elf (though one could use *dák-enur* ("tree-hug") for that). However, it is not lacking words for "[pearl](Pearl.md)" (*kovest*) or "pumpkin" (*elbost*) which do not even exist in-universe.
...
<br> Although dwarves are capable of creating massive and powerful fortresses, killing unimaginable beasts and demons, wiping out entire civilizations, and becoming incredibly buff after hours of constant mining, they all develop a glaring weakness known as [cave adaptation](Cave_adaptation.md), which causes dwarves to puke when exposed to the outdoors. It is because of these thousands of disturbances that the vile substance accelerating out of their guts had been given the ~~stupidly long name~~ incredibly intimidating title of "ngathsesh" due to the countless victims it has affected (including the poor bastards that have to clean the damned mess).

<table>
<tbody><tr><th scope="col"><div><a href="Dwarven_language/raw.md">Raws</a></div></th></tr>
<tr><td><div>[TRANSLATION:DWARF]
	[T_WORD:ABBEY:kulet]
	[T_WORD:ACE:alak]
	[T_WORD:ACT:bidok]
	[T_WORD:AFTER:nicol]
	...
	[T_WORD:COMPANY:kâtad]</div></td></tr></tbody></table>
...
<a href="Language.md">Languages</a></div></th></tr><tr><th scope="row"><a href="../Category/DF2014%253ARaces.md">Races</a></th><td><div>
<a href="Divine_language.md">Divine</a> ·  <a>Dwarven</a> ·  <a href="Elvish_language.md">Elvish</a> ·  <a href="Goblin_language.md">Goblin</a> ·  <a href="Human_language.md">Human</a> ·  <a href="https://dwarffortresswiki.org/index.php?title=DF2014:Kobold_language&amp;action=edit&amp;redlink=1">Kobold</a></div></td></tr><tr><th scope="row">Modding</th><td><div>
...
**Categories:** [D for Dwarf](../Category/D_for_Dwarf.md) &middot; [Language](../Category/Language.md)
