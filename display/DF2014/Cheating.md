<!-- Mirrored from https://dwarffortresswiki.org/index.php/DF2014:Cheating (revision 308892).
     Generated by crawl.py - edit the wiki, not this file. -->

# DF2014:Cheating

*[Source](https://dwarffortresswiki.org/index.php/DF2014:Cheating) &middot; revision 308892 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/DF2014/Cheating.wiki)*

---
<table><tbody><tr><td><div><a href="../Main/Cheating.md">v53.16</a> · <b>v0.47.05</b> · <a href="https://dwarffortresswiki.org/index.php/v0.34:Cheating">v0.34</a> · <a href="https://dwarffortresswiki.org/index.php/v0.31:Cheating">v0.31</a> · <a href="https://dwarffortresswiki.org/index.php/40d:Cheating">v0.28</a> · <a href="https://dwarffortresswiki.org/index.php/23a:Cheating">v0.23</a></div>This article is about an <b>older version</b> of DF.<br/>
...
[Shaostoul's Guide](../Main/Shaostoul's_Guide.md) contains several cut & paste examples for editing raw files specifically for the purpose of cheating.
...
Don't want to care for your dwarves? Simply add \[NO_EAT\] \[NO_SLEEP\] and \[NO_DRINK\] to your dwarves' raws and never care for them again. (Warning when editing \[NO_SLEEP\], because sometimes dwarves will rest and just never wake up<sup>\[[Verify](https://dwarffortresswiki.org/index.php/DF2014_Talk:Cheating)\]</sup>)
...
(Warning, editing this may cause the game to crash.<sup>\[[Verify](https://dwarffortresswiki.org/index.php/DF2014_Talk:Cheating)\]</sup>)
...
Memory hacking is much harder than raw editing, and requires [special tools](Utilities.md). The most prevalent tool today is [DFHack](../Utility/DFHack.md), which provides complete access to most of *Dwarf Fortress* internal memory through C++ plugins as well as Lua and Ruby scripts. The `gui/gm-editor` command allows direct data editing of the selected [creature](Creature.md), [item](Item.md), or [job](Job.md), while `gui/gm-editor world` does the same for global variables.
...
**Categories:** [DF2014:Superior Quality Articles](../Category/DF2014%253ASuperior_Quality_Articles.md) &middot; [DF2014:Mods](../Category/DF2014%253AMods.md) &middot; [D for Dwarf](../Category/D_for_Dwarf.md)
