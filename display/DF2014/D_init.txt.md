<!-- Mirrored from https://dwarffortresswiki.org/index.php/DF2014:D_init.txt (revision 269282).
     Generated by crawl.py - edit the wiki, not this file. -->

# DF2014:D init.txt

*[Source](https://dwarffortresswiki.org/index.php/DF2014:D_init.txt) &middot; revision 269282 &middot; retrieved 2026-09-12 &middot; [wikitext](../../mirror/wikitext/DF2014/D_init.txt.wiki)*

---
<table><tbody><tr><td><div><a href="../Main/D_init.txt.md">v53.16</a> · <b>v0.47.05</b> · <a href="https://dwarffortresswiki.org/index.php/v0.34:D_init.txt">v0.34</a> · <a href="https://dwarffortresswiki.org/index.php/v0.31:D_init.txt">v0.31</a> · <a href="https://dwarffortresswiki.org/index.php?title=40d:D_init.txt&amp;action=edit&amp;redlink=1">v0.28</a> · <a href="https://dwarffortresswiki.org/index.php?title=23a:D_init.txt&amp;action=edit&amp;redlink=1">v0.23</a></div>This article is about an <b>older version</b> of DF.<br/>
...
> *Many of these settings are covered in detail [here](Technical_tricks.md#settings---d-inittxt).*
...
<tr><td>
<p><a href="https://dwarffortresswiki.org/index.php/File:Text-x-generic.svg"><img alt="Text-x-generic.svg" height="18" src="https://thumb.wikimedia.org/wikipedia/commons/thumb/2/20/Text-x-generic.svg/20px-Text-x-generic.svg.png?utm_source=commons.wikimedia.org&amp;utm_campaign=imageinfo&amp;utm_content=thumbnail" width="18"/></a> d_init.txt
</p>
</td></tr>
</tbody></table>

The **d_init.txt** file can be used to make many adjustments to the game's behavior, such as enabling autosave or changing the population limit, as well as some [technical tricks](Technical_tricks.md) to improve framerate by deactivating features like weather and temperature.

This file is located at **`data/init/d_init.txt`** within your *Dwarf Fortress* folder (or the**.dwarffortress** folder in your home directory if you installed *Dwarf Fortress* on Arch Linux using `pacman`). Changes made to this file take effect the next time the game is loaded, and apply to all worlds. The file can be edited manually or manipulated by an external launcher such as the [Lazy Newb Pack](../Utility/Lazy_Newb_Pack.md).
...
<table>
<tbody><tr><th scope="col"><div><a href="D_init.txt/raw.md">d_init.txt</a></div></th></tr>
<tr><td><div>WARNING: Do NOT copy over the d_init.txt from an earlier version of DF.
...
[GUILDHALL_VALUE_LEVELS:2000:10000]</div></td></tr></tbody></table>

### Bugs

- The text in the file says you need a population of 80 for a [monarch](Monarch.md), but you actually need 140.
...
<a href="Announcements.txt.md">announcements.txt</a> • <a>d_init.txt</a></div></td></tr><tr><th scope="row">Log files</th><td><div>
...
**Categories:** [DF2014:Fine Quality Articles](../Category/DF2014%253AFine_Quality_Articles.md) &middot; [DF2014:Bugs](../Category/DF2014%253ABugs.md) &middot; [DF2014:Files](../Category/DF2014%253AFiles.md)
