<!-- Mirrored from https://dwarffortresswiki.org/index.php/DF2014:Military_testing (revision 251596).
     Generated by crawl.py - edit the wiki, not this file. -->

# DF2014:Military testing

*[Source](https://dwarffortresswiki.org/index.php/DF2014:Military_testing) &middot; revision 251596 &middot; retrieved 2026-09-13 &middot; [wikitext](../../mirror/wikitext/DF2014/Military_testing.wiki)*
...
If you want to know more about how to do your own testing, go to the [Arena](Object_testing_arena.md) wiki article. To learn more about the military and how it works in *Dwarf Fortress*, go to the [DF2014:Military](Military.md) article.
...
Third time last axedwarf actually fall into martial trance and finished three remaining sworddwarves, last sword guy just bled to death while fighting. It seems distance on which fighting is started influence outcome, though I'm not sure and this statement requires more tests.
...
**Notes:** Both humans were placed in the central pit at opposite ends of said pit.
...
<br> **Tester's conclusion:** The 65% victory rate for silver warhammer users suggests that a meaningful advantage does exist for silver over steel warhammers. This is consistent with general community sentiments.
...
<br> **Tester's conclusion:** The victory rate of 68% for silver war hammers is not a significantly different result from the unarmored test's result of 65%. This suggests that silver warhammers are more effective than steel warhammers, and that this effect is equally true whether or not the target or armored.
