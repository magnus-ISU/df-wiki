<!-- Mirrored from https://dwarffortresswiki.org/index.php/DF2014:Weather (revision 286819).
     Generated by crawl.py - edit the wiki, not this file. -->

# DF2014:Weather

*[Source](https://dwarffortresswiki.org/index.php/DF2014:Weather) &middot; revision 286819 &middot; retrieved 2026-09-13 &middot; [wikitext](../../mirror/wikitext/DF2014/Weather.wiki)*

---
<table><tbody><tr><td><div><a href="../Main/Weather.md">v53.16</a> · <b>v0.47.05</b> · <a href="https://dwarffortresswiki.org/index.php/v0.34:Weather">v0.34</a> · <a href="https://dwarffortresswiki.org/index.php/v0.31:Weather">v0.31</a> · <a href="https://dwarffortresswiki.org/index.php/40d:Weather">v0.28</a> · <a href="https://dwarffortresswiki.org/index.php/23a:Weather">v0.23</a></div>This article is about an <b>older version</b> of DF.<br/>
<div><a href="../Dwarf_Fortress_Wiki/V.md">More Info</a> · <a href="../Template/Av.md">V</a></div></td></tr>
</tbody></table>

[![Weather preview.png](https://dwarffortresswiki.org/images/thumb/6/6e/Weather_preview.png/300px-Weather_preview.png)](https://dwarffortresswiki.org/index.php/File:Weather_preview.png)
...
Normal (non-evil) weather can be disabled by changing \[WEATHER:YES\] to \[WEATHER:NO\] in [d_init.txt](D_init.txt.md). Disabling weather is a quick and largely harmless fix to improve [framerate](FPS.md) on older machines if required.
...
Rainfall occurs occasionally. Normal rain cleans any tile it lands on, removing blood, [vomit](Vomit.md) and other bodily fluids on contact. Any dwarf caught outside when it rains will receive a minor unhappy [thought](Thought.md).
...
If the [temperature](Climate.md) is cold enough, snowfall rather than rainfall will occur, and outside water will freeze, including murky pools and rivers. This can happen in winter months in a moderate [biome](Biome.md), or at any time in freezing biomes like a [tundra](Tundra.md) or [glacier](Glacier.md).
...
In the freezing cold, outside water will freeze into a wall of [ice](Ice.md) of at least 4/7 deep, or a floor otherwise. Freezing ice acts much like [obsidian](Obsidian.md), and will instantly kill anything caught inside of it -- including creatures otherwise extremely hard to kill. In moderate biomes after winter has passed, ice will melt back into ponds. Ice walls will always thaw back into a full 7 units of liquid, regardless of the original water level, but ice floors will produce the original water depth when thawed. <sup>[\[1\]](https://dwarffortresswiki.org/index.php/DF2014_Talk:Weather#Freezing.2Fthawing_ice)</sup>
